...
func (rb *RequestBuilder) IgnoreIndexSettings(ignore_index_settings ...string) *RequestBuilder {
	rb.v.IgnoreIndexSettings = append(rb.v.IgnoreIndexSettings, ignore_index_settings...)
	return rb
}
...
func (rb *RequestBuilder) IndexSettings(indexsettings types.IndexSettings) *RequestBuilder {
	rb.v.IndexSettings = &indexsettings
	return rb
}
