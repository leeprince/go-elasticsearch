...
func (rb *RequestBuilder) Repository(repository types.Repository) *RequestBuilder {
	rb.v.Repository = &repository
	return rb
}

func (rb *RequestBuilder) Settings(settings types.RepositorySettings) *RequestBuilder {
