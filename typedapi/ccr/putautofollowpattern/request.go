...
func (rb *RequestBuilder) LeaderIndexExclusionPatterns(leaderindexexclusionpatterns types.IndexPatterns) *RequestBuilder {
	rb.v.LeaderIndexExclusionPatterns = &leaderindexexclusionpatterns
	return rb
}

func (rb *RequestBuilder) LeaderIndexPatterns(leaderindexpatterns types.IndexPatterns) *RequestBuilder {
	rb.v.LeaderIndexPatterns = &leaderindexpatterns
	return rb
}
...
func (rb *RequestBuilder) MaxReadRequestSize(maxreadrequestsize types.ByteSize) *RequestBuilder {
	rb.v.MaxReadRequestSize = &maxreadrequestsize
	return rb
}

func (rb *RequestBuilder) MaxRetryDelay(maxretrydelay types.Time) *RequestBuilder {
...
func (rb *RequestBuilder) MaxWriteBufferSize(maxwritebuffersize types.ByteSize) *RequestBuilder {
...
func (rb *RequestBuilder) MaxWriteRequestSize(maxwriterequestsize types.ByteSize) *RequestBuilder {
	rb.v.MaxWriteRequestSize = &maxwriterequestsize
	return rb
}

func (rb *RequestBuilder) ReadPollTimeout(readpolltimeout types.Time) *RequestBuilder {
