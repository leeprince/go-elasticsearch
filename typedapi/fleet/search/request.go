...
func (rb *RequestBuilder) Aggregations(value map[string]types.AggregationContainer) *RequestBuilder {
	rb.v.Aggregations = value
	return rb
}

func (rb *RequestBuilder) Collapse(collapse types.FieldCollapse) *RequestBuilder {
...
func (rb *RequestBuilder) Fields(fields ...types.FieldAndFormat) *RequestBuilder {
...
func (rb *RequestBuilder) Highlight(highlight types.Highlight) *RequestBuilder {
	rb.v.Highlight = &highlight
	return rb
}

func (rb *RequestBuilder) IndicesBoost(value ...map[types.IndexName]float64) *RequestBuilder {
	rb.v.IndicesBoost = append(rb.v.IndicesBoost, value...)
	return rb
}
...
func (rb *RequestBuilder) Pit(pit types.PointInTimeReference) *RequestBuilder {
	rb.v.Pit = &pit
	return rb
}

func (rb *RequestBuilder) PostFilter(postfilter types.QueryContainer) *RequestBuilder {
...
func (rb *RequestBuilder) RuntimeMappings(runtimemappings types.RuntimeFields) *RequestBuilder {
	rb.v.RuntimeMappings = &runtimemappings
	return rb
}

func (rb *RequestBuilder) ScriptFields(value map[string]types.ScriptField) *RequestBuilder {
	rb.v.ScriptFields = value
	return rb
}

func (rb *RequestBuilder) SearchAfter(searchafter types.SortResults) *RequestBuilder {
...
func (rb *RequestBuilder) Slice(slice types.SlicedScroll) *RequestBuilder {
	rb.v.Slice = &slice
	return rb
}

func (rb *RequestBuilder) Sort(sort types.Sort) *RequestBuilder {
	rb.v.Sort = &sort
	return rb
}
...
func (rb *RequestBuilder) Stats(stats ...string) *RequestBuilder {
	rb.v.Stats = append(rb.v.Stats, stats...)
	return rb
}
...
func (rb *RequestBuilder) Suggest(suggest types.Suggester) *RequestBuilder {
	rb.v.Suggest = &suggest
	return rb
}
...
func (rb *RequestBuilder) TrackTotalHits(tracktotalhits types.TrackHits) *RequestBuilder {
	rb.v.TrackTotalHits = &tracktotalhits
	return rb
}
