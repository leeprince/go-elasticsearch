...
func (rb *RequestBuilder) License(license types.License) *RequestBuilder {
	rb.v.License = &license
	return rb
}

func (rb *RequestBuilder) Licenses(licenses ...types.License) *RequestBuilder {
	rb.v.Licenses = append(rb.v.Licenses, licenses...)
	return rb
}
