...
func (rb *RequestBuilder) OnFailure(on_failure ...types.ProcessorContainer) *RequestBuilder {
	rb.v.OnFailure = append(rb.v.OnFailure, on_failure...)
	return rb
}

func (rb *RequestBuilder) Processors(processors ...types.ProcessorContainer) *RequestBuilder {
