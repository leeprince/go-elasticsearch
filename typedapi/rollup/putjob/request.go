...
func (rb *RequestBuilder) Groups(groups types.Groupings) *RequestBuilder {
	rb.v.Groups = groups
	return rb
}
...
func (rb *RequestBuilder) Metrics(metrics ...types.FieldMetric) *RequestBuilder {
...
func (rb *RequestBuilder) Timeout(timeout types.Time) *RequestBuilder {
