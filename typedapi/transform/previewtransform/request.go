...
func (rb *RequestBuilder) Dest(dest types.Destination) *RequestBuilder {
	rb.v.Dest = &dest
	return rb
}
...
func (rb *RequestBuilder) Latest(latest types.Latest) *RequestBuilder {
	rb.v.Latest = &latest
	return rb
}

func (rb *RequestBuilder) Pivot(pivot types.Pivot) *RequestBuilder {
	rb.v.Pivot = &pivot
	return rb
}
...
func (rb *RequestBuilder) Settings(settings types.Settings) *RequestBuilder {
	rb.v.Settings = &settings
	return rb
}

func (rb *RequestBuilder) Source(source types.Source) *RequestBuilder {
	rb.v.Source = &source
	return rb
}

func (rb *RequestBuilder) Sync(sync types.SyncContainer) *RequestBuilder {
	rb.v.Sync = &sync
	return rb
}
