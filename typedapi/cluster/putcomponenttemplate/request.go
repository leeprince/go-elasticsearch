...
func (rb *RequestBuilder) Aliases(value map[string]types.AliasDefinition) *RequestBuilder {
	rb.v.Aliases = value
	return rb
}
...
func (rb *RequestBuilder) Template(template types.IndexState) *RequestBuilder {
