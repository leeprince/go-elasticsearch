...
func (rb *RequestBuilder) SimulatedActions(simulatedactions types.SimulatedActions) *RequestBuilder {
	rb.v.SimulatedActions = &simulatedactions
	return rb
}

func (rb *RequestBuilder) TriggerData(triggerdata types.ScheduleTriggerEvent) *RequestBuilder {
	rb.v.TriggerData = &triggerdata
	return rb
}

func (rb *RequestBuilder) Watch(watch types.Watch) *RequestBuilder {
	rb.v.Watch = &watch
	return rb
}
