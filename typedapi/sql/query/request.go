...
func (rb *RequestBuilder) Filter(filter types.QueryContainer) *RequestBuilder {
	rb.v.Filter = &filter
	return rb
}
...
func (rb *RequestBuilder) KeepAlive(keepalive types.Time) *RequestBuilder {
...
func (rb *RequestBuilder) PageTimeout(pagetimeout types.Time) *RequestBuilder {
	rb.v.PageTimeout = &pagetimeout
	return rb
}
...
func (rb *RequestBuilder) RequestTimeout(requesttimeout types.Time) *RequestBuilder {
	rb.v.RequestTimeout = &requesttimeout
	return rb
}
...
func (rb *RequestBuilder) WaitForCompletionTimeout(waitforcompletiontimeout types.Time) *RequestBuilder {
	rb.v.WaitForCompletionTimeout = &waitforcompletiontimeout
	return rb
}
