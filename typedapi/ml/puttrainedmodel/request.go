...
func (rb *RequestBuilder) Definition(definition types.Definition) *RequestBuilder {
...
func (rb *RequestBuilder) InferenceConfig(inferenceconfig types.InferenceConfigCreateContainer) *RequestBuilder {
	rb.v.InferenceConfig = inferenceconfig
	return rb
}

func (rb *RequestBuilder) Input(input types.Input) *RequestBuilder {
	rb.v.Input = input
	return rb
}
