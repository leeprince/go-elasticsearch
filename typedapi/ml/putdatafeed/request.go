...
func (rb *RequestBuilder) ChunkingConfig(chunkingconfig types.ChunkingConfig) *RequestBuilder {
	rb.v.ChunkingConfig = &chunkingconfig
	return rb
}

func (rb *RequestBuilder) DelayedDataCheckConfig(delayeddatacheckconfig types.DelayedDataCheckConfig) *RequestBuilder {
	rb.v.DelayedDataCheckConfig = &delayeddatacheckconfig
	return rb
}

func (rb *RequestBuilder) Frequency(frequency types.Time) *RequestBuilder {
	rb.v.Frequency = &frequency
	return rb
}

func (rb *RequestBuilder) Headers(headers types.HttpHeaders) *RequestBuilder {
	rb.v.Headers = &headers
	return rb
}

func (rb *RequestBuilder) Indices(indices types.Indices) *RequestBuilder {
	rb.v.Indices = &indices
	return rb
}

func (rb *RequestBuilder) IndicesOptions(indicesoptions types.IndicesOptions) *RequestBuilder {
...
func (rb *RequestBuilder) QueryDelay(querydelay types.Time) *RequestBuilder {
