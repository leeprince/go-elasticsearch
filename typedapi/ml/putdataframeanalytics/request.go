...
func (rb *RequestBuilder) Analysis(analysis types.DataframeAnalysisContainer) *RequestBuilder {
	rb.v.Analysis = analysis
	return rb
}

func (rb *RequestBuilder) AnalyzedFields(analyzedfields types.DataframeAnalysisAnalyzedFields) *RequestBuilder {
...
func (rb *RequestBuilder) Dest(dest types.DataframeAnalyticsDestination) *RequestBuilder {
	rb.v.Dest = dest
	return rb
}
...
func (rb *RequestBuilder) Source(source types.DataframeAnalyticsSource) *RequestBuilder {
	rb.v.Source = source
	return rb
}
