...
func (rb *RequestBuilder) Duration(duration types.Time) *RequestBuilder {
	rb.v.Duration = &duration
	return rb
}

func (rb *RequestBuilder) ExpiresIn(expiresin types.Time) *RequestBuilder {
	rb.v.ExpiresIn = &expiresin
	return rb
}
