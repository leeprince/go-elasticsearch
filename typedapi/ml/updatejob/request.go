...
func (rb *RequestBuilder) AnalysisLimits(analysislimits types.AnalysisMemoryLimit) *RequestBuilder {
...
func (rb *RequestBuilder) Detectors(detectors ...types.Detector) *RequestBuilder {
...
func (rb *RequestBuilder) PerPartitionCategorization(perpartitioncategorization types.PerPartitionCategorization) *RequestBuilder {
