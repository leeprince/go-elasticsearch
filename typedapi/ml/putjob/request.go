...
type Request struct {
	...
	// value too low.
	BackgroundPersistInterval types.Time `json:"background_persist_interval"`
...
func (rb *RequestBuilder) AnalysisConfig(analysisconfig types.AnalysisConfig) *RequestBuilder {
	rb.v.AnalysisConfig = analysisconfig
	return rb
}

func (rb *RequestBuilder) AnalysisLimits(analysislimits types.AnalysisLimits) *RequestBuilder {
	rb.v.AnalysisLimits = &analysislimits
	return rb
}

func (rb *RequestBuilder) BackgroundPersistInterval(backgroundpersistinterval types.Time) *RequestBuilder {
	rb.v.BackgroundPersistInterval = backgroundpersistinterval
	return rb
}

func (rb *RequestBuilder) CustomSettings(customsettings types.CustomSettings) *RequestBuilder {
...
func (rb *RequestBuilder) DataDescription(datadescription types.DataDescription) *RequestBuilder {
	rb.v.DataDescription = datadescription
	return rb
}

func (rb *RequestBuilder) DatafeedConfig(datafeedconfig types.DatafeedConfig) *RequestBuilder {
...
func (rb *RequestBuilder) ModelPlotConfig(modelplotconfig types.ModelPlotConfig) *RequestBuilder {
