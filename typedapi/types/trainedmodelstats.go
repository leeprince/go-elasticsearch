...
func NewTrainedModelStats() *TrainedModelStatsBuilder {
...
// DeploymentStats A collection of deployment stats, which is present when the models are
// deployed.
func (rb *TrainedModelStatsBuilder) DeploymentStats(deploymentstats TrainedModelDeploymentStats) *TrainedModelStatsBuilder {
	rb.v.DeploymentStats = &deploymentstats
	return rb
}

// InferenceStats A collection of inference stats fields.
func (rb *TrainedModelStatsBuilder) InferenceStats(inferencestats TrainedModelInferenceStats) *TrainedModelStatsBuilder {
	rb.v.InferenceStats = &inferencestats
	return rb
}
...
// ModelSizeStats A collection of model size stats.
func (rb *TrainedModelStatsBuilder) ModelSizeStats(modelsizestats TrainedModelSizeStats) *TrainedModelStatsBuilder {
