...
func NewKeyedProcessor() *KeyedProcessorBuilder {
...
// Stats set the Stats property for KeyedProcessorBuilder.
func (rb *KeyedProcessorBuilder) Stats(stats Processor) *KeyedProcessorBuilder {
	rb.v.Stats = &stats
	return rb
}

// Type set the Type property for KeyedProcessorBuilder.
