...
func NewTrainedModelSizeStats() *TrainedModelSizeStatsBuilder {
...
// ModelSizeBytes The size of the model in bytes.
func (rb *TrainedModelSizeStatsBuilder) ModelSizeBytes(modelsizebytes ByteSize) *TrainedModelSizeStatsBuilder {
