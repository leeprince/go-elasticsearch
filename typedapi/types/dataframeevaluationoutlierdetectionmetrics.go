...
func NewDataframeEvaluationOutlierDetectionMetrics() *DataframeEvaluationOutlierDetectionMetricsBuilder {
...
// score and optionally the curve. It is calculated for a specific class
// (provided as "class_name") treated as positive.
func (rb *DataframeEvaluationOutlierDetectionMetricsBuilder) AucRoc(aucroc DataframeEvaluationClassificationMetricsAucRoc) *DataframeEvaluationOutlierDetectionMetricsBuilder {
	rb.v.AucRoc = &aucroc
	return rb
}
