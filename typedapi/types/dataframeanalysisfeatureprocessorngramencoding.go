...
func NewDataframeAnalysisFeatureProcessorNGramEncoding() *DataframeAnalysisFeatureProcessorNGramEncodingBuilder {
...
// Custom set the Custom property for DataframeAnalysisFeatureProcessorNGramEncodingBuilder.
...
func (rb *DataframeAnalysisFeatureProcessorNGramEncodingBuilder) NGrams(n_grams ...int) *DataframeAnalysisFeatureProcessorNGramEncodingBuilder {
	rb.v.NGrams = append(rb.v.NGrams, n_grams...)
	return rb
}
