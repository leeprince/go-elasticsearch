...
func NewDataTierPhaseStatistics() *DataTierPhaseStatisticsBuilder {
...
// DocCount set the DocCount property for DataTierPhaseStatisticsBuilder.
func (rb *DataTierPhaseStatisticsBuilder) DocCount(doccount int64) *DataTierPhaseStatisticsBuilder {
	rb.v.DocCount = doccount
	return rb
}

// IndexCount set the IndexCount property for DataTierPhaseStatisticsBuilder.
...
// NodeCount set the NodeCount property for DataTierPhaseStatisticsBuilder.
func (rb *DataTierPhaseStatisticsBuilder) NodeCount(nodecount int64) *DataTierPhaseStatisticsBuilder {
	rb.v.NodeCount = nodecount
	return rb
}

// PrimaryShardCount set the PrimaryShardCount property for DataTierPhaseStatisticsBuilder.
...
// PrimaryShardSizeAvgBytes set the PrimaryShardSizeAvgBytes property for DataTierPhaseStatisticsBuilder.
...
// PrimaryShardSizeMadBytes set the PrimaryShardSizeMadBytes property for DataTierPhaseStatisticsBuilder.
...
// PrimaryShardSizeMedianBytes set the PrimaryShardSizeMedianBytes property for DataTierPhaseStatisticsBuilder.
...
// PrimarySizeBytes set the PrimarySizeBytes property for DataTierPhaseStatisticsBuilder.
...
// TotalShardCount set the TotalShardCount property for DataTierPhaseStatisticsBuilder.
...
// TotalSizeBytes set the TotalSizeBytes property for DataTierPhaseStatisticsBuilder.
