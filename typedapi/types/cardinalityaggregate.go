...
func NewCardinalityAggregate() *CardinalityAggregateBuilder {
...
// Meta set the Meta property for CardinalityAggregateBuilder.
func (rb *CardinalityAggregateBuilder) Meta(meta Metadata) *CardinalityAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Value set the Value property for CardinalityAggregateBuilder.
