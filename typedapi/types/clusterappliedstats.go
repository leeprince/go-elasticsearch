...
func NewClusterAppliedStats() *ClusterAppliedStatsBuilder {
...
// Recordings set the Recordings property for ClusterAppliedStatsBuilder.
func (rb *ClusterAppliedStatsBuilder) Recordings(recordings ...Recording) *ClusterAppliedStatsBuilder {
	rb.v.Recordings = append(rb.v.Recordings, recordings...)
	return rb
}
