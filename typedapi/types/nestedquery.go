...
func NewNestedQuery() *NestedQueryBuilder {
...
// Boost set the Boost property for NestedQueryBuilder.
func (rb *NestedQueryBuilder) Boost(boost float32) *NestedQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// IgnoreUnmapped set the IgnoreUnmapped property for NestedQueryBuilder.
func (rb *NestedQueryBuilder) IgnoreUnmapped(ignoreunmapped bool) *NestedQueryBuilder {
	rb.v.IgnoreUnmapped = &ignoreunmapped
	return rb
}

// InnerHits set the InnerHits property for NestedQueryBuilder.
func (rb *NestedQueryBuilder) InnerHits(innerhits InnerHits) *NestedQueryBuilder {
	rb.v.InnerHits = &innerhits
	return rb
}

// Path set the Path property for NestedQueryBuilder.
func (rb *NestedQueryBuilder) Path(path Field) *NestedQueryBuilder {
	rb.v.Path = path
	return rb
}

// Query set the Query property for NestedQueryBuilder.
func (rb *NestedQueryBuilder) Query(query QueryContainer) *NestedQueryBuilder {
	rb.v.Query = &query
	return rb
}

// QueryName_ set the QueryName_ property for NestedQueryBuilder.
func (rb *NestedQueryBuilder) QueryName_(queryname_ string) *NestedQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// ScoreMode set the ScoreMode property for NestedQueryBuilder.
