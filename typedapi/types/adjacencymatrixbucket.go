...
func NewAdjacencyMatrixBucket() *AdjacencyMatrixBucketBuilder {
...
// Aggregations set the Aggregations property for AdjacencyMatrixBucketBuilder.
func (rb *AdjacencyMatrixBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *AdjacencyMatrixBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for AdjacencyMatrixBucketBuilder.
