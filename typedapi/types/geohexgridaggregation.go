...
func NewGeohexGridAggregation() *GeohexGridAggregationBuilder {
...
// Bounds Bounding box used to filter the geo-points in each bucket.
func (rb *GeohexGridAggregationBuilder) Bounds(bounds GeoBounds) *GeohexGridAggregationBuilder {
	rb.v.Bounds = &bounds
	return rb
}
...
// Meta set the Meta property for GeohexGridAggregationBuilder.
func (rb *GeohexGridAggregationBuilder) Meta(meta Metadata) *GeohexGridAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for GeohexGridAggregationBuilder.
