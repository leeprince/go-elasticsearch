...
func NewBucketSummary() *BucketSummaryBuilder {
...
// BucketInfluencers set the BucketInfluencers property for BucketSummaryBuilder.
func (rb *BucketSummaryBuilder) BucketInfluencers(bucket_influencers ...BucketInfluencer) *BucketSummaryBuilder {
	rb.v.BucketInfluencers = append(rb.v.BucketInfluencers, bucket_influencers...)
	return rb
}

// BucketSpan The length of the bucket in seconds. This value matches the bucket span that
// is specified in the job.
func (rb *BucketSummaryBuilder) BucketSpan(bucketspan Time) *BucketSummaryBuilder {
...
// Events that occur exactly at the
// timestamp of the bucket are included in the results for the bucket.
func (rb *BucketSummaryBuilder) Timestamp(timestamp Time) *BucketSummaryBuilder {
