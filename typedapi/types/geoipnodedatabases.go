...
func NewGeoIpNodeDatabases() *GeoIpNodeDatabasesBuilder {
...
// Databases Downloaded databases for the node.
func (rb *GeoIpNodeDatabasesBuilder) Databases(databases ...GeoIpNodeDatabaseName) *GeoIpNodeDatabasesBuilder {
	rb.v.Databases = append(rb.v.Databases, databases...)
	return rb
}
...
func (rb *GeoIpNodeDatabasesBuilder) FilesInTemp(files_in_temp ...string) *GeoIpNodeDatabasesBuilder {
	rb.v.FilesInTemp = append(rb.v.FilesInTemp, files_in_temp...)
	return rb
}
