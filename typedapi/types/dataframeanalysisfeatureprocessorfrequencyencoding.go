...
func NewDataframeAnalysisFeatureProcessorFrequencyEncoding() *DataframeAnalysisFeatureProcessorFrequencyEncodingBuilder {
...
// Field set the Field property for DataframeAnalysisFeatureProcessorFrequencyEncodingBuilder.
