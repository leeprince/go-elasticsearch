...
func NewSuggestBase() *SuggestBaseBuilder {
...
// Length set the Length property for SuggestBaseBuilder.
func (rb *SuggestBaseBuilder) Length(length int) *SuggestBaseBuilder {
	rb.v.Length = length
	return rb
}

// Offset set the Offset property for SuggestBaseBuilder.
func (rb *SuggestBaseBuilder) Offset(offset int) *SuggestBaseBuilder {
	rb.v.Offset = offset
	return rb
}

// Text set the Text property for SuggestBaseBuilder.
