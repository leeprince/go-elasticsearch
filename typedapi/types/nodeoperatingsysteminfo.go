...
func NewNodeOperatingSystemInfo() *NodeOperatingSystemInfoBuilder {
...
// Cpu set the Cpu property for NodeOperatingSystemInfoBuilder.
func (rb *NodeOperatingSystemInfoBuilder) Cpu(cpu NodeInfoOSCPU) *NodeOperatingSystemInfoBuilder {
	rb.v.Cpu = &cpu
	return rb
}

// Mem set the Mem property for NodeOperatingSystemInfoBuilder.
func (rb *NodeOperatingSystemInfoBuilder) Mem(mem NodeInfoMemory) *NodeOperatingSystemInfoBuilder {
	rb.v.Mem = &mem
	return rb
}
...
// PrettyName set the PrettyName property for NodeOperatingSystemInfoBuilder.
...
// Swap set the Swap property for NodeOperatingSystemInfoBuilder.
func (rb *NodeOperatingSystemInfoBuilder) Swap(swap NodeInfoMemory) *NodeOperatingSystemInfoBuilder {
	rb.v.Swap = &swap
	return rb
}
