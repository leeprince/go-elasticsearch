...
func NewAutoscalingCapacity() *AutoscalingCapacityBuilder {
...
// Node set the Node property for AutoscalingCapacityBuilder.
func (rb *AutoscalingCapacityBuilder) Node(node AutoscalingResources) *AutoscalingCapacityBuilder {
	rb.v.Node = node
	return rb
}

// Total set the Total property for AutoscalingCapacityBuilder.
func (rb *AutoscalingCapacityBuilder) Total(total AutoscalingResources) *AutoscalingCapacityBuilder {
	rb.v.Total = total
	return rb
}
