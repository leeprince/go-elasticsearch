...
func NewDataframeEvaluationRegression() *DataframeEvaluationRegressionBuilder {
...
// on mse, msle, and huber, consult the Jupyter notebook on regression loss
// functions.
func (rb *DataframeEvaluationRegressionBuilder) Metrics(metrics DataframeEvaluationRegressionMetrics) *DataframeEvaluationRegressionBuilder {
