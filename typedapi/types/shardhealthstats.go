...
func NewShardHealthStats() *ShardHealthStatsBuilder {
...
// ActiveShards set the ActiveShards property for ShardHealthStatsBuilder.
func (rb *ShardHealthStatsBuilder) ActiveShards(activeshards int) *ShardHealthStatsBuilder {
	rb.v.ActiveShards = activeshards
	return rb
}

// InitializingShards set the InitializingShards property for ShardHealthStatsBuilder.
...
// PrimaryActive set the PrimaryActive property for ShardHealthStatsBuilder.
func (rb *ShardHealthStatsBuilder) PrimaryActive(primaryactive bool) *ShardHealthStatsBuilder {
	rb.v.PrimaryActive = primaryactive
	return rb
}

// RelocatingShards set the RelocatingShards property for ShardHealthStatsBuilder.
...
// Status set the Status property for ShardHealthStatsBuilder.
func (rb *ShardHealthStatsBuilder) Status(status healthstatus.HealthStatus) *ShardHealthStatsBuilder {
	rb.v.Status = status
	return rb
}

// UnassignedShards set the UnassignedShards property for ShardHealthStatsBuilder.
