...
func NewBaseNode() *BaseNodeBuilder {
	r := BaseNodeBuilder{
		&BaseNode{
...
// Attributes set the Attributes property for BaseNodeBuilder.
func (rb *BaseNodeBuilder) Attributes(value map[string]string) *BaseNodeBuilder {
	rb.v.Attributes = value
	return rb
}

// Host set the Host property for BaseNodeBuilder.
func (rb *BaseNodeBuilder) Host(host Host) *BaseNodeBuilder {
	rb.v.Host = host
	return rb
}

// Ip set the Ip property for BaseNodeBuilder.
func (rb *BaseNodeBuilder) Ip(ip Ip) *BaseNodeBuilder {
	rb.v.Ip = ip
	return rb
}

// Name set the Name property for BaseNodeBuilder.
func (rb *BaseNodeBuilder) Name(name Name) *BaseNodeBuilder {
	rb.v.Name = name
	return rb
}

// Roles set the Roles property for BaseNodeBuilder.
func (rb *BaseNodeBuilder) Roles(roles NodeRoles) *BaseNodeBuilder {
	rb.v.Roles = &roles
	return rb
}

// TransportAddress set the TransportAddress property for BaseNodeBuilder.
