...
func NewRepositoryMeteringInformation() *RepositoryMeteringInformationBuilder {
...
// RepositoryLocation Represents an unique location within the repository.
func (rb *RepositoryMeteringInformationBuilder) RepositoryLocation(repositorylocation RepositoryLocation) *RepositoryMeteringInformationBuilder {
	rb.v.RepositoryLocation = repositorylocation
	return rb
}
...
// RepositoryStartedAt Time the repository was created or updated. Recorded in milliseconds since
// the Unix Epoch.
func (rb *RepositoryMeteringInformationBuilder) RepositoryStartedAt(repositorystartedat EpochMillis) *RepositoryMeteringInformationBuilder {
	rb.v.RepositoryStartedAt = repositorystartedat
	return rb
}

// RepositoryStoppedAt Time the repository was deleted or updated. Recorded in milliseconds since
// the Unix Epoch.
func (rb *RepositoryMeteringInformationBuilder) RepositoryStoppedAt(repositorystoppedat EpochMillis) *RepositoryMeteringInformationBuilder {
	rb.v.RepositoryStoppedAt = &repositorystoppedat
	return rb
}
...
// RequestCounts An object with the number of request performed against the repository grouped
// by request type.
func (rb *RepositoryMeteringInformationBuilder) RequestCounts(requestcounts RequestCounts) *RepositoryMeteringInformationBuilder {
	rb.v.RequestCounts = requestcounts
	return rb
}
