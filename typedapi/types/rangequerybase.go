...
func NewRangeQueryBase() *RangeQueryBaseBuilder {
...
// Boost set the Boost property for RangeQueryBaseBuilder.
func (rb *RangeQueryBaseBuilder) Boost(boost float32) *RangeQueryBaseBuilder {
	rb.v.Boost = &boost
	return rb
}

// QueryName_ set the QueryName_ property for RangeQueryBaseBuilder.
func (rb *RangeQueryBaseBuilder) QueryName_(queryname_ string) *RangeQueryBaseBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// Relation set the Relation property for RangeQueryBaseBuilder.
