...
func NewHttpInputResponseResult() *HttpInputResponseResultBuilder {
...
// Body set the Body property for HttpInputResponseResultBuilder.
func (rb *HttpInputResponseResultBuilder) Body(body string) *HttpInputResponseResultBuilder {
	rb.v.Body = body
	return rb
}

// Headers set the Headers property for HttpInputResponseResultBuilder.
func (rb *HttpInputResponseResultBuilder) Headers(headers HttpHeaders) *HttpInputResponseResultBuilder {
	rb.v.Headers = headers
	return rb
}

// Status set the Status property for HttpInputResponseResultBuilder.
