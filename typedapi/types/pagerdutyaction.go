...
func NewPagerDutyAction() *PagerDutyActionBuilder {
...
// Account set the Account property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) Account(account string) *PagerDutyActionBuilder {
	rb.v.Account = &account
	return rb
}

// AttachPayload set the AttachPayload property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) AttachPayload(attachpayload bool) *PagerDutyActionBuilder {
	rb.v.AttachPayload = attachpayload
	return rb
}

// Client set the Client property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) Client(client string) *PagerDutyActionBuilder {
	rb.v.Client = &client
	return rb
}

// ClientUrl set the ClientUrl property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) ClientUrl(clienturl string) *PagerDutyActionBuilder {
	rb.v.ClientUrl = &clienturl
	return rb
}

// Contexts set the Contexts property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) Contexts(contexts ...PagerDutyContext) *PagerDutyActionBuilder {
	rb.v.Contexts = append(rb.v.Contexts, contexts...)
	return rb
}

// Description set the Description property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) Description(description string) *PagerDutyActionBuilder {
	rb.v.Description = description
	return rb
}

// EventType set the EventType property for PagerDutyActionBuilder.
...
// IncidentKey set the IncidentKey property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) IncidentKey(incidentkey string) *PagerDutyActionBuilder {
	rb.v.IncidentKey = incidentkey
	return rb
}

// Proxy set the Proxy property for PagerDutyActionBuilder.
func (rb *PagerDutyActionBuilder) Proxy(proxy PagerDutyEventProxy) *PagerDutyActionBuilder {
	rb.v.Proxy = &proxy
	return rb
}
