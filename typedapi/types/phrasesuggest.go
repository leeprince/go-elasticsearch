...
func NewPhraseSuggest() *PhraseSuggestBuilder {
...
// Length set the Length property for PhraseSuggestBuilder.
func (rb *PhraseSuggestBuilder) Length(length int) *PhraseSuggestBuilder {
	rb.v.Length = length
	return rb
}

// Offset set the Offset property for PhraseSuggestBuilder.
func (rb *PhraseSuggestBuilder) Offset(offset int) *PhraseSuggestBuilder {
	rb.v.Offset = offset
	return rb
}

// Options set the Options property for PhraseSuggestBuilder.
func (rb *PhraseSuggestBuilder) Options(options PhraseSuggestOption) *PhraseSuggestBuilder {
	rb.v.Options = options
	return rb
}

// Text set the Text property for PhraseSuggestBuilder.
