...
func NewMatchQuery() *MatchQueryBuilder {
	r := MatchQueryBuilder{
		&MatchQuery{},
	}
...
// Analyzer set the Analyzer property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) Analyzer(analyzer string) *MatchQueryBuilder {
	rb.v.Analyzer = &analyzer
	return rb
}

// AutoGenerateSynonymsPhraseQuery set the AutoGenerateSynonymsPhraseQuery property for MatchQueryBuilder.
...
// Boost set the Boost property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) Boost(boost float32) *MatchQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// CutoffFrequency set the CutoffFrequency property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) CutoffFrequency(cutofffrequency float64) *MatchQueryBuilder {
	rb.v.CutoffFrequency = &cutofffrequency
	return rb
}

// Fuzziness set the Fuzziness property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) Fuzziness(fuzziness Fuzziness) *MatchQueryBuilder {
	rb.v.Fuzziness = &fuzziness
	return rb
}

// FuzzyRewrite set the FuzzyRewrite property for MatchQueryBuilder.
...
// FuzzyTranspositions set the FuzzyTranspositions property for MatchQueryBuilder.
...
// Lenient set the Lenient property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) Lenient(lenient bool) *MatchQueryBuilder {
	rb.v.Lenient = &lenient
	return rb
}

// MaxExpansions set the MaxExpansions property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) MaxExpansions(maxexpansions int) *MatchQueryBuilder {
	rb.v.MaxExpansions = &maxexpansions
	return rb
}

// MinimumShouldMatch set the MinimumShouldMatch property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) MinimumShouldMatch(minimumshouldmatch MinimumShouldMatch) *MatchQueryBuilder {
	rb.v.MinimumShouldMatch = &minimumshouldmatch
	return rb
}

// Operator set the Operator property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) Operator(operator operator.Operator) *MatchQueryBuilder {
	rb.v.Operator = &operator
	return rb
}

// PrefixLength set the PrefixLength property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) PrefixLength(prefixlength int) *MatchQueryBuilder {
	rb.v.PrefixLength = &prefixlength
	return rb
}

// Query set the Query property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) Query(arg string) *MatchQueryBuilder {
	rb.v.Query = arg
	return rb
}

// QueryName_ set the QueryName_ property for MatchQueryBuilder.
func (rb *MatchQueryBuilder) QueryName_(queryname_ string) *MatchQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// ZeroTermsQuery set the ZeroTermsQuery property for MatchQueryBuilder.
