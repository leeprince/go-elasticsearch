...
func NewClusterRemoteProxyInfo() *ClusterRemoteProxyInfoBuilder {
...
// Connected set the Connected property for ClusterRemoteProxyInfoBuilder.
func (rb *ClusterRemoteProxyInfoBuilder) Connected(connected bool) *ClusterRemoteProxyInfoBuilder {
	rb.v.Connected = connected
	return rb
}

// InitialConnectTimeout set the InitialConnectTimeout property for ClusterRemoteProxyInfoBuilder.
func (rb *ClusterRemoteProxyInfoBuilder) InitialConnectTimeout(initialconnecttimeout Time) *ClusterRemoteProxyInfoBuilder {
	rb.v.InitialConnectTimeout = initialconnecttimeout
	return rb
}

// MaxProxySocketConnections set the MaxProxySocketConnections property for ClusterRemoteProxyInfoBuilder.
...
// Mode set the Mode property for ClusterRemoteProxyInfoBuilder.

// NumProxySocketsConnected set the NumProxySocketsConnected property for ClusterRemoteProxyInfoBuilder.
...
// ProxyAddress set the ProxyAddress property for ClusterRemoteProxyInfoBuilder.
...
// ServerName set the ServerName property for ClusterRemoteProxyInfoBuilder.
...
// SkipUnavailable set the SkipUnavailable property for ClusterRemoteProxyInfoBuilder.
