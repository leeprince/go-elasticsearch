...
func NewWhitespaceAnalyzer() *WhitespaceAnalyzerBuilder {
...
// Type set the Type property for WhitespaceAnalyzerBuilder.

// Version set the Version property for WhitespaceAnalyzerBuilder.
