...
func NewIndicesPrivileges() *IndicesPrivilegesBuilder {
...
// Names A list of indices (or index name patterns) to which the permissions in this
// entry apply.
func (rb *IndicesPrivilegesBuilder) Names(names Indices) *IndicesPrivilegesBuilder {
	rb.v.Names = names
	return rb
}
...
func (rb *IndicesPrivilegesBuilder) Privileges(privileges ...indexprivilege.IndexPrivilege) *IndicesPrivilegesBuilder {
	rb.v.Privileges = append(rb.v.Privileges, privileges...)
	return rb
}
...
// access to. A document within the specified indices must match this query for
// it to be accessible by the owners of the role.
func (rb *IndicesPrivilegesBuilder) Query(query IndicesPrivilegesQuery) *IndicesPrivilegesBuilder {
	rb.v.Query = &query
	return rb
}
