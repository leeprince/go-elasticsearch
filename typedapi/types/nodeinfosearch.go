...
func NewNodeInfoSearch() *NodeInfoSearchBuilder {
...
// Remote set the Remote property for NodeInfoSearchBuilder.
func (rb *NodeInfoSearchBuilder) Remote(remote NodeInfoSearchRemote) *NodeInfoSearchBuilder {
	rb.v.Remote = remote
	return rb
}
