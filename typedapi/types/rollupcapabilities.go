...
func NewRollupCapabilities() *RollupCapabilitiesBuilder {
...
// RollupJobs set the RollupJobs property for RollupCapabilitiesBuilder.
func (rb *RollupCapabilitiesBuilder) RollupJobs(rollup_jobs ...RollupCapabilitySummary) *RollupCapabilitiesBuilder {
	rb.v.RollupJobs = append(rb.v.RollupJobs, rollup_jobs...)
	return rb
}
