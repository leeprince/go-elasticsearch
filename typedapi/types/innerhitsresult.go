...
func NewInnerHitsResult() *InnerHitsResultBuilder {
...
// Hits set the Hits property for InnerHitsResultBuilder.
func (rb *InnerHitsResultBuilder) Hits(hits HitsMetadata) *InnerHitsResultBuilder {
	rb.v.Hits = &hits
	return rb
}
