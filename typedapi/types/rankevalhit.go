...
func NewRankEvalHit() *RankEvalHitBuilder {
...
// Id_ set the Id_ property for RankEvalHitBuilder.
func (rb *RankEvalHitBuilder) Id_(id_ Id) *RankEvalHitBuilder {
	rb.v.Id_ = id_
	return rb
}

// Index_ set the Index_ property for RankEvalHitBuilder.
func (rb *RankEvalHitBuilder) Index_(index_ IndexName) *RankEvalHitBuilder {
	rb.v.Index_ = index_
	return rb
}

// Score_ set the Score_ property for RankEvalHitBuilder.
