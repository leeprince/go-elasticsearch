...
func NewClusterShardMetrics() *ClusterShardMetricsBuilder {
...
// Avg set the Avg property for ClusterShardMetricsBuilder.
func (rb *ClusterShardMetricsBuilder) Avg(avg float64) *ClusterShardMetricsBuilder {
	rb.v.Avg = avg
	return rb
}

// Max set the Max property for ClusterShardMetricsBuilder.
func (rb *ClusterShardMetricsBuilder) Max(max float64) *ClusterShardMetricsBuilder {
	rb.v.Max = max
	return rb
}

// Min set the Min property for ClusterShardMetricsBuilder.
