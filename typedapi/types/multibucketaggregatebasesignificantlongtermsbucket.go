...
func NewMultiBucketAggregateBaseSignificantLongTermsBucket() *MultiBucketAggregateBaseSignificantLongTermsBucketBuilder {
...
// Buckets set the Buckets property for MultiBucketAggregateBaseSignificantLongTermsBucketBuilder.
func (rb *MultiBucketAggregateBaseSignificantLongTermsBucketBuilder) Buckets(buckets BucketsSignificantLongTermsBucket) *MultiBucketAggregateBaseSignificantLongTermsBucketBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for MultiBucketAggregateBaseSignificantLongTermsBucketBuilder.
func (rb *MultiBucketAggregateBaseSignificantLongTermsBucketBuilder) Meta(meta Metadata) *MultiBucketAggregateBaseSignificantLongTermsBucketBuilder {
	rb.v.Meta = &meta
	return rb
}
