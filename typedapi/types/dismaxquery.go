...
func NewDisMaxQuery() *DisMaxQueryBuilder {
...
// Boost set the Boost property for DisMaxQueryBuilder.
func (rb *DisMaxQueryBuilder) Boost(boost float32) *DisMaxQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Queries set the Queries property for DisMaxQueryBuilder.
func (rb *DisMaxQueryBuilder) Queries(queries ...QueryContainer) *DisMaxQueryBuilder {
	rb.v.Queries = append(rb.v.Queries, queries...)
	return rb
}

// QueryName_ set the QueryName_ property for DisMaxQueryBuilder.
func (rb *DisMaxQueryBuilder) QueryName_(queryname_ string) *DisMaxQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// TieBreaker set the TieBreaker property for DisMaxQueryBuilder.
