...
// Int set the Int property for SlicesBuilder.
func (u *SlicesBuilder) Int(v int) *SlicesBuilder {
	u.v = v
	return u
}

// SlicesCalculation set the SlicesCalculation property for SlicesBuilder.
func (u *SlicesBuilder) SlicesCalculation(v slicescalculation.SlicesCalculation) *SlicesBuilder {
	u.v = v
	return u
}
