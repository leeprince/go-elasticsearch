...
func NewSuggester() *SuggesterBuilder {
	r := SuggesterBuilder{
		&Suggester{
...
// Suggesters set the Suggesters property for SuggesterBuilder.
func (rb *SuggesterBuilder) Suggesters(value map[string]FieldSuggester) *SuggesterBuilder {
	rb.v.Suggesters = value
	return rb
}
