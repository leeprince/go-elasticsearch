...
func NewAliasDefinition() *AliasDefinitionBuilder {
...
// Filter set the Filter property for AliasDefinitionBuilder.
func (rb *AliasDefinitionBuilder) Filter(filter QueryContainer) *AliasDefinitionBuilder {
	rb.v.Filter = &filter
	return rb
}

// IndexRouting set the IndexRouting property for AliasDefinitionBuilder.
func (rb *AliasDefinitionBuilder) IndexRouting(indexrouting string) *AliasDefinitionBuilder {
	rb.v.IndexRouting = &indexrouting
	return rb
}

// IsHidden set the IsHidden property for AliasDefinitionBuilder.
func (rb *AliasDefinitionBuilder) IsHidden(ishidden bool) *AliasDefinitionBuilder {
	rb.v.IsHidden = &ishidden
	return rb
}

// IsWriteIndex set the IsWriteIndex property for AliasDefinitionBuilder.
func (rb *AliasDefinitionBuilder) IsWriteIndex(iswriteindex bool) *AliasDefinitionBuilder {
	rb.v.IsWriteIndex = &iswriteindex
	return rb
}

// Routing set the Routing property for AliasDefinitionBuilder.
func (rb *AliasDefinitionBuilder) Routing(routing string) *AliasDefinitionBuilder {
	rb.v.Routing = &routing
	return rb
}

// SearchRouting set the SearchRouting property for AliasDefinitionBuilder.
