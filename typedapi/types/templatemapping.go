...
func NewTemplateMapping() *TemplateMappingBuilder {
...
// Aliases set the Aliases property for TemplateMappingBuilder.
func (rb *TemplateMappingBuilder) Aliases(value map[IndexName]Alias) *TemplateMappingBuilder {
	rb.v.Aliases = value
	return rb
}

// IndexPatterns set the IndexPatterns property for TemplateMappingBuilder.
...
// Mappings set the Mappings property for TemplateMappingBuilder.
func (rb *TemplateMappingBuilder) Mappings(mappings TypeMapping) *TemplateMappingBuilder {
	rb.v.Mappings = mappings
	return rb
}

// Order set the Order property for TemplateMappingBuilder.
func (rb *TemplateMappingBuilder) Order(order int) *TemplateMappingBuilder {
	rb.v.Order = order
	return rb
}

// Settings set the Settings property for TemplateMappingBuilder.
func (rb *TemplateMappingBuilder) Settings(value map[string]interface{}) *TemplateMappingBuilder {
	rb.v.Settings = value
	return rb
}

// Version set the Version property for TemplateMappingBuilder.
