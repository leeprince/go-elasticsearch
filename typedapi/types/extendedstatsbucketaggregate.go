...
func NewExtendedStatsBucketAggregate() *ExtendedStatsBucketAggregateBuilder {
...
// Avg set the Avg property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) Avg(avg float64) *ExtendedStatsBucketAggregateBuilder {
	rb.v.Avg = avg
	return rb
}

// AvgAsString set the AvgAsString property for ExtendedStatsBucketAggregateBuilder.
...
// Count set the Count property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) Count(count int64) *ExtendedStatsBucketAggregateBuilder {
	rb.v.Count = count
	return rb
}

// Max set the Max property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) Max(max float64) *ExtendedStatsBucketAggregateBuilder {
	rb.v.Max = max
	return rb
}

// MaxAsString set the MaxAsString property for ExtendedStatsBucketAggregateBuilder.
...
// Meta set the Meta property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) Meta(meta Metadata) *ExtendedStatsBucketAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Min set the Min property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) Min(min float64) *ExtendedStatsBucketAggregateBuilder {
	rb.v.Min = min
	return rb
}

// MinAsString set the MinAsString property for ExtendedStatsBucketAggregateBuilder.
...
// StdDeviation set the StdDeviation property for ExtendedStatsBucketAggregateBuilder.
...
// StdDeviationAsString set the StdDeviationAsString property for ExtendedStatsBucketAggregateBuilder.
...
// StdDeviationBounds set the StdDeviationBounds property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) StdDeviationBounds(stddeviationbounds StandardDeviationBounds) *ExtendedStatsBucketAggregateBuilder {
	rb.v.StdDeviationBounds = &stddeviationbounds
	return rb
}

// StdDeviationBoundsAsString set the StdDeviationBoundsAsString property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) StdDeviationBoundsAsString(stddeviationboundsasstring StandardDeviationBoundsAsString) *ExtendedStatsBucketAggregateBuilder {
	rb.v.StdDeviationBoundsAsString = &stddeviationboundsasstring
	return rb
}

// Sum set the Sum property for ExtendedStatsBucketAggregateBuilder.
func (rb *ExtendedStatsBucketAggregateBuilder) Sum(sum float64) *ExtendedStatsBucketAggregateBuilder {
	rb.v.Sum = sum
	return rb
}

// SumAsString set the SumAsString property for ExtendedStatsBucketAggregateBuilder.
...
// SumOfSquares set the SumOfSquares property for ExtendedStatsBucketAggregateBuilder.
...
// SumOfSquaresAsString set the SumOfSquaresAsString property for ExtendedStatsBucketAggregateBuilder.
...
// Variance set the Variance property for ExtendedStatsBucketAggregateBuilder.
...
// VarianceAsString set the VarianceAsString property for ExtendedStatsBucketAggregateBuilder.
...
// VariancePopulation set the VariancePopulation property for ExtendedStatsBucketAggregateBuilder.
...
// VariancePopulationAsString set the VariancePopulationAsString property for ExtendedStatsBucketAggregateBuilder.
...
// VarianceSampling set the VarianceSampling property for ExtendedStatsBucketAggregateBuilder.
...
// VarianceSamplingAsString set the VarianceSamplingAsString property for ExtendedStatsBucketAggregateBuilder.
