...
func NewOutlierDetectionParameters() *OutlierDetectionParametersBuilder {
...
// ComputeFeatureInfluence set the ComputeFeatureInfluence property for OutlierDetectionParametersBuilder.
...
// FeatureInfluenceThreshold set the FeatureInfluenceThreshold property for OutlierDetectionParametersBuilder.
...
// Method set the Method property for OutlierDetectionParametersBuilder.
func (rb *OutlierDetectionParametersBuilder) Method(method string) *OutlierDetectionParametersBuilder {
	rb.v.Method = &method
	return rb
}

// NNeighbors set the NNeighbors property for OutlierDetectionParametersBuilder.
...
// OutlierFraction set the OutlierFraction property for OutlierDetectionParametersBuilder.
...
// StandardizationEnabled set the StandardizationEnabled property for OutlierDetectionParametersBuilder.
