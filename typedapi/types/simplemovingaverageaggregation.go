...
func NewSimpleMovingAverageAggregation() *SimpleMovingAverageAggregationBuilder {
...
// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *SimpleMovingAverageAggregationBuilder) BucketsPath(bucketspath BucketsPath) *SimpleMovingAverageAggregationBuilder {
	rb.v.BucketsPath = &bucketspath
	return rb
}

// Format set the Format property for SimpleMovingAverageAggregationBuilder.
func (rb *SimpleMovingAverageAggregationBuilder) Format(format string) *SimpleMovingAverageAggregationBuilder {
	rb.v.Format = &format
	return rb
}

// GapPolicy set the GapPolicy property for SimpleMovingAverageAggregationBuilder.
...
// Meta set the Meta property for SimpleMovingAverageAggregationBuilder.
func (rb *SimpleMovingAverageAggregationBuilder) Meta(meta Metadata) *SimpleMovingAverageAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Minimize set the Minimize property for SimpleMovingAverageAggregationBuilder.
...
// Model set the Model property for SimpleMovingAverageAggregationBuilder.

// Name set the Name property for SimpleMovingAverageAggregationBuilder.
func (rb *SimpleMovingAverageAggregationBuilder) Name(name string) *SimpleMovingAverageAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Predict set the Predict property for SimpleMovingAverageAggregationBuilder.
...
// Settings set the Settings property for SimpleMovingAverageAggregationBuilder.
func (rb *SimpleMovingAverageAggregationBuilder) Settings(settings EmptyObject) *SimpleMovingAverageAggregationBuilder {
	rb.v.Settings = settings
	return rb
}

// Window set the Window property for SimpleMovingAverageAggregationBuilder.
