...
func NewAnomalyDetectors() *AnomalyDetectorsBuilder {
...
// CategorizationAnalyzer set the CategorizationAnalyzer property for AnomalyDetectorsBuilder.
func (rb *AnomalyDetectorsBuilder) CategorizationAnalyzer(categorizationanalyzer CategorizationAnalyzer) *AnomalyDetectorsBuilder {
	rb.v.CategorizationAnalyzer = categorizationanalyzer
	return rb
}

// CategorizationExamplesLimit set the CategorizationExamplesLimit property for AnomalyDetectorsBuilder.
...
// DailyModelSnapshotRetentionAfterDays set the DailyModelSnapshotRetentionAfterDays property for AnomalyDetectorsBuilder.
...
// ModelMemoryLimit set the ModelMemoryLimit property for AnomalyDetectorsBuilder.
...
// ModelSnapshotRetentionDays set the ModelSnapshotRetentionDays property for AnomalyDetectorsBuilder.
