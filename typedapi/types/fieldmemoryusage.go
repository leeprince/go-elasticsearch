...
func NewFieldMemoryUsage() *FieldMemoryUsageBuilder {
...
// MemorySize set the MemorySize property for FieldMemoryUsageBuilder.
func (rb *FieldMemoryUsageBuilder) MemorySize(memorysize ByteSize) *FieldMemoryUsageBuilder {
	rb.v.MemorySize = &memorysize
	return rb
}

// MemorySizeInBytes set the MemorySizeInBytes property for FieldMemoryUsageBuilder.
