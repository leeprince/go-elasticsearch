...
func NewRollupCapabilitySummary() *RollupCapabilitySummaryBuilder {
...
// Fields set the Fields property for RollupCapabilitySummaryBuilder.
...
// IndexPattern set the IndexPattern property for RollupCapabilitySummaryBuilder.
...
// JobId set the JobId property for RollupCapabilitySummaryBuilder.
func (rb *RollupCapabilitySummaryBuilder) JobId(jobid string) *RollupCapabilitySummaryBuilder {
	rb.v.JobId = jobid
	return rb
}

// RollupIndex set the RollupIndex property for RollupCapabilitySummaryBuilder.
