...
func NewIndexCapabilities() *IndexCapabilitiesBuilder {
...
// RollupJobs set the RollupJobs property for IndexCapabilitiesBuilder.
func (rb *IndexCapabilitiesBuilder) RollupJobs(rollup_jobs ...RollupJobSummary) *IndexCapabilitiesBuilder {
