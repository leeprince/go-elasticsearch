...
func NewScriptField() *ScriptFieldBuilder {
...
// IgnoreFailure set the IgnoreFailure property for ScriptFieldBuilder.
func (rb *ScriptFieldBuilder) IgnoreFailure(ignorefailure bool) *ScriptFieldBuilder {
	rb.v.IgnoreFailure = &ignorefailure
	return rb
}

// Script set the Script property for ScriptFieldBuilder.
func (rb *ScriptFieldBuilder) Script(script Script) *ScriptFieldBuilder {
	rb.v.Script = script
	return rb
}
