...
func NewJvmStats() *JvmStatsBuilder {
	r := JvmStatsBuilder{
		&JvmStats{},
	}
...
// HeapMax Maximum amount of memory available for use by the heap.
func (rb *JvmStatsBuilder) HeapMax(heapmax ByteSize) *JvmStatsBuilder {
...
// JavaInference Amount of Java heap currently being used for caching inference models.
func (rb *JvmStatsBuilder) JavaInference(javainference ByteSize) *JvmStatsBuilder {
	rb.v.JavaInference = &javainference
	return rb
}
...
// JavaInferenceMax Maximum amount of Java heap to be used for caching inference models.
func (rb *JvmStatsBuilder) JavaInferenceMax(javainferencemax ByteSize) *JvmStatsBuilder {
	rb.v.JavaInferenceMax = &javainferencemax
	return rb
}
