...
func NewCategorizeTextAggregation() *CategorizeTextAggregationBuilder {
...
// This property
// cannot be used at the same time as categorization_filters.
func (rb *CategorizeTextAggregationBuilder) CategorizationAnalyzer(categorizationanalyzer CategorizeTextAnalyzer) *CategorizeTextAggregationBuilder {
...
// Meta set the Meta property for CategorizeTextAggregationBuilder.
func (rb *CategorizeTextAggregationBuilder) Meta(meta Metadata) *CategorizeTextAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// Name set the Name property for CategorizeTextAggregationBuilder.
