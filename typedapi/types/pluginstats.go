...
func NewPluginStats() *PluginStatsBuilder {
...
// Classname set the Classname property for PluginStatsBuilder.
func (rb *PluginStatsBuilder) Classname(classname string) *PluginStatsBuilder {
	rb.v.Classname = classname
	return rb
}

// Description set the Description property for PluginStatsBuilder.
func (rb *PluginStatsBuilder) Description(description string) *PluginStatsBuilder {
	rb.v.Description = description
	return rb
}

// ElasticsearchVersion set the ElasticsearchVersion property for PluginStatsBuilder.
...
// ExtendedPlugins set the ExtendedPlugins property for PluginStatsBuilder.
func (rb *PluginStatsBuilder) ExtendedPlugins(extended_plugins ...string) *PluginStatsBuilder {
	rb.v.ExtendedPlugins = append(rb.v.ExtendedPlugins, extended_plugins...)
	return rb
}

// HasNativeController set the HasNativeController property for PluginStatsBuilder.
