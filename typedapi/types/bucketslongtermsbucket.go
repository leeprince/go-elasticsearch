...
func NewBucketsLongTermsBucket() *BucketsLongTermsBucketBuilder {
...
// LongTermsBuckets set the LongTermsBuckets property for BucketsLongTermsBucketBuilder.
func (u *BucketsLongTermsBucketBuilder) LongTermsBuckets(v []LongTermsBucket) *BucketsLongTermsBucketBuilder {
	u.v = v
	return u
}

// Map set the Map property for BucketsLongTermsBucketBuilder.
func (u *BucketsLongTermsBucketBuilder) Map(v map[string]LongTermsBucket) *BucketsLongTermsBucketBuilder {
	u.v = v
	return u
}
