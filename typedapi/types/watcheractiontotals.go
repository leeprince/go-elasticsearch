...
func NewWatcherActionTotals() *WatcherActionTotalsBuilder {
...
// Total set the Total property for WatcherActionTotalsBuilder.
func (rb *WatcherActionTotalsBuilder) Total(total int64) *WatcherActionTotalsBuilder {
	rb.v.Total = total
	return rb
}

// TotalTimeInMs set the TotalTimeInMs property for WatcherActionTotalsBuilder.
