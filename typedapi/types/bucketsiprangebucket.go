...
func NewBucketsIpRangeBucket() *BucketsIpRangeBucketBuilder {
...
// IpRangeBuckets set the IpRangeBuckets property for BucketsIpRangeBucketBuilder.
func (u *BucketsIpRangeBucketBuilder) IpRangeBuckets(v []IpRangeBucket) *BucketsIpRangeBucketBuilder {
	u.v = v
	return u
}

// Map set the Map property for BucketsIpRangeBucketBuilder.
func (u *BucketsIpRangeBucketBuilder) Map(v map[string]IpRangeBucket) *BucketsIpRangeBucketBuilder {
	u.v = v
	return u
}
