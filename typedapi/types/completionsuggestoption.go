...
func NewCompletionSuggestOption() *CompletionSuggestOptionBuilder {
...
// CollateMatch set the CollateMatch property for CompletionSuggestOptionBuilder.
