...
func NewBucketsStringTermsBucket() *BucketsStringTermsBucketBuilder {
...
// Map set the Map property for BucketsStringTermsBucketBuilder.
func (u *BucketsStringTermsBucketBuilder) Map(v map[string]StringTermsBucket) *BucketsStringTermsBucketBuilder {
	u.v = v
	return u
}

// StringTermsBuckets set the StringTermsBuckets property for BucketsStringTermsBucketBuilder.
func (u *BucketsStringTermsBucketBuilder) StringTermsBuckets(v []StringTermsBucket) *BucketsStringTermsBucketBuilder {
	u.v = v
	return u
}
