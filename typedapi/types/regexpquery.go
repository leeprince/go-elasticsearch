...
func NewRegexpQuery() *RegexpQueryBuilder {
...
// Boost set the Boost property for RegexpQueryBuilder.
func (rb *RegexpQueryBuilder) Boost(boost float32) *RegexpQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// CaseInsensitive set the CaseInsensitive property for RegexpQueryBuilder.
func (rb *RegexpQueryBuilder) CaseInsensitive(caseinsensitive bool) *RegexpQueryBuilder {
	rb.v.CaseInsensitive = &caseinsensitive
	return rb
}

// Flags set the Flags property for RegexpQueryBuilder.
func (rb *RegexpQueryBuilder) Flags(flags string) *RegexpQueryBuilder {
	rb.v.Flags = &flags
	return rb
}

// MaxDeterminizedStates set the MaxDeterminizedStates property for RegexpQueryBuilder.
