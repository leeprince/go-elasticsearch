...
type Retention struct {
	...
	ExpireAfter Time `json:"expire_after"`
...
func NewRetention() *RetentionBuilder {
	r := RetentionBuilder{
		&Retention{},
	}
...
// ExpireAfter Time period after which a snapshot is considered expired and eligible for
// deletion. SLM deletes expired snapshots based on the slm.retention_schedule.
func (rb *RetentionBuilder) ExpireAfter(expireafter Time) *RetentionBuilder {
	rb.v.ExpireAfter = expireafter
	return rb
}
