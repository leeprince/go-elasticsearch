...
func NewSettingsSimilarityScriptedTfidf() *SettingsSimilarityScriptedTfidfBuilder {
...
// Script set the Script property for SettingsSimilarityScriptedTfidfBuilder.
func (rb *SettingsSimilarityScriptedTfidfBuilder) Script(script Script) *SettingsSimilarityScriptedTfidfBuilder {
	rb.v.Script = script
	return rb
}

// Type set the Type property for SettingsSimilarityScriptedTfidfBuilder.
