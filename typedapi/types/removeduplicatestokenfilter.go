...
func NewRemoveDuplicatesTokenFilter() *RemoveDuplicatesTokenFilterBuilder {
...
// Type set the Type property for RemoveDuplicatesTokenFilterBuilder.

// Version set the Version property for RemoveDuplicatesTokenFilterBuilder.
