...
func NewDataframeEvaluationSummaryAucRoc() *DataframeEvaluationSummaryAucRocBuilder {
...
// Curve set the Curve property for DataframeEvaluationSummaryAucRocBuilder.
func (rb *DataframeEvaluationSummaryAucRocBuilder) Curve(curve ...DataframeEvaluationSummaryAucRocCurveItem) *DataframeEvaluationSummaryAucRocBuilder {
	rb.v.Curve = append(rb.v.Curve, curve...)
	return rb
}

// Value set the Value property for DataframeEvaluationSummaryAucRocBuilder.
