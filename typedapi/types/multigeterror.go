...
func NewMultiGetError() *MultiGetErrorBuilder {
...
// Error set the Error property for MultiGetErrorBuilder.
func (rb *MultiGetErrorBuilder) Error(error ErrorCause) *MultiGetErrorBuilder {
	rb.v.Error = error
	return rb
}

// Id_ set the Id_ property for MultiGetErrorBuilder.
func (rb *MultiGetErrorBuilder) Id_(id_ Id) *MultiGetErrorBuilder {
	rb.v.Id_ = id_
	return rb
}

// Index_ set the Index_ property for MultiGetErrorBuilder.
