...
func NewIndexRoutingAllocationDisk() *IndexRoutingAllocationDiskBuilder {
...
// ThresholdEnabled set the ThresholdEnabled property for IndexRoutingAllocationDiskBuilder.
