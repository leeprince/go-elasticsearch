...
func NewLengthTokenFilter() *LengthTokenFilterBuilder {
...
// Max set the Max property for LengthTokenFilterBuilder.
func (rb *LengthTokenFilterBuilder) Max(max int) *LengthTokenFilterBuilder {
	rb.v.Max = max
	return rb
}

// Min set the Min property for LengthTokenFilterBuilder.
func (rb *LengthTokenFilterBuilder) Min(min int) *LengthTokenFilterBuilder {
	rb.v.Min = min
	return rb
}

// Type set the Type property for LengthTokenFilterBuilder.

// Version set the Version property for LengthTokenFilterBuilder.
