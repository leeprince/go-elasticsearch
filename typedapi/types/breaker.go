...
func NewBreaker() *BreakerBuilder {
	r := BreakerBuilder{
		&Breaker{},
	}
...
// EstimatedSize set the EstimatedSize property for BreakerBuilder.
func (rb *BreakerBuilder) EstimatedSize(estimatedsize string) *BreakerBuilder {
	rb.v.EstimatedSize = &estimatedsize
	return rb
}

// EstimatedSizeInBytes set the EstimatedSizeInBytes property for BreakerBuilder.
