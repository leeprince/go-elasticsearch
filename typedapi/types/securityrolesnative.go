...
func NewSecurityRolesNative() *SecurityRolesNativeBuilder {
...
// Dls set the Dls property for SecurityRolesNativeBuilder.
func (rb *SecurityRolesNativeBuilder) Dls(dls bool) *SecurityRolesNativeBuilder {
	rb.v.Dls = dls
	return rb
}

// Fls set the Fls property for SecurityRolesNativeBuilder.
func (rb *SecurityRolesNativeBuilder) Fls(fls bool) *SecurityRolesNativeBuilder {
	rb.v.Fls = fls
	return rb
}

// Size set the Size property for SecurityRolesNativeBuilder.
