...
func NewTrainedModelDeploymentNodesStats() *TrainedModelDeploymentNodesStatsBuilder {
...
// Node Information pertaining to the node.
func (rb *TrainedModelDeploymentNodesStatsBuilder) Node(node DiscoveryNode) *TrainedModelDeploymentNodesStatsBuilder {
	rb.v.Node = node
	return rb
}
...
// RoutingState The current routing state and reason for the current routing state for this
// allocation.
func (rb *TrainedModelDeploymentNodesStatsBuilder) RoutingState(routingstate TrainedModelAllocationRoutingTable) *TrainedModelDeploymentNodesStatsBuilder {
