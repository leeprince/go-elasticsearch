...
func NewHighlightBase() *HighlightBaseBuilder {
...
// BoundaryChars set the BoundaryChars property for HighlightBaseBuilder.
func (rb *HighlightBaseBuilder) BoundaryChars(boundarychars string) *HighlightBaseBuilder {
	rb.v.BoundaryChars = &boundarychars
	return rb
}

// BoundaryMaxScan set the BoundaryMaxScan property for HighlightBaseBuilder.
...
// BoundaryScanner set the BoundaryScanner property for HighlightBaseBuilder.
...
// BoundaryScannerLocale set the BoundaryScannerLocale property for HighlightBaseBuilder.
...
// HighlightFilter set the HighlightFilter property for HighlightBaseBuilder.
...
// HighlightQuery set the HighlightQuery property for HighlightBaseBuilder.
func (rb *HighlightBaseBuilder) HighlightQuery(highlightquery QueryContainer) *HighlightBaseBuilder {
	rb.v.HighlightQuery = &highlightquery
	return rb
}

// MaxAnalyzedOffset set the MaxAnalyzedOffset property for HighlightBaseBuilder.
...
// MaxFragmentLength set the MaxFragmentLength property for HighlightBaseBuilder.
...
// NoMatchSize set the NoMatchSize property for HighlightBaseBuilder.
func (rb *HighlightBaseBuilder) NoMatchSize(nomatchsize int) *HighlightBaseBuilder {
	rb.v.NoMatchSize = &nomatchsize
	return rb
}

// NumberOfFragments set the NumberOfFragments property for HighlightBaseBuilder.
...
// TagsSchema set the TagsSchema property for HighlightBaseBuilder.
...
// Type set the Type property for HighlightBaseBuilder.
