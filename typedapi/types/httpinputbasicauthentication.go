...
func NewHttpInputBasicAuthentication() *HttpInputBasicAuthenticationBuilder {
...
// Password set the Password property for HttpInputBasicAuthenticationBuilder.
...
// Username set the Username property for HttpInputBasicAuthenticationBuilder.
