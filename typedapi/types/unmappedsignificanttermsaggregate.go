...
func NewUnmappedSignificantTermsAggregate() *UnmappedSignificantTermsAggregateBuilder {
...
// Buckets set the Buckets property for UnmappedSignificantTermsAggregateBuilder.
func (rb *UnmappedSignificantTermsAggregateBuilder) Buckets(buckets BucketsVoid) *UnmappedSignificantTermsAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for UnmappedSignificantTermsAggregateBuilder.
func (rb *UnmappedSignificantTermsAggregateBuilder) Meta(meta Metadata) *UnmappedSignificantTermsAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
