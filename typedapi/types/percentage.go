...
func NewPercentage() *PercentageBuilder {
...
// Float32 set the Float32 property for PercentageBuilder.
func (u *PercentageBuilder) Float32(v float32) *PercentageBuilder {
	u.v = v
	return u
}

// String set the String property for PercentageBuilder.
func (u *PercentageBuilder) String(v string) *PercentageBuilder {
	u.v = v
	return u
}
