...
func NewTextEmbeddingInferenceUpdateOptions() *TextEmbeddingInferenceUpdateOptionsBuilder {
...
// Tokenization set the Tokenization property for TextEmbeddingInferenceUpdateOptionsBuilder.
func (rb *TextEmbeddingInferenceUpdateOptionsBuilder) Tokenization(tokenization NlpTokenizationUpdateOptions) *TextEmbeddingInferenceUpdateOptionsBuilder {
