...
func NewMultiTermsBucket() *MultiTermsBucketBuilder {
...
// Aggregations set the Aggregations property for MultiTermsBucketBuilder.
func (rb *MultiTermsBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *MultiTermsBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for MultiTermsBucketBuilder.
func (rb *MultiTermsBucketBuilder) DocCount(doccount int64) *MultiTermsBucketBuilder {
	rb.v.DocCount = doccount
	return rb
}

// DocCountErrorUpperBound set the DocCountErrorUpperBound property for MultiTermsBucketBuilder.
...
// Key set the Key property for MultiTermsBucketBuilder.
func (rb *MultiTermsBucketBuilder) Key(key ...string) *MultiTermsBucketBuilder {
	rb.v.Key = append(rb.v.Key, key...)
	return rb
}

// KeyAsString set the KeyAsString property for MultiTermsBucketBuilder.
