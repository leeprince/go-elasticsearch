...
func NewQueryBreakdown() *QueryBreakdownBuilder {
...
// ComputeMaxScore set the ComputeMaxScore property for QueryBreakdownBuilder.
...
// ComputeMaxScoreCount set the ComputeMaxScoreCount property for QueryBreakdownBuilder.
...
// CreateWeight set the CreateWeight property for QueryBreakdownBuilder.
func (rb *QueryBreakdownBuilder) CreateWeight(createweight int64) *QueryBreakdownBuilder {
	rb.v.CreateWeight = createweight
	return rb
}

// CreateWeightCount set the CreateWeightCount property for QueryBreakdownBuilder.
...
// SetMinCompetitiveScoreCount set the SetMinCompetitiveScoreCount property for QueryBreakdownBuilder.
...
// ShallowAdvance set the ShallowAdvance property for QueryBreakdownBuilder.
...
// ShallowAdvanceCount set the ShallowAdvanceCount property for QueryBreakdownBuilder.
