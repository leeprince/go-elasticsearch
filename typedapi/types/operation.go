...
// Doc set the Doc property for OperationBuilder.
func (rb *OperationBuilder) Doc(doc interface{}) *OperationBuilder {
	rb.v.Doc = doc
	return rb
}

// FieldStatistics set the FieldStatistics property for OperationBuilder.
func (rb *OperationBuilder) FieldStatistics(fieldstatistics bool) *OperationBuilder {
	rb.v.FieldStatistics = &fieldstatistics
	return rb
}

// Fields set the Fields property for OperationBuilder.
func (rb *OperationBuilder) Fields(fields Fields) *OperationBuilder {
	rb.v.Fields = &fields
	return rb
}

// Filter set the Filter property for OperationBuilder.
func (rb *OperationBuilder) Filter(filter Filter) *OperationBuilder {
	rb.v.Filter = &filter
	return rb
}

// Id_ set the Id_ property for OperationBuilder.
func (rb *OperationBuilder) Id_(id_ Id) *OperationBuilder {
	rb.v.Id_ = id_
	return rb
}

// Index_ set the Index_ property for OperationBuilder.
func (rb *OperationBuilder) Index_(index_ IndexName) *OperationBuilder {
	rb.v.Index_ = &index_
	return rb
}

// Offsets set the Offsets property for OperationBuilder.
func (rb *OperationBuilder) Offsets(offsets bool) *OperationBuilder {
	rb.v.Offsets = &offsets
	return rb
}

// Payloads set the Payloads property for OperationBuilder.
func (rb *OperationBuilder) Payloads(payloads bool) *OperationBuilder {
	rb.v.Payloads = &payloads
	return rb
}

// Positions set the Positions property for OperationBuilder.
func (rb *OperationBuilder) Positions(positions bool) *OperationBuilder {
	rb.v.Positions = &positions
	return rb
}

// Routing set the Routing property for OperationBuilder.
func (rb *OperationBuilder) Routing(routing Routing) *OperationBuilder {
	rb.v.Routing = &routing
	return rb
}

// TermStatistics set the TermStatistics property for OperationBuilder.
func (rb *OperationBuilder) TermStatistics(termstatistics bool) *OperationBuilder {
	rb.v.TermStatistics = &termstatistics
	return rb
}

// Version set the Version property for OperationBuilder.
func (rb *OperationBuilder) Version(version VersionNumber) *OperationBuilder {
	rb.v.Version = &version
	return rb
}

// VersionType set the VersionType property for OperationBuilder.
