...
func NewAutoscalingDecider() *AutoscalingDeciderBuilder {
...
// ReasonDetails set the ReasonDetails property for AutoscalingDeciderBuilder.
...
// ReasonSummary set the ReasonSummary property for AutoscalingDeciderBuilder.
...
// RequiredCapacity set the RequiredCapacity property for AutoscalingDeciderBuilder.
func (rb *AutoscalingDeciderBuilder) RequiredCapacity(requiredcapacity AutoscalingCapacity) *AutoscalingDeciderBuilder {
