...
func NewSnapshotShardsStatus() *SnapshotShardsStatusBuilder {
...
// Stage set the Stage property for SnapshotShardsStatusBuilder.
func (rb *SnapshotShardsStatusBuilder) Stage(stage shardsstatsstage.ShardsStatsStage) *SnapshotShardsStatusBuilder {
	rb.v.Stage = stage
	return rb
}

// Stats set the Stats property for SnapshotShardsStatusBuilder.
func (rb *SnapshotShardsStatusBuilder) Stats(stats ShardsStatsSummary) *SnapshotShardsStatusBuilder {
	rb.v.Stats = stats
	return rb
}
