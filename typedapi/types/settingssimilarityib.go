...
func NewSettingsSimilarityIb() *SettingsSimilarityIbBuilder {
...
// Distribution set the Distribution property for SettingsSimilarityIbBuilder.
...
// Lambda set the Lambda property for SettingsSimilarityIbBuilder.
func (rb *SettingsSimilarityIbBuilder) Lambda(lambda iblambda.IBLambda) *SettingsSimilarityIbBuilder {
	rb.v.Lambda = lambda
	return rb
}

// Normalization set the Normalization property for SettingsSimilarityIbBuilder.
...
// Type set the Type property for SettingsSimilarityIbBuilder.
