...
func (rb *CategoryBuilder) Examples(examples ...string) *CategoryBuilder {
	rb.v.Examples = append(rb.v.Examples, examples...)
	return rb
}
...
// Mlcategory set the Mlcategory property for CategoryBuilder.
...
// P set the P property for CategoryBuilder.
...
func (rb *CategoryBuilder) PreferredToCategories(preferred_to_categories ...Id) *CategoryBuilder {
	rb.v.PreferredToCategories = append(rb.v.PreferredToCategories, preferred_to_categories...)
	return rb
}
...
// ResultType set the ResultType property for CategoryBuilder.
