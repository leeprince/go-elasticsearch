...
func NewPhraseSuggestHighlight() *PhraseSuggestHighlightBuilder {
...
// PostTag set the PostTag property for PhraseSuggestHighlightBuilder.
func (rb *PhraseSuggestHighlightBuilder) PostTag(posttag string) *PhraseSuggestHighlightBuilder {
	rb.v.PostTag = posttag
	return rb
}

// PreTag set the PreTag property for PhraseSuggestHighlightBuilder.
