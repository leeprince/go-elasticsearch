...
func NewBucketCorrelationFunctionCountCorrelationIndicator() *BucketCorrelationFunctionCountCorrelationIndicatorBuilder {
...
func (rb *BucketCorrelationFunctionCountCorrelationIndicatorBuilder) Expectations(expectations ...float64) *BucketCorrelationFunctionCountCorrelationIndicatorBuilder {
	rb.v.Expectations = append(rb.v.Expectations, expectations...)
	return rb
}
