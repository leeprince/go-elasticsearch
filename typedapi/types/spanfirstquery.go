...
func NewSpanFirstQuery() *SpanFirstQueryBuilder {
...
// Boost set the Boost property for SpanFirstQueryBuilder.
func (rb *SpanFirstQueryBuilder) Boost(boost float32) *SpanFirstQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// End set the End property for SpanFirstQueryBuilder.
func (rb *SpanFirstQueryBuilder) End(end int) *SpanFirstQueryBuilder {
	rb.v.End = end
	return rb
}

// Match set the Match property for SpanFirstQueryBuilder.
func (rb *SpanFirstQueryBuilder) Match(match SpanQuery) *SpanFirstQueryBuilder {
	rb.v.Match = &match
	return rb
}

// QueryName_ set the QueryName_ property for SpanFirstQueryBuilder.
