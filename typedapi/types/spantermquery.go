...
func NewSpanTermQuery() *SpanTermQueryBuilder {
...
// Boost set the Boost property for SpanTermQueryBuilder.
func (rb *SpanTermQueryBuilder) Boost(boost float32) *SpanTermQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// QueryName_ set the QueryName_ property for SpanTermQueryBuilder.
func (rb *SpanTermQueryBuilder) QueryName_(queryname_ string) *SpanTermQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// Value set the Value property for SpanTermQueryBuilder.
