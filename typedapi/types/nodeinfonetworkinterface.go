...
func NewNodeInfoNetworkInterface() *NodeInfoNetworkInterfaceBuilder {
...
// Address set the Address property for NodeInfoNetworkInterfaceBuilder.
func (rb *NodeInfoNetworkInterfaceBuilder) Address(address string) *NodeInfoNetworkInterfaceBuilder {
	rb.v.Address = address
	return rb
}

// MacAddress set the MacAddress property for NodeInfoNetworkInterfaceBuilder.
...
// Name set the Name property for NodeInfoNetworkInterfaceBuilder.
