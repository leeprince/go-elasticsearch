...
func NewTranslogRetention() *TranslogRetentionBuilder {
...
// are enabled by default in
// indices created in Elasticsearch versions 7.0.0 and later.
func (rb *TranslogRetentionBuilder) Age(age Time) *TranslogRetentionBuilder {
	rb.v.Age = &age
	return rb
}
...
// indices created in Elasticsearch
// versions 7.0.0 and later.
func (rb *TranslogRetentionBuilder) Size(size ByteSize) *TranslogRetentionBuilder {
	rb.v.Size = &size
	return rb
}
