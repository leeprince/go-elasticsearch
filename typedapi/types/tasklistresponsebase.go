...
func NewTaskListResponseBase() *TaskListResponseBaseBuilder {
...
// NodeFailures set the NodeFailures property for TaskListResponseBaseBuilder.
func (rb *TaskListResponseBaseBuilder) NodeFailures(node_failures ...ErrorCause) *TaskListResponseBaseBuilder {
	rb.v.NodeFailures = append(rb.v.NodeFailures, node_failures...)
	return rb
}

// Nodes Task information grouped by node, if `group_by` was set to `node` (the
// default).
func (rb *TaskListResponseBaseBuilder) Nodes(value map[string]NodeTasks) *TaskListResponseBaseBuilder {
	rb.v.Nodes = value
	return rb
}

// TaskFailures set the TaskFailures property for TaskListResponseBaseBuilder.
func (rb *TaskListResponseBaseBuilder) TaskFailures(task_failures ...TaskFailure) *TaskListResponseBaseBuilder {
	rb.v.TaskFailures = append(rb.v.TaskFailures, task_failures...)
	return rb
}
...
// parents if
// `group_by` was set to `parents`.
func (rb *TaskListResponseBaseBuilder) Tasks(tasks TaskInfos) *TaskListResponseBaseBuilder {
	rb.v.Tasks = &tasks
	return rb
}
