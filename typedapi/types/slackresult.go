...
func NewSlackResult() *SlackResultBuilder {
...
// Account set the Account property for SlackResultBuilder.
func (rb *SlackResultBuilder) Account(account string) *SlackResultBuilder {
	rb.v.Account = &account
	return rb
}

// Message set the Message property for SlackResultBuilder.
func (rb *SlackResultBuilder) Message(message SlackMessage) *SlackResultBuilder {
