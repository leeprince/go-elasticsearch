...
func NewSettingsSimilarityLmd() *SettingsSimilarityLmdBuilder {
...
// Mu set the Mu property for SettingsSimilarityLmdBuilder.
func (rb *SettingsSimilarityLmdBuilder) Mu(mu int) *SettingsSimilarityLmdBuilder {
	rb.v.Mu = mu
	return rb
}

// Type set the Type property for SettingsSimilarityLmdBuilder.
