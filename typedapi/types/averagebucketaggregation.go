...
func NewAverageBucketAggregation() *AverageBucketAggregationBuilder {
...
// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *AverageBucketAggregationBuilder) BucketsPath(bucketspath BucketsPath) *AverageBucketAggregationBuilder {
	rb.v.BucketsPath = &bucketspath
	return rb
}

// Format set the Format property for AverageBucketAggregationBuilder.
func (rb *AverageBucketAggregationBuilder) Format(format string) *AverageBucketAggregationBuilder {
	rb.v.Format = &format
	return rb
}

// GapPolicy set the GapPolicy property for AverageBucketAggregationBuilder.
...
// Meta set the Meta property for AverageBucketAggregationBuilder.
func (rb *AverageBucketAggregationBuilder) Meta(meta Metadata) *AverageBucketAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for AverageBucketAggregationBuilder.
