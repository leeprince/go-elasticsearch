...
func NewIndicesStats() *IndicesStatsBuilder {
...
// Health set the Health property for IndicesStatsBuilder.
func (rb *IndicesStatsBuilder) Health(health healthstatus.HealthStatus) *IndicesStatsBuilder {
	rb.v.Health = &health
	return rb
}

// Primaries set the Primaries property for IndicesStatsBuilder.
func (rb *IndicesStatsBuilder) Primaries(primaries IndexStats) *IndicesStatsBuilder {
	rb.v.Primaries = &primaries
	return rb
}

// Shards set the Shards property for IndicesStatsBuilder.
func (rb *IndicesStatsBuilder) Shards(value map[string][]ShardStats) *IndicesStatsBuilder {
	rb.v.Shards = value
	return rb
}

// Status set the Status property for IndicesStatsBuilder.
func (rb *IndicesStatsBuilder) Status(status indexmetadatastate.IndexMetadataState) *IndicesStatsBuilder {
	rb.v.Status = &status
	return rb
}

// Total set the Total property for IndicesStatsBuilder.
func (rb *IndicesStatsBuilder) Total(total IndexStats) *IndicesStatsBuilder {
	rb.v.Total = &total
	return rb
}

// Uuid set the Uuid property for IndicesStatsBuilder.
