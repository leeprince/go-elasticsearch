...
func NewNestedAggregation() *NestedAggregationBuilder {
...
// Meta set the Meta property for NestedAggregationBuilder.
func (rb *NestedAggregationBuilder) Meta(meta Metadata) *NestedAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for NestedAggregationBuilder.
func (rb *NestedAggregationBuilder) Name(name string) *NestedAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Path set the Path property for NestedAggregationBuilder.
