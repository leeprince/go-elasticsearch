...
func NewSimpleValueAggregate() *SimpleValueAggregateBuilder {
...
// Meta set the Meta property for SimpleValueAggregateBuilder.
func (rb *SimpleValueAggregateBuilder) Meta(meta Metadata) *SimpleValueAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for SimpleValueAggregateBuilder.
