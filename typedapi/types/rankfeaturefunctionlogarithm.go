...
func NewRankFeatureFunctionLogarithm() *RankFeatureFunctionLogarithmBuilder {
...
// ScalingFactor set the ScalingFactor property for RankFeatureFunctionLogarithmBuilder.
