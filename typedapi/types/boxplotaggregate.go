...
func NewBoxPlotAggregate() *BoxPlotAggregateBuilder {
...
// Lower set the Lower property for BoxPlotAggregateBuilder.
func (rb *BoxPlotAggregateBuilder) Lower(lower float64) *BoxPlotAggregateBuilder {
	rb.v.Lower = lower
	return rb
}

// LowerAsString set the LowerAsString property for BoxPlotAggregateBuilder.
