...
func NewConstantScoreQuery() *ConstantScoreQueryBuilder {
...
// Boost set the Boost property for ConstantScoreQueryBuilder.
func (rb *ConstantScoreQueryBuilder) Boost(boost float32) *ConstantScoreQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Filter set the Filter property for ConstantScoreQueryBuilder.
func (rb *ConstantScoreQueryBuilder) Filter(filter QueryContainer) *ConstantScoreQueryBuilder {
	rb.v.Filter = &filter
	return rb
}

// QueryName_ set the QueryName_ property for ConstantScoreQueryBuilder.
