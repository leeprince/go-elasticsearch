...
func NewTotalUserProfiles() *TotalUserProfilesBuilder {
...
// Relation set the Relation property for TotalUserProfilesBuilder.
func (rb *TotalUserProfilesBuilder) Relation(relation RelationName) *TotalUserProfilesBuilder {
	rb.v.Relation = relation
	return rb
}

// Value set the Value property for TotalUserProfilesBuilder.
