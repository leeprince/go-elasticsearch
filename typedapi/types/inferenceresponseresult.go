...
func NewInferenceResponseResult() *InferenceResponseResultBuilder {
...
// Entities If the model is trained for named entity recognition (NER) tasks, the
// response contains the recognized entities.
func (rb *InferenceResponseResultBuilder) Entities(entities ...TrainedModelEntities) *InferenceResponseResultBuilder {
	rb.v.Entities = append(rb.v.Entities, entities...)
	return rb
}

// FeatureImportance The feature importance for the inference results. Relevant only for
// classification or regression models
func (rb *InferenceResponseResultBuilder) FeatureImportance(feature_importance ...TrainedModelInferenceFeatureImportance) *InferenceResponseResultBuilder {
...
func (rb *InferenceResponseResultBuilder) PredictedValue(predicted_value ...PredictedValue) *InferenceResponseResultBuilder {
	rb.v.PredictedValue = append(rb.v.PredictedValue, predicted_value...)
	return rb
}
...
// response contains a list of top
// class entries.
func (rb *InferenceResponseResultBuilder) TopClasses(top_classes ...TopClassEntry) *InferenceResponseResultBuilder {
