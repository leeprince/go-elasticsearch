...
func NewMultiBucketAggregateBaseRangeBucket() *MultiBucketAggregateBaseRangeBucketBuilder {
...
// Buckets set the Buckets property for MultiBucketAggregateBaseRangeBucketBuilder.
func (rb *MultiBucketAggregateBaseRangeBucketBuilder) Buckets(buckets BucketsRangeBucket) *MultiBucketAggregateBaseRangeBucketBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for MultiBucketAggregateBaseRangeBucketBuilder.
func (rb *MultiBucketAggregateBaseRangeBucketBuilder) Meta(meta Metadata) *MultiBucketAggregateBaseRangeBucketBuilder {
	rb.v.Meta = &meta
	return rb
}
