...
func NewStopAnalyzer() *StopAnalyzerBuilder {
...
// Stopwords set the Stopwords property for StopAnalyzerBuilder.
func (rb *StopAnalyzerBuilder) Stopwords(stopwords StopWords) *StopAnalyzerBuilder {
	rb.v.Stopwords = &stopwords
	return rb
}

// StopwordsPath set the StopwordsPath property for StopAnalyzerBuilder.
func (rb *StopAnalyzerBuilder) StopwordsPath(stopwordspath string) *StopAnalyzerBuilder {
	rb.v.StopwordsPath = &stopwordspath
	return rb
}

// Type set the Type property for StopAnalyzerBuilder.

// Version set the Version property for StopAnalyzerBuilder.
