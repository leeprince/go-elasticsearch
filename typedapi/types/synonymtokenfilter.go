...
func NewSynonymTokenFilter() *SynonymTokenFilterBuilder {
...
// SynonymsPath set the SynonymsPath property for SynonymTokenFilterBuilder.
...
// Tokenizer set the Tokenizer property for SynonymTokenFilterBuilder.
func (rb *SynonymTokenFilterBuilder) Tokenizer(tokenizer string) *SynonymTokenFilterBuilder {
	rb.v.Tokenizer = &tokenizer
	return rb
}

// Type set the Type property for SynonymTokenFilterBuilder.

// Updateable set the Updateable property for SynonymTokenFilterBuilder.
func (rb *SynonymTokenFilterBuilder) Updateable(updateable bool) *SynonymTokenFilterBuilder {
	rb.v.Updateable = &updateable
	return rb
}

// Version set the Version property for SynonymTokenFilterBuilder.
