...
func NewDataframeEvaluationRegressionMetrics() *DataframeEvaluationRegressionMetricsBuilder {
...
// Huber Pseudo Huber loss function.
func (rb *DataframeEvaluationRegressionMetricsBuilder) Huber(huber DataframeEvaluationRegressionMetricsHuber) *DataframeEvaluationRegressionMetricsBuilder {
	rb.v.Huber = &huber
	return rb
}
...
// Msle Average squared difference between the logarithm of the predicted values and
// the logarithm of the actual (ground truth) value.
func (rb *DataframeEvaluationRegressionMetricsBuilder) Msle(msle DataframeEvaluationRegressionMetricsMsle) *DataframeEvaluationRegressionMetricsBuilder {
	rb.v.Msle = &msle
	return rb
}
