...
func NewBucketsHistogramBucket() *BucketsHistogramBucketBuilder {
...
// HistogramBuckets set the HistogramBuckets property for BucketsHistogramBucketBuilder.
func (u *BucketsHistogramBucketBuilder) HistogramBuckets(v []HistogramBucket) *BucketsHistogramBucketBuilder {
	u.v = v
	return u
}

// Map set the Map property for BucketsHistogramBucketBuilder.
func (u *BucketsHistogramBucketBuilder) Map(v map[string]HistogramBucket) *BucketsHistogramBucketBuilder {
	u.v = v
	return u
}
