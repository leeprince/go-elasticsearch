...
func NewBucketCorrelationFunctionCountCorrelation() *BucketCorrelationFunctionCountCorrelationBuilder {
...
// Indicator The indicator with which to correlate the configured `bucket_path` values.
func (rb *BucketCorrelationFunctionCountCorrelationBuilder) Indicator(indicator BucketCorrelationFunctionCountCorrelationIndicator) *BucketCorrelationFunctionCountCorrelationBuilder {
	rb.v.Indicator = indicator
	return rb
}
