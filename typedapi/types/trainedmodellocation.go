...
func NewTrainedModelLocation() *TrainedModelLocationBuilder {
...
// Index set the Index property for TrainedModelLocationBuilder.
func (rb *TrainedModelLocationBuilder) Index(index TrainedModelLocationIndex) *TrainedModelLocationBuilder {
	rb.v.Index = index
	return rb
}
