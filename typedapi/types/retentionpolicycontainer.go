...
func NewRetentionPolicyContainer() *RetentionPolicyContainerBuilder {
...
// Time Specifies that the transform uses a time field to set the retention policy.
func (rb *RetentionPolicyContainerBuilder) Time(time RetentionPolicy) *RetentionPolicyContainerBuilder {
	rb.v.Time = &time
	return rb
}
