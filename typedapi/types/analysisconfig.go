...
func NewAnalysisConfig() *AnalysisConfigBuilder {
...
// of the date histogram aggregation.
// * @server_default 5m
func (rb *AnalysisConfigBuilder) BucketSpan(bucketspan TimeSpan) *AnalysisConfigBuilder {
...
// either as a string or as an object. If it is a string, it must refer to a
// built-in analyzer or one added by another plugin.
func (rb *AnalysisConfigBuilder) CategorizationAnalyzer(categorizationanalyzer CategorizationAnalyzer) *AnalysisConfigBuilder {
	rb.v.CategorizationAnalyzer = &categorizationanalyzer
	return rb
}
...
func (rb *AnalysisConfigBuilder) CategorizationFilters(categorization_filters ...string) *AnalysisConfigBuilder {
	rb.v.CategorizationFilters = append(rb.v.CategorizationFilters, categorization_filters...)
	return rb
}
...
// detectors for a job. If the detectors array does not contain at least one
// detector, no analysis can occur and an error is returned.
func (rb *AnalysisConfigBuilder) Detectors(detectors ...Detector) *AnalysisConfigBuilder {
	rb.v.Detectors = append(rb.v.Detectors, detectors...)
	return rb
}
...
// NOTE: Latency is applicable only when you send data by using the post data
// API.
func (rb *AnalysisConfigBuilder) Latency(latency Time) *AnalysisConfigBuilder {
	rb.v.Latency = &latency
	return rb
}
...
// from the model. For jobs created in 8.1 and later, the default value is the
// greater of `30d` or 20 times `bucket_span`.
func (rb *AnalysisConfigBuilder) ModelPruneWindow(modelprunewindow Time) *AnalysisConfigBuilder {
	rb.v.ModelPruneWindow = &modelprunewindow
	return rb
}
...
// PerPartitionCategorization Settings related to how categorization interacts with partition fields.
func (rb *AnalysisConfigBuilder) PerPartitionCategorization(perpartitioncategorization PerPartitionCategorization) *AnalysisConfigBuilder {
	rb.v.PerPartitionCategorization = &perpartitioncategorization
	return rb
}
