...
// DocFreq set the DocFreq property for TermBuilder.
func (rb *TermBuilder) DocFreq(docfreq int) *TermBuilder {
	rb.v.DocFreq = &docfreq
	return rb
}

// Score set the Score property for TermBuilder.
func (rb *TermBuilder) Score(score float64) *TermBuilder {
	rb.v.Score = &score
	return rb
}

// TermFreq set the TermFreq property for TermBuilder.
func (rb *TermBuilder) TermFreq(termfreq int) *TermBuilder {
	rb.v.TermFreq = termfreq
	return rb
}

// Tokens set the Tokens property for TermBuilder.
func (rb *TermBuilder) Tokens(tokens ...Token) *TermBuilder {
	rb.v.Tokens = append(rb.v.Tokens, tokens...)
	return rb
}

// Ttf set the Ttf property for TermBuilder.
