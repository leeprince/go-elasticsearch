...
func NewAutoscalingResources() *AutoscalingResourcesBuilder {
...
// Memory set the Memory property for AutoscalingResourcesBuilder.
func (rb *AutoscalingResourcesBuilder) Memory(memory int) *AutoscalingResourcesBuilder {
	rb.v.Memory = memory
	return rb
}

// Storage set the Storage property for AutoscalingResourcesBuilder.
