...
func NewFieldValueFactorScoreFunction() *FieldValueFactorScoreFunctionBuilder {
...
// Factor set the Factor property for FieldValueFactorScoreFunctionBuilder.
func (rb *FieldValueFactorScoreFunctionBuilder) Factor(factor float64) *FieldValueFactorScoreFunctionBuilder {
	rb.v.Factor = &factor
	return rb
}

// Field set the Field property for FieldValueFactorScoreFunctionBuilder.
func (rb *FieldValueFactorScoreFunctionBuilder) Field(field Field) *FieldValueFactorScoreFunctionBuilder {
	rb.v.Field = field
	return rb
}

// Missing set the Missing property for FieldValueFactorScoreFunctionBuilder.
...
// Modifier set the Modifier property for FieldValueFactorScoreFunctionBuilder.
