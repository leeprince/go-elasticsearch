...
func NewGrantApiKey() *GrantApiKeyBuilder {
...
// Expiration set the Expiration property for GrantApiKeyBuilder.
func (rb *GrantApiKeyBuilder) Expiration(expiration Time) *GrantApiKeyBuilder {
	rb.v.Expiration = &expiration
	return rb
}

// Name set the Name property for GrantApiKeyBuilder.
func (rb *GrantApiKeyBuilder) Name(name Name) *GrantApiKeyBuilder {
	rb.v.Name = name
	return rb
}

// RoleDescriptors set the RoleDescriptors property for GrantApiKeyBuilder.
func (rb *GrantApiKeyBuilder) RoleDescriptors(value ...map[string]interface{}) *GrantApiKeyBuilder {
	rb.v.RoleDescriptors = append(rb.v.RoleDescriptors, value...)
	return rb
}
