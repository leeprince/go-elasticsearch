...
func NewIntervalsMatch() *IntervalsMatchBuilder {
...
// Analyzer set the Analyzer property for IntervalsMatchBuilder.
func (rb *IntervalsMatchBuilder) Analyzer(analyzer string) *IntervalsMatchBuilder {
	rb.v.Analyzer = &analyzer
	return rb
}

// Filter set the Filter property for IntervalsMatchBuilder.
func (rb *IntervalsMatchBuilder) Filter(filter IntervalsFilter) *IntervalsMatchBuilder {
	rb.v.Filter = &filter
	return rb
}

// MaxGaps set the MaxGaps property for IntervalsMatchBuilder.
func (rb *IntervalsMatchBuilder) MaxGaps(maxgaps int) *IntervalsMatchBuilder {
	rb.v.MaxGaps = &maxgaps
	return rb
}

// Ordered set the Ordered property for IntervalsMatchBuilder.
func (rb *IntervalsMatchBuilder) Ordered(ordered bool) *IntervalsMatchBuilder {
	rb.v.Ordered = &ordered
	return rb
}

// Query set the Query property for IntervalsMatchBuilder.
func (rb *IntervalsMatchBuilder) Query(query string) *IntervalsMatchBuilder {
	rb.v.Query = query
	return rb
}

// UseField set the UseField property for IntervalsMatchBuilder.
