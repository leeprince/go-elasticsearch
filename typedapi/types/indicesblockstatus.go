...
func NewIndicesBlockStatus() *IndicesBlockStatusBuilder {
...
// Blocked set the Blocked property for IndicesBlockStatusBuilder.
func (rb *IndicesBlockStatusBuilder) Blocked(blocked bool) *IndicesBlockStatusBuilder {
	rb.v.Blocked = blocked
	return rb
}

// Name set the Name property for IndicesBlockStatusBuilder.
