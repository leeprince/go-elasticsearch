...
func NewSingleMetricAggregateBase() *SingleMetricAggregateBaseBuilder {
...
// Meta set the Meta property for SingleMetricAggregateBaseBuilder.
func (rb *SingleMetricAggregateBaseBuilder) Meta(meta Metadata) *SingleMetricAggregateBaseBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for SingleMetricAggregateBaseBuilder.
