...
func NewIndicesVersions() *IndicesVersionsBuilder {
...
// IndexCount set the IndexCount property for IndicesVersionsBuilder.
func (rb *IndicesVersionsBuilder) IndexCount(indexcount int) *IndicesVersionsBuilder {
	rb.v.IndexCount = indexcount
	return rb
}

// PrimaryShardCount set the PrimaryShardCount property for IndicesVersionsBuilder.
...
// TotalPrimaryBytes set the TotalPrimaryBytes property for IndicesVersionsBuilder.
...
// Version set the Version property for IndicesVersionsBuilder.
