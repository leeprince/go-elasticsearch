...
func NewAutoFollowPatternSummary() *AutoFollowPatternSummaryBuilder {
...
// Active set the Active property for AutoFollowPatternSummaryBuilder.
...
// LeaderIndexExclusionPatterns An array of simple index patterns that can be used to exclude indices from
// being auto-followed.
func (rb *AutoFollowPatternSummaryBuilder) LeaderIndexExclusionPatterns(leaderindexexclusionpatterns IndexPatterns) *AutoFollowPatternSummaryBuilder {
...
// LeaderIndexPatterns An array of simple index patterns to match against indices in the remote
// cluster specified by the remote_cluster field.
func (rb *AutoFollowPatternSummaryBuilder) LeaderIndexPatterns(leaderindexpatterns IndexPatterns) *AutoFollowPatternSummaryBuilder {
