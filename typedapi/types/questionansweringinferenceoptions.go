...
func NewQuestionAnsweringInferenceOptions() *QuestionAnsweringInferenceOptionsBuilder {
...
// Tokenization The tokenization options to update when inferring
func (rb *QuestionAnsweringInferenceOptionsBuilder) Tokenization(tokenization TokenizationConfigContainer) *QuestionAnsweringInferenceOptionsBuilder {
