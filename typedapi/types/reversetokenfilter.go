...
func NewReverseTokenFilter() *ReverseTokenFilterBuilder {
...
// Type set the Type property for ReverseTokenFilterBuilder.

// Version set the Version property for ReverseTokenFilterBuilder.
