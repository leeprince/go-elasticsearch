...
func NewIndexRoutingAllocationInitialRecovery() *IndexRoutingAllocationInitialRecoveryBuilder {
...
// Id_ set the Id_ property for IndexRoutingAllocationInitialRecoveryBuilder.
