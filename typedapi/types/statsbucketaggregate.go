...
func NewStatsBucketAggregate() *StatsBucketAggregateBuilder {
...
// Avg set the Avg property for StatsBucketAggregateBuilder.
func (rb *StatsBucketAggregateBuilder) Avg(avg float64) *StatsBucketAggregateBuilder {
	rb.v.Avg = avg
	return rb
}

// AvgAsString set the AvgAsString property for StatsBucketAggregateBuilder.
...
// Count set the Count property for StatsBucketAggregateBuilder.
func (rb *StatsBucketAggregateBuilder) Count(count int64) *StatsBucketAggregateBuilder {
	rb.v.Count = count
	return rb
}

// Max set the Max property for StatsBucketAggregateBuilder.
func (rb *StatsBucketAggregateBuilder) Max(max float64) *StatsBucketAggregateBuilder {
	rb.v.Max = max
	return rb
}

// MaxAsString set the MaxAsString property for StatsBucketAggregateBuilder.
...
// Meta set the Meta property for StatsBucketAggregateBuilder.
func (rb *StatsBucketAggregateBuilder) Meta(meta Metadata) *StatsBucketAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Min set the Min property for StatsBucketAggregateBuilder.
func (rb *StatsBucketAggregateBuilder) Min(min float64) *StatsBucketAggregateBuilder {
	rb.v.Min = min
	return rb
}

// MinAsString set the MinAsString property for StatsBucketAggregateBuilder.
...
// Sum set the Sum property for StatsBucketAggregateBuilder.
func (rb *StatsBucketAggregateBuilder) Sum(sum float64) *StatsBucketAggregateBuilder {
	rb.v.Sum = sum
	return rb
}

// SumAsString set the SumAsString property for StatsBucketAggregateBuilder.
