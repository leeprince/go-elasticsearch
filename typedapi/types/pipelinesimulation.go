...
func NewPipelineSimulation() *PipelineSimulationBuilder {
...
// Doc set the Doc property for PipelineSimulationBuilder.
func (rb *PipelineSimulationBuilder) Doc(doc DocumentSimulation) *PipelineSimulationBuilder {
	rb.v.Doc = &doc
	return rb
}

// ProcessorResults set the ProcessorResults property for PipelineSimulationBuilder.
func (rb *PipelineSimulationBuilder) ProcessorResults(processor_results ...PipelineSimulation) *PipelineSimulationBuilder {
	rb.v.ProcessorResults = append(rb.v.ProcessorResults, processor_results...)
	return rb
}

// ProcessorType set the ProcessorType property for PipelineSimulationBuilder.
...
// Status set the Status property for PipelineSimulationBuilder.
func (rb *PipelineSimulationBuilder) Status(status actionstatusoptions.ActionStatusOptions) *PipelineSimulationBuilder {
	rb.v.Status = &status
	return rb
}

// Tag set the Tag property for PipelineSimulationBuilder.
