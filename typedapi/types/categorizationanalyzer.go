...
func NewCategorizationAnalyzer() *CategorizationAnalyzerBuilder {
...
// CategorizationAnalyzerDefinition set the CategorizationAnalyzerDefinition property for CategorizationAnalyzerBuilder.
func (u *CategorizationAnalyzerBuilder) CategorizationAnalyzerDefinition(v CategorizationAnalyzerDefinition) *CategorizationAnalyzerBuilder {
	u.v = v
	return u
}

// String set the String property for CategorizationAnalyzerBuilder.
func (u *CategorizationAnalyzerBuilder) String(v string) *CategorizationAnalyzerBuilder {
	u.v = v
	return u
}
