...
func NewVariableWidthHistogramAggregate() *VariableWidthHistogramAggregateBuilder {
...
// Buckets set the Buckets property for VariableWidthHistogramAggregateBuilder.
func (rb *VariableWidthHistogramAggregateBuilder) Buckets(buckets BucketsVariableWidthHistogramBucket) *VariableWidthHistogramAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for VariableWidthHistogramAggregateBuilder.
func (rb *VariableWidthHistogramAggregateBuilder) Meta(meta Metadata) *VariableWidthHistogramAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
