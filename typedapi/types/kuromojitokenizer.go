...
func NewKuromojiTokenizer() *KuromojiTokenizerBuilder {
...
// DiscardCompoundToken set the DiscardCompoundToken property for KuromojiTokenizerBuilder.
...
// DiscardPunctuation set the DiscardPunctuation property for KuromojiTokenizerBuilder.
...
// Type set the Type property for KuromojiTokenizerBuilder.

// UserDictionary set the UserDictionary property for KuromojiTokenizerBuilder.
...
// UserDictionaryRules set the UserDictionaryRules property for KuromojiTokenizerBuilder.
func (rb *KuromojiTokenizerBuilder) UserDictionaryRules(user_dictionary_rules ...string) *KuromojiTokenizerBuilder {
	rb.v.UserDictionaryRules = append(rb.v.UserDictionaryRules, user_dictionary_rules...)
	return rb
}

// Version set the Version property for KuromojiTokenizerBuilder.
