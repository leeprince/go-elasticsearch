...
func NewLifecycleExplainUnmanaged() *LifecycleExplainUnmanagedBuilder {
...
// Index set the Index property for LifecycleExplainUnmanagedBuilder.
func (rb *LifecycleExplainUnmanagedBuilder) Index(index IndexName) *LifecycleExplainUnmanagedBuilder {
	rb.v.Index = index
	return rb
}

// Managed set the Managed property for LifecycleExplainUnmanagedBuilder.
