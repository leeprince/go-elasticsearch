...
func NewHoltWintersMovingAverageAggregation() *HoltWintersMovingAverageAggregationBuilder {
...
// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *HoltWintersMovingAverageAggregationBuilder) BucketsPath(bucketspath BucketsPath) *HoltWintersMovingAverageAggregationBuilder {
	rb.v.BucketsPath = &bucketspath
	return rb
}

// Format set the Format property for HoltWintersMovingAverageAggregationBuilder.
func (rb *HoltWintersMovingAverageAggregationBuilder) Format(format string) *HoltWintersMovingAverageAggregationBuilder {
	rb.v.Format = &format
	return rb
}

// GapPolicy set the GapPolicy property for HoltWintersMovingAverageAggregationBuilder.
...
// Meta set the Meta property for HoltWintersMovingAverageAggregationBuilder.
func (rb *HoltWintersMovingAverageAggregationBuilder) Meta(meta Metadata) *HoltWintersMovingAverageAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Minimize set the Minimize property for HoltWintersMovingAverageAggregationBuilder.
...
// Model set the Model property for HoltWintersMovingAverageAggregationBuilder.

// Name set the Name property for HoltWintersMovingAverageAggregationBuilder.
func (rb *HoltWintersMovingAverageAggregationBuilder) Name(name string) *HoltWintersMovingAverageAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Predict set the Predict property for HoltWintersMovingAverageAggregationBuilder.
...
// Settings set the Settings property for HoltWintersMovingAverageAggregationBuilder.
func (rb *HoltWintersMovingAverageAggregationBuilder) Settings(settings HoltWintersModelSettings) *HoltWintersMovingAverageAggregationBuilder {
	rb.v.Settings = settings
	return rb
}

// Window set the Window property for HoltWintersMovingAverageAggregationBuilder.
