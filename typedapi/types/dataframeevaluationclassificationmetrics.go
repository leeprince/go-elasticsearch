...
func NewDataframeEvaluationClassificationMetrics() *DataframeEvaluationClassificationMetricsBuilder {
...
// score and optionally the curve. It is calculated for a specific class
// (provided as "class_name") treated as positive.
func (rb *DataframeEvaluationClassificationMetricsBuilder) AucRoc(aucroc DataframeEvaluationClassificationMetricsAucRoc) *DataframeEvaluationClassificationMetricsBuilder {
	rb.v.AucRoc = &aucroc
	return rb
}
