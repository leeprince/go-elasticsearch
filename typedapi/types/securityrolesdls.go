...
func NewSecurityRolesDls() *SecurityRolesDlsBuilder {
...
// BitSetCache set the BitSetCache property for SecurityRolesDlsBuilder.
func (rb *SecurityRolesDlsBuilder) BitSetCache(bitsetcache SecurityRolesDlsBitSetCache) *SecurityRolesDlsBuilder {
	rb.v.BitSetCache = bitsetcache
	return rb
}
