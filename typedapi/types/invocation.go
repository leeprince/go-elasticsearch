...
func NewInvocation() *InvocationBuilder {
	r := InvocationBuilder{
		&Invocation{},
	}
...
// SnapshotName set the SnapshotName property for InvocationBuilder.
func (rb *InvocationBuilder) SnapshotName(snapshotname Name) *InvocationBuilder {
	rb.v.SnapshotName = snapshotname
	return rb
}

// Time set the Time property for InvocationBuilder.
func (rb *InvocationBuilder) Time(time DateString) *InvocationBuilder {
	rb.v.Time = time
	return rb
}
