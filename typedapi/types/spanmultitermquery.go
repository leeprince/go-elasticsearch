...
func NewSpanMultiTermQuery() *SpanMultiTermQueryBuilder {
...
// Boost set the Boost property for SpanMultiTermQueryBuilder.
...
// Match Should be a multi term query (one of wildcard, fuzzy, prefix, range or regexp
// query)
func (rb *SpanMultiTermQueryBuilder) Match(match QueryContainer) *SpanMultiTermQueryBuilder {
	rb.v.Match = &match
	return rb
}

// QueryName_ set the QueryName_ property for SpanMultiTermQueryBuilder.
