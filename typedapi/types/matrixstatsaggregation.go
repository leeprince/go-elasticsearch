...
func NewMatrixStatsAggregation() *MatrixStatsAggregationBuilder {
...
// Fields set the Fields property for MatrixStatsAggregationBuilder.
func (rb *MatrixStatsAggregationBuilder) Fields(fields Fields) *MatrixStatsAggregationBuilder {
	rb.v.Fields = &fields
	return rb
}

// Meta set the Meta property for MatrixStatsAggregationBuilder.
func (rb *MatrixStatsAggregationBuilder) Meta(meta Metadata) *MatrixStatsAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Missing set the Missing property for MatrixStatsAggregationBuilder.
func (rb *MatrixStatsAggregationBuilder) Missing(value map[Field]float64) *MatrixStatsAggregationBuilder {
	rb.v.Missing = value
	return rb
}

// Mode set the Mode property for MatrixStatsAggregationBuilder.
func (rb *MatrixStatsAggregationBuilder) Mode(mode sortmode.SortMode) *MatrixStatsAggregationBuilder {
	rb.v.Mode = &mode
	return rb
}

// Name set the Name property for MatrixStatsAggregationBuilder.
