...
func NewLongRareTermsBucket() *LongRareTermsBucketBuilder {
...
// Aggregations set the Aggregations property for LongRareTermsBucketBuilder.
func (rb *LongRareTermsBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *LongRareTermsBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for LongRareTermsBucketBuilder.
func (rb *LongRareTermsBucketBuilder) DocCount(doccount int64) *LongRareTermsBucketBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Key set the Key property for LongRareTermsBucketBuilder.
func (rb *LongRareTermsBucketBuilder) Key(key int64) *LongRareTermsBucketBuilder {
	rb.v.Key = key
	return rb
}

// KeyAsString set the KeyAsString property for LongRareTermsBucketBuilder.
