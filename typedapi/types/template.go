...
// Aliases set the Aliases property for TemplateBuilder.
func (rb *TemplateBuilder) Aliases(value map[IndexName]Alias) *TemplateBuilder {
	rb.v.Aliases = value
	return rb
}

// Mappings set the Mappings property for TemplateBuilder.
func (rb *TemplateBuilder) Mappings(mappings TypeMapping) *TemplateBuilder {
	rb.v.Mappings = mappings
	return rb
}

// Settings set the Settings property for TemplateBuilder.
func (rb *TemplateBuilder) Settings(settings IndexSettings) *TemplateBuilder {
