...
func NewHdrPercentileRanksAggregate() *HdrPercentileRanksAggregateBuilder {
...
// Meta set the Meta property for HdrPercentileRanksAggregateBuilder.
func (rb *HdrPercentileRanksAggregateBuilder) Meta(meta Metadata) *HdrPercentileRanksAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Values set the Values property for HdrPercentileRanksAggregateBuilder.
func (rb *HdrPercentileRanksAggregateBuilder) Values(values Percentiles) *HdrPercentileRanksAggregateBuilder {
	rb.v.Values = values
	return rb
}
