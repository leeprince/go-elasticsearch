...
func NewPercentilesAggregateBase() *PercentilesAggregateBaseBuilder {
...
// Meta set the Meta property for PercentilesAggregateBaseBuilder.
func (rb *PercentilesAggregateBaseBuilder) Meta(meta Metadata) *PercentilesAggregateBaseBuilder {
	rb.v.Meta = &meta
	return rb
}

// Values set the Values property for PercentilesAggregateBaseBuilder.
func (rb *PercentilesAggregateBaseBuilder) Values(values Percentiles) *PercentilesAggregateBaseBuilder {
	rb.v.Values = values
	return rb
}
