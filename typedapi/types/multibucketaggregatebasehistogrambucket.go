...
func NewMultiBucketAggregateBaseHistogramBucket() *MultiBucketAggregateBaseHistogramBucketBuilder {
...
// Buckets set the Buckets property for MultiBucketAggregateBaseHistogramBucketBuilder.
func (rb *MultiBucketAggregateBaseHistogramBucketBuilder) Buckets(buckets BucketsHistogramBucket) *MultiBucketAggregateBaseHistogramBucketBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for MultiBucketAggregateBaseHistogramBucketBuilder.
func (rb *MultiBucketAggregateBaseHistogramBucketBuilder) Meta(meta Metadata) *MultiBucketAggregateBaseHistogramBucketBuilder {
	rb.v.Meta = &meta
	return rb
}
