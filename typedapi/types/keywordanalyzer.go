...
func NewKeywordAnalyzer() *KeywordAnalyzerBuilder {
...
// Type set the Type property for KeywordAnalyzerBuilder.

// Version set the Version property for KeywordAnalyzerBuilder.
