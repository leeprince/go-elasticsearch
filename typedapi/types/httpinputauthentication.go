...
func NewHttpInputAuthentication() *HttpInputAuthenticationBuilder {
...
// Basic set the Basic property for HttpInputAuthenticationBuilder.
func (rb *HttpInputAuthenticationBuilder) Basic(basic HttpInputBasicAuthentication) *HttpInputAuthenticationBuilder {
	rb.v.Basic = basic
	return rb
}
