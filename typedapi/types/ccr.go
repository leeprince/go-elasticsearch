...
// AutoFollowPatternsCount set the AutoFollowPatternsCount property for CcrBuilder.
...
// Available set the Available property for CcrBuilder.
func (rb *CcrBuilder) Available(available bool) *CcrBuilder {
	rb.v.Available = available
	return rb
}

// Enabled set the Enabled property for CcrBuilder.
func (rb *CcrBuilder) Enabled(enabled bool) *CcrBuilder {
	rb.v.Enabled = enabled
	return rb
}

// FollowerIndicesCount set the FollowerIndicesCount property for CcrBuilder.
