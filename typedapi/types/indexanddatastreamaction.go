...
func NewIndexAndDataStreamAction() *IndexAndDataStreamActionBuilder {
...
// DataStream set the DataStream property for IndexAndDataStreamActionBuilder.
...
// Index set the Index property for IndexAndDataStreamActionBuilder.
