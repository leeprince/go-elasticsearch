...
func NewLowercaseTokenizer() *LowercaseTokenizerBuilder {
...
// Type set the Type property for LowercaseTokenizerBuilder.

// Version set the Version property for LowercaseTokenizerBuilder.
