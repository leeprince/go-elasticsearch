...
func NewCategorizationAnalyzerDefinition() *CategorizationAnalyzerDefinitionBuilder {
...
// categorization identical to the default for jobs created in these versions,
// specify "tokenizer": "ml_classic" in your `categorization_analyzer`.
func (rb *CategorizationAnalyzerDefinitionBuilder) Tokenizer(tokenizer Tokenizer) *CategorizationAnalyzerDefinitionBuilder {
