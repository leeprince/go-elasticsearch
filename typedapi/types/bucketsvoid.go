...
func NewBucketsVoid() *BucketsVoidBuilder {
...
// Map set the Map property for BucketsVoidBuilder.
func (u *BucketsVoidBuilder) Map(v map[string]Void) *BucketsVoidBuilder {
	u.v = v
	return u
}

// Voids set the Voids property for BucketsVoidBuilder.
func (u *BucketsVoidBuilder) Voids(v []Void) *BucketsVoidBuilder {
	u.v = v
	return u
}
