...
func NewMultiBucketAggregateBaseCompositeBucket() *MultiBucketAggregateBaseCompositeBucketBuilder {
...
// Buckets set the Buckets property for MultiBucketAggregateBaseCompositeBucketBuilder.
func (rb *MultiBucketAggregateBaseCompositeBucketBuilder) Buckets(buckets BucketsCompositeBucket) *MultiBucketAggregateBaseCompositeBucketBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for MultiBucketAggregateBaseCompositeBucketBuilder.
func (rb *MultiBucketAggregateBaseCompositeBucketBuilder) Meta(meta Metadata) *MultiBucketAggregateBaseCompositeBucketBuilder {
	rb.v.Meta = &meta
	return rb
}
