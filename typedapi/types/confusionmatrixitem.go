...
func NewConfusionMatrixItem() *ConfusionMatrixItemBuilder {
...
// ActualClass set the ActualClass property for ConfusionMatrixItemBuilder.
func (rb *ConfusionMatrixItemBuilder) ActualClass(actualclass Name) *ConfusionMatrixItemBuilder {
	rb.v.ActualClass = actualclass
	return rb
}

// ActualClassDocCount set the ActualClassDocCount property for ConfusionMatrixItemBuilder.
...
// OtherPredictedClassDocCount set the OtherPredictedClassDocCount property for ConfusionMatrixItemBuilder.
...
// PredictedClasses set the PredictedClasses property for ConfusionMatrixItemBuilder.
func (rb *ConfusionMatrixItemBuilder) PredictedClasses(predicted_classes ...ConfusionMatrixPrediction) *ConfusionMatrixItemBuilder {
	rb.v.PredictedClasses = append(rb.v.PredictedClasses, predicted_classes...)
	return rb
}
