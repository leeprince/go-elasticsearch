...
func NewBucketsQueryContainer() *BucketsQueryContainerBuilder {
...
// Map set the Map property for BucketsQueryContainerBuilder.
func (u *BucketsQueryContainerBuilder) Map(v map[string]QueryContainer) *BucketsQueryContainerBuilder {
	u.v = v
	return u
}

// QueryContainers set the QueryContainers property for BucketsQueryContainerBuilder.
func (u *BucketsQueryContainerBuilder) QueryContainers(v []QueryContainer) *BucketsQueryContainerBuilder {
	u.v = v
	return u
}
