...
// PolicyCount set the PolicyCount property for IlmBuilder.
func (rb *IlmBuilder) PolicyCount(policycount int) *IlmBuilder {
	rb.v.PolicyCount = policycount
	return rb
}

// PolicyStats set the PolicyStats property for IlmBuilder.
func (rb *IlmBuilder) PolicyStats(policy_stats ...IlmPolicyStatistics) *IlmBuilder {
	rb.v.PolicyStats = append(rb.v.PolicyStats, policy_stats...)
	return rb
}
