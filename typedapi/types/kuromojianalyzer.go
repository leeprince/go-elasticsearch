...
func NewKuromojiAnalyzer() *KuromojiAnalyzerBuilder {
...
// Mode set the Mode property for KuromojiAnalyzerBuilder.
func (rb *KuromojiAnalyzerBuilder) Mode(mode kuromojitokenizationmode.KuromojiTokenizationMode) *KuromojiAnalyzerBuilder {
	rb.v.Mode = mode
	return rb
}

// Type set the Type property for KuromojiAnalyzerBuilder.

// UserDictionary set the UserDictionary property for KuromojiAnalyzerBuilder.
