...
func NewPhoneticTokenFilter() *PhoneticTokenFilterBuilder {
...
// Encoder set the Encoder property for PhoneticTokenFilterBuilder.
...
// Languageset set the Languageset property for PhoneticTokenFilterBuilder.
func (rb *PhoneticTokenFilterBuilder) Languageset(languageset ...phoneticlanguage.PhoneticLanguage) *PhoneticTokenFilterBuilder {
	rb.v.Languageset = append(rb.v.Languageset, languageset...)
	return rb
}

// MaxCodeLen set the MaxCodeLen property for PhoneticTokenFilterBuilder.
func (rb *PhoneticTokenFilterBuilder) MaxCodeLen(maxcodelen int) *PhoneticTokenFilterBuilder {
	rb.v.MaxCodeLen = &maxcodelen
	return rb
}

// NameType set the NameType property for PhoneticTokenFilterBuilder.
...
// Replace set the Replace property for PhoneticTokenFilterBuilder.
func (rb *PhoneticTokenFilterBuilder) Replace(replace bool) *PhoneticTokenFilterBuilder {
	rb.v.Replace = &replace
	return rb
}

// RuleType set the RuleType property for PhoneticTokenFilterBuilder.
...
// Type set the Type property for PhoneticTokenFilterBuilder.

// Version set the Version property for PhoneticTokenFilterBuilder.
