...
func NewSignificantStringTermsAggregate() *SignificantStringTermsAggregateBuilder {
...
// Buckets set the Buckets property for SignificantStringTermsAggregateBuilder.
func (rb *SignificantStringTermsAggregateBuilder) Buckets(buckets BucketsSignificantStringTermsBucket) *SignificantStringTermsAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for SignificantStringTermsAggregateBuilder.
func (rb *SignificantStringTermsAggregateBuilder) Meta(meta Metadata) *SignificantStringTermsAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
