...
func NewFillMaskInferenceUpdateOptions() *FillMaskInferenceUpdateOptionsBuilder {
...
// Tokenization The tokenization options to update when inferring
func (rb *FillMaskInferenceUpdateOptionsBuilder) Tokenization(tokenization NlpTokenizationUpdateOptions) *FillMaskInferenceUpdateOptionsBuilder {
