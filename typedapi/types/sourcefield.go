...
func NewSourceField() *SourceFieldBuilder {
...
// Compress set the Compress property for SourceFieldBuilder.
func (rb *SourceFieldBuilder) Compress(compress bool) *SourceFieldBuilder {
	rb.v.Compress = &compress
	return rb
}

// CompressThreshold set the CompressThreshold property for SourceFieldBuilder.
...
// Enabled set the Enabled property for SourceFieldBuilder.
func (rb *SourceFieldBuilder) Enabled(enabled bool) *SourceFieldBuilder {
	rb.v.Enabled = &enabled
	return rb
}

// Excludes set the Excludes property for SourceFieldBuilder.
func (rb *SourceFieldBuilder) Excludes(excludes ...string) *SourceFieldBuilder {
	rb.v.Excludes = append(rb.v.Excludes, excludes...)
	return rb
}

// Includes set the Includes property for SourceFieldBuilder.
func (rb *SourceFieldBuilder) Includes(includes ...string) *SourceFieldBuilder {
	rb.v.Includes = append(rb.v.Includes, includes...)
	return rb
}
