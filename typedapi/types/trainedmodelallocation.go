...
func NewTrainedModelAllocation() *TrainedModelAllocationBuilder {
...
// RoutingTable The allocation state for each node.
func (rb *TrainedModelAllocationBuilder) RoutingTable(value map[string]TrainedModelAllocationRoutingTable) *TrainedModelAllocationBuilder {
	rb.v.RoutingTable = value
	return rb
}
...
// TaskParameters set the TaskParameters property for TrainedModelAllocationBuilder.
func (rb *TrainedModelAllocationBuilder) TaskParameters(taskparameters TrainedModelAllocationTaskParameters) *TrainedModelAllocationBuilder {
	rb.v.TaskParameters = taskparameters
	return rb
}
