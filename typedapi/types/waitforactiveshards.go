...
func NewWaitForActiveShards() *WaitForActiveShardsBuilder {
...
// Int set the Int property for WaitForActiveShardsBuilder.
func (u *WaitForActiveShardsBuilder) Int(v int) *WaitForActiveShardsBuilder {
	u.v = v
	return u
}

// WaitForActiveShardOptions set the WaitForActiveShardOptions property for WaitForActiveShardsBuilder.
func (u *WaitForActiveShardsBuilder) WaitForActiveShardOptions(v waitforactiveshardoptions.WaitForActiveShardOptions) *WaitForActiveShardsBuilder {
	u.v = v
	return u
}
