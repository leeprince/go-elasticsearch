...
func NewSuggestContext() *SuggestContextBuilder {
...
// Name set the Name property for SuggestContextBuilder.
func (rb *SuggestContextBuilder) Name(name Name) *SuggestContextBuilder {
	rb.v.Name = name
	return rb
}

// Path set the Path property for SuggestContextBuilder.
func (rb *SuggestContextBuilder) Path(path Field) *SuggestContextBuilder {
	rb.v.Path = &path
	return rb
}

// Precision set the Precision property for SuggestContextBuilder.
func (rb *SuggestContextBuilder) Precision(arg string) *SuggestContextBuilder {
	rb.v.Precision = arg
	return rb
}

// Type set the Type property for SuggestContextBuilder.
