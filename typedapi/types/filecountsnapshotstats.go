...
func NewFileCountSnapshotStats() *FileCountSnapshotStatsBuilder {
...
// FileCount set the FileCount property for FileCountSnapshotStatsBuilder.
func (rb *FileCountSnapshotStatsBuilder) FileCount(filecount int) *FileCountSnapshotStatsBuilder {
	rb.v.FileCount = filecount
	return rb
}

// SizeInBytes set the SizeInBytes property for FileCountSnapshotStatsBuilder.
