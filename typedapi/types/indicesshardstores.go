...
func NewIndicesShardStores() *IndicesShardStoresBuilder {
...
// Shards set the Shards property for IndicesShardStoresBuilder.
func (rb *IndicesShardStoresBuilder) Shards(value map[string]ShardStoreWrapper) *IndicesShardStoresBuilder {
	rb.v.Shards = value
	return rb
}
