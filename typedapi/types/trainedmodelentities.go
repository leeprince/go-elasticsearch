...
func NewTrainedModelEntities() *TrainedModelEntitiesBuilder {
...
// ClassName set the ClassName property for TrainedModelEntitiesBuilder.
func (rb *TrainedModelEntitiesBuilder) ClassName(classname string) *TrainedModelEntitiesBuilder {
	rb.v.ClassName = classname
	return rb
}

// ClassProbability set the ClassProbability property for TrainedModelEntitiesBuilder.
...
// EndPos set the EndPos property for TrainedModelEntitiesBuilder.
func (rb *TrainedModelEntitiesBuilder) EndPos(endpos int) *TrainedModelEntitiesBuilder {
	rb.v.EndPos = endpos
	return rb
}

// Entity set the Entity property for TrainedModelEntitiesBuilder.
func (rb *TrainedModelEntitiesBuilder) Entity(entity string) *TrainedModelEntitiesBuilder {
	rb.v.Entity = entity
	return rb
}

// StartPos set the StartPos property for TrainedModelEntitiesBuilder.
