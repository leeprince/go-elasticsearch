...
func NewSegmentsRecord() *SegmentsRecordBuilder {
...
// Size segment size in bytes
func (rb *SegmentsRecordBuilder) Size(size ByteSize) *SegmentsRecordBuilder {
	rb.v.Size = &size
	return rb
}

// SizeMemory segment memory in bytes
func (rb *SegmentsRecordBuilder) SizeMemory(sizememory ByteSize) *SegmentsRecordBuilder {
	rb.v.SizeMemory = &sizememory
	return rb
}
