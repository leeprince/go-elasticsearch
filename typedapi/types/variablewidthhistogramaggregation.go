...
func NewVariableWidthHistogramAggregation() *VariableWidthHistogramAggregationBuilder {
...
// Buckets set the Buckets property for VariableWidthHistogramAggregationBuilder.
...
// Field set the Field property for VariableWidthHistogramAggregationBuilder.
func (rb *VariableWidthHistogramAggregationBuilder) Field(field Field) *VariableWidthHistogramAggregationBuilder {
	rb.v.Field = &field
	return rb
}

// InitialBuffer set the InitialBuffer property for VariableWidthHistogramAggregationBuilder.
...
// ShardSize set the ShardSize property for VariableWidthHistogramAggregationBuilder.
