...
func NewIndexingStats() *IndexingStatsBuilder {
...
// ThrottleTime set the ThrottleTime property for IndexingStatsBuilder.
func (rb *IndexingStatsBuilder) ThrottleTime(throttletime string) *IndexingStatsBuilder {
	rb.v.ThrottleTime = &throttletime
	return rb
}

// ThrottleTimeInMillis set the ThrottleTimeInMillis property for IndexingStatsBuilder.
...
// Types set the Types property for IndexingStatsBuilder.
func (rb *IndexingStatsBuilder) Types(value map[string]IndexingStats) *IndexingStatsBuilder {
	rb.v.Types = value
	return rb
}
