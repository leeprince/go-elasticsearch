...
func NewSuggesterBase() *SuggesterBaseBuilder {
...
// Analyzer set the Analyzer property for SuggesterBaseBuilder.
func (rb *SuggesterBaseBuilder) Analyzer(analyzer string) *SuggesterBaseBuilder {
	rb.v.Analyzer = &analyzer
	return rb
}

// Field set the Field property for SuggesterBaseBuilder.
func (rb *SuggesterBaseBuilder) Field(field Field) *SuggesterBaseBuilder {
	rb.v.Field = field
	return rb
}

// Size set the Size property for SuggesterBaseBuilder.
