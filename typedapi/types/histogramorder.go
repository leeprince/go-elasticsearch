...
func NewHistogramOrder() *HistogramOrderBuilder {
...
// Count_ set the Count_ property for HistogramOrderBuilder.
func (rb *HistogramOrderBuilder) Count_(count_ sortorder.SortOrder) *HistogramOrderBuilder {
	rb.v.Count_ = &count_
	return rb
}

// Key_ set the Key_ property for HistogramOrderBuilder.
