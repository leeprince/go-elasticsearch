...
func NewAuthenticationProvider() *AuthenticationProviderBuilder {
...
// Name set the Name property for AuthenticationProviderBuilder.
func (rb *AuthenticationProviderBuilder) Name(name Name) *AuthenticationProviderBuilder {
	rb.v.Name = name
	return rb
}

// Type set the Type property for AuthenticationProviderBuilder.
