...
func NewErrorResponseBase() *ErrorResponseBaseBuilder {
...
// Error set the Error property for ErrorResponseBaseBuilder.
func (rb *ErrorResponseBaseBuilder) Error(error ErrorCause) *ErrorResponseBaseBuilder {
	rb.v.Error = error
	return rb
}

// Status set the Status property for ErrorResponseBaseBuilder.
