...
func NewCombinedFieldsQuery() *CombinedFieldsQueryBuilder {
...
// AutoGenerateSynonymsPhraseQuery set the AutoGenerateSynonymsPhraseQuery property for CombinedFieldsQueryBuilder.
...
// Boost set the Boost property for CombinedFieldsQueryBuilder.
func (rb *CombinedFieldsQueryBuilder) Boost(boost float32) *CombinedFieldsQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Fields set the Fields property for CombinedFieldsQueryBuilder.
func (rb *CombinedFieldsQueryBuilder) Fields(fields ...Field) *CombinedFieldsQueryBuilder {
	rb.v.Fields = append(rb.v.Fields, fields...)
	return rb
}

// MinimumShouldMatch set the MinimumShouldMatch property for CombinedFieldsQueryBuilder.
func (rb *CombinedFieldsQueryBuilder) MinimumShouldMatch(minimumshouldmatch MinimumShouldMatch) *CombinedFieldsQueryBuilder {
	rb.v.MinimumShouldMatch = &minimumshouldmatch
	return rb
}

// Operator set the Operator property for CombinedFieldsQueryBuilder.
...
// Query set the Query property for CombinedFieldsQueryBuilder.
func (rb *CombinedFieldsQueryBuilder) Query(query string) *CombinedFieldsQueryBuilder {
	rb.v.Query = query
	return rb
}

// QueryName_ set the QueryName_ property for CombinedFieldsQueryBuilder.
func (rb *CombinedFieldsQueryBuilder) QueryName_(queryname_ string) *CombinedFieldsQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// ZeroTermsQuery set the ZeroTermsQuery property for CombinedFieldsQueryBuilder.
