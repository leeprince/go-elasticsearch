...
func NewConstantKeywordProperty() *ConstantKeywordPropertyBuilder {
...
// Dynamic set the Dynamic property for ConstantKeywordPropertyBuilder.
func (rb *ConstantKeywordPropertyBuilder) Dynamic(dynamic dynamicmapping.DynamicMapping) *ConstantKeywordPropertyBuilder {
	rb.v.Dynamic = &dynamic
	return rb
}

// Fields set the Fields property for ConstantKeywordPropertyBuilder.
func (rb *ConstantKeywordPropertyBuilder) Fields(value map[PropertyName]Property) *ConstantKeywordPropertyBuilder {
	rb.v.Fields = value
	return rb
}

// IgnoreAbove set the IgnoreAbove property for ConstantKeywordPropertyBuilder.
func (rb *ConstantKeywordPropertyBuilder) IgnoreAbove(ignoreabove int) *ConstantKeywordPropertyBuilder {
	rb.v.IgnoreAbove = &ignoreabove
	return rb
}

// LocalMetadata set the LocalMetadata property for ConstantKeywordPropertyBuilder.
func (rb *ConstantKeywordPropertyBuilder) LocalMetadata(localmetadata Metadata) *ConstantKeywordPropertyBuilder {
	rb.v.LocalMetadata = &localmetadata
	return rb
}

// Meta set the Meta property for ConstantKeywordPropertyBuilder.
func (rb *ConstantKeywordPropertyBuilder) Meta(value map[string]string) *ConstantKeywordPropertyBuilder {
	rb.v.Meta = value
	return rb
}

// Properties set the Properties property for ConstantKeywordPropertyBuilder.
func (rb *ConstantKeywordPropertyBuilder) Properties(value map[PropertyName]Property) *ConstantKeywordPropertyBuilder {
	rb.v.Properties = value
	return rb
}

// Type set the Type property for ConstantKeywordPropertyBuilder.

// Value set the Value property for ConstantKeywordPropertyBuilder.
