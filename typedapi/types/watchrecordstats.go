...
func NewWatchRecordStats() *WatchRecordStatsBuilder {
...
// ExecutedActions set the ExecutedActions property for WatchRecordStatsBuilder.
func (rb *WatchRecordStatsBuilder) ExecutedActions(executed_actions ...string) *WatchRecordStatsBuilder {
	rb.v.ExecutedActions = append(rb.v.ExecutedActions, executed_actions...)
	return rb
}

// ExecutionPhase set the ExecutionPhase property for WatchRecordStatsBuilder.
...
// ExecutionTime set the ExecutionTime property for WatchRecordStatsBuilder.
...
// TriggeredTime set the TriggeredTime property for WatchRecordStatsBuilder.
...
// WatchId set the WatchId property for WatchRecordStatsBuilder.
func (rb *WatchRecordStatsBuilder) WatchId(watchid Id) *WatchRecordStatsBuilder {
	rb.v.WatchId = watchid
	return rb
}

// WatchRecordId set the WatchRecordId property for WatchRecordStatsBuilder.
