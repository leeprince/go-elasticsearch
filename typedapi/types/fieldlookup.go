...
func NewFieldLookup() *FieldLookupBuilder {
...
// Id set the Id property for FieldLookupBuilder.
func (rb *FieldLookupBuilder) Id(id Id) *FieldLookupBuilder {
	rb.v.Id = id
	return rb
}

// Index set the Index property for FieldLookupBuilder.
func (rb *FieldLookupBuilder) Index(index IndexName) *FieldLookupBuilder {
	rb.v.Index = &index
	return rb
}

// Path set the Path property for FieldLookupBuilder.
func (rb *FieldLookupBuilder) Path(path Field) *FieldLookupBuilder {
	rb.v.Path = &path
	return rb
}

// Routing set the Routing property for FieldLookupBuilder.
