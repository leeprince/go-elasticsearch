...
func NewTrainedModelInferenceStats() *TrainedModelInferenceStatsBuilder {
...
// Timestamp The time when the statistics were last updated.
func (rb *TrainedModelInferenceStatsBuilder) Timestamp(timestamp Time) *TrainedModelInferenceStatsBuilder {
