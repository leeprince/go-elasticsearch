...
func NewKeywordTokenizer() *KeywordTokenizerBuilder {
...
// BufferSize set the BufferSize property for KeywordTokenizerBuilder.
func (rb *KeywordTokenizerBuilder) BufferSize(buffersize int) *KeywordTokenizerBuilder {
	rb.v.BufferSize = buffersize
	return rb
}

// Type set the Type property for KeywordTokenizerBuilder.

// Version set the Version property for KeywordTokenizerBuilder.
