...
func NewSimpleAnalyzer() *SimpleAnalyzerBuilder {
...
// Type set the Type property for SimpleAnalyzerBuilder.

// Version set the Version property for SimpleAnalyzerBuilder.
