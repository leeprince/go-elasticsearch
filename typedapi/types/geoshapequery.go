...
func NewGeoShapeQuery() *GeoShapeQueryBuilder {
...
// Boost set the Boost property for GeoShapeQueryBuilder.
func (rb *GeoShapeQueryBuilder) Boost(boost float32) *GeoShapeQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// GeoShapeQuery set the GeoShapeQuery property for GeoShapeQueryBuilder.
func (rb *GeoShapeQueryBuilder) GeoShapeQuery(value map[Field]GeoShapeFieldQuery) *GeoShapeQueryBuilder {
	rb.v.GeoShapeQuery = value
	return rb
}

// IgnoreUnmapped set the IgnoreUnmapped property for GeoShapeQueryBuilder.
func (rb *GeoShapeQueryBuilder) IgnoreUnmapped(ignoreunmapped bool) *GeoShapeQueryBuilder {
	rb.v.IgnoreUnmapped = &ignoreunmapped
	return rb
}

// QueryName_ set the QueryName_ property for GeoShapeQueryBuilder.
