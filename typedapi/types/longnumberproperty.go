...
func NewLongNumberProperty() *LongNumberPropertyBuilder {
...
// Coerce set the Coerce property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Coerce(coerce bool) *LongNumberPropertyBuilder {
	rb.v.Coerce = &coerce
	return rb
}

// CopyTo set the CopyTo property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) CopyTo(copyto Fields) *LongNumberPropertyBuilder {
	rb.v.CopyTo = &copyto
	return rb
}

// DocValues set the DocValues property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) DocValues(docvalues bool) *LongNumberPropertyBuilder {
	rb.v.DocValues = &docvalues
	return rb
}

// Dynamic set the Dynamic property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Dynamic(dynamic dynamicmapping.DynamicMapping) *LongNumberPropertyBuilder {
	rb.v.Dynamic = &dynamic
	return rb
}

// Fields set the Fields property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Fields(value map[PropertyName]Property) *LongNumberPropertyBuilder {
	rb.v.Fields = value
	return rb
}

// IgnoreAbove set the IgnoreAbove property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) IgnoreAbove(ignoreabove int) *LongNumberPropertyBuilder {
	rb.v.IgnoreAbove = &ignoreabove
	return rb
}

// IgnoreMalformed set the IgnoreMalformed property for LongNumberPropertyBuilder.
...
// Index set the Index property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Index(index bool) *LongNumberPropertyBuilder {
	rb.v.Index = &index
	return rb
}

// LocalMetadata set the LocalMetadata property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) LocalMetadata(localmetadata Metadata) *LongNumberPropertyBuilder {
	rb.v.LocalMetadata = &localmetadata
	return rb
}

// Meta set the Meta property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Meta(value map[string]string) *LongNumberPropertyBuilder {
	rb.v.Meta = value
	return rb
}

// NullValue set the NullValue property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) NullValue(nullvalue int64) *LongNumberPropertyBuilder {
	rb.v.NullValue = &nullvalue
	return rb
}

// OnScriptError set the OnScriptError property for LongNumberPropertyBuilder.
...
// Properties set the Properties property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Properties(value map[PropertyName]Property) *LongNumberPropertyBuilder {
	rb.v.Properties = value
	return rb
}

// Script set the Script property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Script(script Script) *LongNumberPropertyBuilder {
	rb.v.Script = &script
	return rb
}

// Similarity set the Similarity property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Similarity(similarity string) *LongNumberPropertyBuilder {
	rb.v.Similarity = &similarity
	return rb
}

// Store set the Store property for LongNumberPropertyBuilder.
func (rb *LongNumberPropertyBuilder) Store(store bool) *LongNumberPropertyBuilder {
	rb.v.Store = &store
	return rb
}

// TimeSeriesMetric set the TimeSeriesMetric property for LongNumberPropertyBuilder.
...
// Type set the Type property for LongNumberPropertyBuilder.
