...
func NewScriptQuery() *ScriptQueryBuilder {
...
// Boost set the Boost property for ScriptQueryBuilder.
func (rb *ScriptQueryBuilder) Boost(boost float32) *ScriptQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// QueryName_ set the QueryName_ property for ScriptQueryBuilder.
func (rb *ScriptQueryBuilder) QueryName_(queryname_ string) *ScriptQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// Script set the Script property for ScriptQueryBuilder.
func (rb *ScriptQueryBuilder) Script(script Script) *ScriptQueryBuilder {
	rb.v.Script = script
	return rb
}
