...
func NewSpanOrQuery() *SpanOrQueryBuilder {
...
// Boost set the Boost property for SpanOrQueryBuilder.
func (rb *SpanOrQueryBuilder) Boost(boost float32) *SpanOrQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Clauses set the Clauses property for SpanOrQueryBuilder.
func (rb *SpanOrQueryBuilder) Clauses(clauses ...SpanQuery) *SpanOrQueryBuilder {
	rb.v.Clauses = append(rb.v.Clauses, clauses...)
	return rb
}

// QueryName_ set the QueryName_ property for SpanOrQueryBuilder.
