...
func NewShardLease() *ShardLeaseBuilder {
	r := ShardLeaseBuilder{
		&ShardLease{},
	}
...
// Id set the Id property for ShardLeaseBuilder.
func (rb *ShardLeaseBuilder) Id(id Id) *ShardLeaseBuilder {
	rb.v.Id = id
	return rb
}

// RetainingSeqNo set the RetainingSeqNo property for ShardLeaseBuilder.
...
// Source set the Source property for ShardLeaseBuilder.
func (rb *ShardLeaseBuilder) Source(source string) *ShardLeaseBuilder {
	rb.v.Source = source
	return rb
}

// Timestamp set the Timestamp property for ShardLeaseBuilder.
