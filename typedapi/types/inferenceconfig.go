...
func NewInferenceConfig() *InferenceConfigBuilder {
...
// Classification set the Classification property for InferenceConfigBuilder.
func (rb *InferenceConfigBuilder) Classification(classification InferenceConfigClassification) *InferenceConfigBuilder {
	rb.v.Classification = &classification
	return rb
}

// Regression set the Regression property for InferenceConfigBuilder.
func (rb *InferenceConfigBuilder) Regression(regression InferenceConfigRegression) *InferenceConfigBuilder {
