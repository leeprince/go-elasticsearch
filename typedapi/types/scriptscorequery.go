...
// Boost set the Boost property for ScriptScoreQueryBuilder.
func (rb *ScriptScoreQueryBuilder) Boost(boost float32) *ScriptScoreQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// MinScore set the MinScore property for ScriptScoreQueryBuilder.
func (rb *ScriptScoreQueryBuilder) MinScore(minscore float32) *ScriptScoreQueryBuilder {
	rb.v.MinScore = &minscore
	return rb
}

// Query set the Query property for ScriptScoreQueryBuilder.
func (rb *ScriptScoreQueryBuilder) Query(query QueryContainer) *ScriptScoreQueryBuilder {
	rb.v.Query = &query
	return rb
}

// QueryName_ set the QueryName_ property for ScriptScoreQueryBuilder.
func (rb *ScriptScoreQueryBuilder) QueryName_(queryname_ string) *ScriptScoreQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// Script set the Script property for ScriptScoreQueryBuilder.
func (rb *ScriptScoreQueryBuilder) Script(script Script) *ScriptScoreQueryBuilder {
	rb.v.Script = script
	return rb
}
