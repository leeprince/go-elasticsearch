...
func NewSlackAction() *SlackActionBuilder {
...
// Account set the Account property for SlackActionBuilder.
func (rb *SlackActionBuilder) Account(account string) *SlackActionBuilder {
	rb.v.Account = &account
	return rb
}

// Message set the Message property for SlackActionBuilder.
func (rb *SlackActionBuilder) Message(message SlackMessage) *SlackActionBuilder {
