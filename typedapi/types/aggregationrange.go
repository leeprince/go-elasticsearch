...
func NewAggregationRange() *AggregationRangeBuilder {
...
// From set the From property for AggregationRangeBuilder.
func (rb *AggregationRangeBuilder) From(arg string) *AggregationRangeBuilder {
	rb.v.From = arg
	return rb
}

// Key set the Key property for AggregationRangeBuilder.
func (rb *AggregationRangeBuilder) Key(key string) *AggregationRangeBuilder {
	rb.v.Key = &key
	return rb
}

// To set the To property for AggregationRangeBuilder.
