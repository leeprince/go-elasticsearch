...
func NewSlackDynamicAttachment() *SlackDynamicAttachmentBuilder {
...
// AttachmentTemplate set the AttachmentTemplate property for SlackDynamicAttachmentBuilder.
func (rb *SlackDynamicAttachmentBuilder) AttachmentTemplate(attachmenttemplate SlackAttachment) *SlackDynamicAttachmentBuilder {
	rb.v.AttachmentTemplate = attachmenttemplate
	return rb
}

// ListPath set the ListPath property for SlackDynamicAttachmentBuilder.
