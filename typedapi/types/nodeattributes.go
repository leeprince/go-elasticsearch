...
func NewNodeAttributes() *NodeAttributesBuilder {
...
// Roles set the Roles property for NodeAttributesBuilder.
func (rb *NodeAttributesBuilder) Roles(roles NodeRoles) *NodeAttributesBuilder {
	rb.v.Roles = &roles
	return rb
}
