...
func NewResponseBase() *ResponseBaseBuilder {
...
// ClusterName set the ClusterName property for ResponseBaseBuilder.
...
// NodeStats Contains statistics about the number of nodes selected by the request’s node
// filters.
func (rb *ResponseBaseBuilder) NodeStats(nodestats NodeStatistics) *ResponseBaseBuilder {
	rb.v.NodeStats = &nodestats
	return rb
}

// Nodes set the Nodes property for ResponseBaseBuilder.
func (rb *ResponseBaseBuilder) Nodes(value map[string]NodeUsage) *ResponseBaseBuilder {
	rb.v.Nodes = value
	return rb
}
