...
func NewParentAggregate() *ParentAggregateBuilder {
...
// Aggregations set the Aggregations property for ParentAggregateBuilder.
func (rb *ParentAggregateBuilder) Aggregations(value map[AggregateName]Aggregate) *ParentAggregateBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for ParentAggregateBuilder.
func (rb *ParentAggregateBuilder) DocCount(doccount int64) *ParentAggregateBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Meta set the Meta property for ParentAggregateBuilder.
func (rb *ParentAggregateBuilder) Meta(meta Metadata) *ParentAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
