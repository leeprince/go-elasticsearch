...
func NewIcuTransformTokenFilter() *IcuTransformTokenFilterBuilder {
...
// Dir set the Dir property for IcuTransformTokenFilterBuilder.
...
// Id set the Id property for IcuTransformTokenFilterBuilder.
func (rb *IcuTransformTokenFilterBuilder) Id(id string) *IcuTransformTokenFilterBuilder {
	rb.v.Id = id
	return rb
}

// Type set the Type property for IcuTransformTokenFilterBuilder.

// Version set the Version property for IcuTransformTokenFilterBuilder.
