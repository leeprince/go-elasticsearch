...
func NewExistsQuery() *ExistsQueryBuilder {
...
// Boost set the Boost property for ExistsQueryBuilder.
func (rb *ExistsQueryBuilder) Boost(boost float32) *ExistsQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Field set the Field property for ExistsQueryBuilder.
func (rb *ExistsQueryBuilder) Field(field Field) *ExistsQueryBuilder {
	rb.v.Field = field
	return rb
}

// QueryName_ set the QueryName_ property for ExistsQueryBuilder.
