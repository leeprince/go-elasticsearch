...
func NewStringRareTermsAggregate() *StringRareTermsAggregateBuilder {
...
// Buckets set the Buckets property for StringRareTermsAggregateBuilder.
func (rb *StringRareTermsAggregateBuilder) Buckets(buckets BucketsStringRareTermsBucket) *StringRareTermsAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for StringRareTermsAggregateBuilder.
func (rb *StringRareTermsAggregateBuilder) Meta(meta Metadata) *StringRareTermsAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
