...
func NewMultiBucketAggregateBaseFiltersBucket() *MultiBucketAggregateBaseFiltersBucketBuilder {
...
// Buckets set the Buckets property for MultiBucketAggregateBaseFiltersBucketBuilder.
func (rb *MultiBucketAggregateBaseFiltersBucketBuilder) Buckets(buckets BucketsFiltersBucket) *MultiBucketAggregateBaseFiltersBucketBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for MultiBucketAggregateBaseFiltersBucketBuilder.
func (rb *MultiBucketAggregateBaseFiltersBucketBuilder) Meta(meta Metadata) *MultiBucketAggregateBaseFiltersBucketBuilder {
	rb.v.Meta = &meta
	return rb
}
