...
func NewReloadDetails() *ReloadDetailsBuilder {
...
// Index set the Index property for ReloadDetailsBuilder.
func (rb *ReloadDetailsBuilder) Index(index string) *ReloadDetailsBuilder {
	rb.v.Index = index
	return rb
}

// ReloadedAnalyzers set the ReloadedAnalyzers property for ReloadDetailsBuilder.
func (rb *ReloadDetailsBuilder) ReloadedAnalyzers(reloaded_analyzers ...string) *ReloadDetailsBuilder {
	rb.v.ReloadedAnalyzers = append(rb.v.ReloadedAnalyzers, reloaded_analyzers...)
	return rb
}

// ReloadedNodeIds set the ReloadedNodeIds property for ReloadDetailsBuilder.
func (rb *ReloadDetailsBuilder) ReloadedNodeIds(reloaded_node_ids ...string) *ReloadDetailsBuilder {
	rb.v.ReloadedNodeIds = append(rb.v.ReloadedNodeIds, reloaded_node_ids...)
	return rb
}
