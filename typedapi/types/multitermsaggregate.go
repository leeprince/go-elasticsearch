...
func NewMultiTermsAggregate() *MultiTermsAggregateBuilder {
...
// Buckets set the Buckets property for MultiTermsAggregateBuilder.
func (rb *MultiTermsAggregateBuilder) Buckets(buckets BucketsMultiTermsBucket) *MultiTermsAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// DocCountErrorUpperBound set the DocCountErrorUpperBound property for MultiTermsAggregateBuilder.
...
// Meta set the Meta property for MultiTermsAggregateBuilder.
func (rb *MultiTermsAggregateBuilder) Meta(meta Metadata) *MultiTermsAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// SumOtherDocCount set the SumOtherDocCount property for MultiTermsAggregateBuilder.
