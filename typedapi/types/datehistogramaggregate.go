...
func NewDateHistogramAggregate() *DateHistogramAggregateBuilder {
...
// Buckets set the Buckets property for DateHistogramAggregateBuilder.
func (rb *DateHistogramAggregateBuilder) Buckets(buckets BucketsDateHistogramBucket) *DateHistogramAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for DateHistogramAggregateBuilder.
func (rb *DateHistogramAggregateBuilder) Meta(meta Metadata) *DateHistogramAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
