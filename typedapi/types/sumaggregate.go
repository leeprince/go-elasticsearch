...
func NewSumAggregate() *SumAggregateBuilder {
...
// Meta set the Meta property for SumAggregateBuilder.
func (rb *SumAggregateBuilder) Meta(meta Metadata) *SumAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for SumAggregateBuilder.
