...
func NewBucketsStringRareTermsBucket() *BucketsStringRareTermsBucketBuilder {
...
// Map set the Map property for BucketsStringRareTermsBucketBuilder.
func (u *BucketsStringRareTermsBucketBuilder) Map(v map[string]StringRareTermsBucket) *BucketsStringRareTermsBucketBuilder {
	u.v = v
	return u
}

// StringRareTermsBuckets set the StringRareTermsBuckets property for BucketsStringRareTermsBucketBuilder.
func (u *BucketsStringRareTermsBucketBuilder) StringRareTermsBuckets(v []StringRareTermsBucket) *BucketsStringRareTermsBucketBuilder {
	u.v = v
	return u
}
