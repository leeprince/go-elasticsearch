...
func NewIndexRoutingAllocationInclude() *IndexRoutingAllocationIncludeBuilder {
...
// Id_ set the Id_ property for IndexRoutingAllocationIncludeBuilder.
func (rb *IndexRoutingAllocationIncludeBuilder) Id_(id_ Id) *IndexRoutingAllocationIncludeBuilder {
	rb.v.Id_ = &id_
	return rb
}

// TierPreference_ set the TierPreference_ property for IndexRoutingAllocationIncludeBuilder.
