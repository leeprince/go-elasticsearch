...
// Meta set the Meta property for AggregationBuilder.
func (rb *AggregationBuilder) Meta(meta Metadata) *AggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for AggregationBuilder.
