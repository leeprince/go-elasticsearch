...
func NewLowercaseTokenFilter() *LowercaseTokenFilterBuilder {
...
// Language set the Language property for LowercaseTokenFilterBuilder.
func (rb *LowercaseTokenFilterBuilder) Language(language string) *LowercaseTokenFilterBuilder {
	rb.v.Language = &language
	return rb
}

// Type set the Type property for LowercaseTokenFilterBuilder.

// Version set the Version property for LowercaseTokenFilterBuilder.
