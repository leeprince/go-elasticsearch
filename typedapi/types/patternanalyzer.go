...
func NewPatternAnalyzer() *PatternAnalyzerBuilder {
...
// Flags set the Flags property for PatternAnalyzerBuilder.
func (rb *PatternAnalyzerBuilder) Flags(flags string) *PatternAnalyzerBuilder {
	rb.v.Flags = &flags
	return rb
}

// Lowercase set the Lowercase property for PatternAnalyzerBuilder.
func (rb *PatternAnalyzerBuilder) Lowercase(lowercase bool) *PatternAnalyzerBuilder {
	rb.v.Lowercase = &lowercase
	return rb
}

// Pattern set the Pattern property for PatternAnalyzerBuilder.
func (rb *PatternAnalyzerBuilder) Pattern(pattern string) *PatternAnalyzerBuilder {
	rb.v.Pattern = pattern
	return rb
}

// Stopwords set the Stopwords property for PatternAnalyzerBuilder.
func (rb *PatternAnalyzerBuilder) Stopwords(stopwords StopWords) *PatternAnalyzerBuilder {
	rb.v.Stopwords = &stopwords
	return rb
}

// Type set the Type property for PatternAnalyzerBuilder.

// Version set the Version property for PatternAnalyzerBuilder.
