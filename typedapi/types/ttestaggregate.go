...
func NewTTestAggregate() *TTestAggregateBuilder {
...
// Meta set the Meta property for TTestAggregateBuilder.
func (rb *TTestAggregateBuilder) Meta(meta Metadata) *TTestAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Value set the Value property for TTestAggregateBuilder.
func (rb *TTestAggregateBuilder) Value(value float64) *TTestAggregateBuilder {
	rb.v.Value = value
	return rb
}

// ValueAsString set the ValueAsString property for TTestAggregateBuilder.
