...
func NewModelSnapshotUpgrade() *ModelSnapshotUpgradeBuilder {
...
// AssignmentExplanation set the AssignmentExplanation property for ModelSnapshotUpgradeBuilder.
...
// JobId set the JobId property for ModelSnapshotUpgradeBuilder.
func (rb *ModelSnapshotUpgradeBuilder) JobId(jobid Id) *ModelSnapshotUpgradeBuilder {
	rb.v.JobId = jobid
	return rb
}

// Node set the Node property for ModelSnapshotUpgradeBuilder.
func (rb *ModelSnapshotUpgradeBuilder) Node(node DiscoveryNode) *ModelSnapshotUpgradeBuilder {
	rb.v.Node = node
	return rb
}

// SnapshotId set the SnapshotId property for ModelSnapshotUpgradeBuilder.
func (rb *ModelSnapshotUpgradeBuilder) SnapshotId(snapshotid Id) *ModelSnapshotUpgradeBuilder {
	rb.v.SnapshotId = snapshotid
	return rb
}

// State set the State property for ModelSnapshotUpgradeBuilder.
