...
func NewInferenceClassImportance() *InferenceClassImportanceBuilder {
...
// ClassName set the ClassName property for InferenceClassImportanceBuilder.
...
// Importance set the Importance property for InferenceClassImportanceBuilder.
