...
func NewRecoveryStatus() *RecoveryStatusBuilder {
...
// Shards set the Shards property for RecoveryStatusBuilder.
func (rb *RecoveryStatusBuilder) Shards(shards ...ShardRecovery) *RecoveryStatusBuilder {
