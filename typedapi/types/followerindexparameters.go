...
func NewFollowerIndexParameters() *FollowerIndexParametersBuilder {
...
// MaxOutstandingReadRequests set the MaxOutstandingReadRequests property for FollowerIndexParametersBuilder.
...
// MaxOutstandingWriteRequests set the MaxOutstandingWriteRequests property for FollowerIndexParametersBuilder.
...
// MaxReadRequestOperationCount set the MaxReadRequestOperationCount property for FollowerIndexParametersBuilder.
...
// MaxReadRequestSize set the MaxReadRequestSize property for FollowerIndexParametersBuilder.
...
// MaxRetryDelay set the MaxRetryDelay property for FollowerIndexParametersBuilder.
func (rb *FollowerIndexParametersBuilder) MaxRetryDelay(maxretrydelay Time) *FollowerIndexParametersBuilder {
	rb.v.MaxRetryDelay = maxretrydelay
	return rb
}

// MaxWriteBufferCount set the MaxWriteBufferCount property for FollowerIndexParametersBuilder.
...
// MaxWriteBufferSize set the MaxWriteBufferSize property for FollowerIndexParametersBuilder.
...
// MaxWriteRequestOperationCount set the MaxWriteRequestOperationCount property for FollowerIndexParametersBuilder.
...
// MaxWriteRequestSize set the MaxWriteRequestSize property for FollowerIndexParametersBuilder.
...
// ReadPollTimeout set the ReadPollTimeout property for FollowerIndexParametersBuilder.
func (rb *FollowerIndexParametersBuilder) ReadPollTimeout(readpolltimeout Time) *FollowerIndexParametersBuilder {
	rb.v.ReadPollTimeout = readpolltimeout
	return rb
}
