...
func NewScheduleTriggerEvent() *ScheduleTriggerEventBuilder {
...
// ScheduledTime set the ScheduledTime property for ScheduleTriggerEventBuilder.
...
// TriggeredTime set the TriggeredTime property for ScheduleTriggerEventBuilder.
