...
func NewZeroShotClassificationInferenceUpdateOptions() *ZeroShotClassificationInferenceUpdateOptionsBuilder {
...
func (rb *ZeroShotClassificationInferenceUpdateOptionsBuilder) Labels(labels ...string) *ZeroShotClassificationInferenceUpdateOptionsBuilder {
	rb.v.Labels = append(rb.v.Labels, labels...)
	return rb
}
...
// Tokenization The tokenization options to update when inferring
func (rb *ZeroShotClassificationInferenceUpdateOptionsBuilder) Tokenization(tokenization NlpTokenizationUpdateOptions) *ZeroShotClassificationInferenceUpdateOptionsBuilder {
