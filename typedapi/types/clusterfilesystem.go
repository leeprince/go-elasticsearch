...
func NewClusterFileSystem() *ClusterFileSystemBuilder {
...
// AvailableInBytes set the AvailableInBytes property for ClusterFileSystemBuilder.
...
// FreeInBytes set the FreeInBytes property for ClusterFileSystemBuilder.
func (rb *ClusterFileSystemBuilder) FreeInBytes(freeinbytes int64) *ClusterFileSystemBuilder {
	rb.v.FreeInBytes = freeinbytes
	return rb
}

// TotalInBytes set the TotalInBytes property for ClusterFileSystemBuilder.
