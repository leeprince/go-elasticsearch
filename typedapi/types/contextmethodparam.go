...
func NewContextMethodParam() *ContextMethodParamBuilder {
...
// Name set the Name property for ContextMethodParamBuilder.
func (rb *ContextMethodParamBuilder) Name(name Name) *ContextMethodParamBuilder {
	rb.v.Name = name
	return rb
}

// Type set the Type property for ContextMethodParamBuilder.
