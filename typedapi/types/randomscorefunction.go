...
func NewRandomScoreFunction() *RandomScoreFunctionBuilder {
...
// Field set the Field property for RandomScoreFunctionBuilder.
func (rb *RandomScoreFunctionBuilder) Field(field Field) *RandomScoreFunctionBuilder {
	rb.v.Field = &field
	return rb
}

// Seed set the Seed property for RandomScoreFunctionBuilder.
