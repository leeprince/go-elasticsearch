...
func NewAggregateBase() *AggregateBaseBuilder {
...
// Meta set the Meta property for AggregateBaseBuilder.
func (rb *AggregateBaseBuilder) Meta(meta Metadata) *AggregateBaseBuilder {
	rb.v.Meta = &meta
	return rb
}
