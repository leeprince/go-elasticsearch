...
func NewNodeInfoXpackLicense() *NodeInfoXpackLicenseBuilder {
...
// SelfGenerated set the SelfGenerated property for NodeInfoXpackLicenseBuilder.
func (rb *NodeInfoXpackLicenseBuilder) SelfGenerated(selfgenerated NodeInfoXpackLicenseType) *NodeInfoXpackLicenseBuilder {
	rb.v.SelfGenerated = selfgenerated
	return rb
}
