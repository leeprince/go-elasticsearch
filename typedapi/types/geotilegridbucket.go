...
func NewGeoTileGridBucket() *GeoTileGridBucketBuilder {
...
// Aggregations set the Aggregations property for GeoTileGridBucketBuilder.
func (rb *GeoTileGridBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *GeoTileGridBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for GeoTileGridBucketBuilder.
func (rb *GeoTileGridBucketBuilder) DocCount(doccount int64) *GeoTileGridBucketBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Key set the Key property for GeoTileGridBucketBuilder.
