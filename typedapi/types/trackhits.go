...
func NewTrackHits() *TrackHitsBuilder {
...
// Bool set the Bool property for TrackHitsBuilder.
func (u *TrackHitsBuilder) Bool(v bool) *TrackHitsBuilder {
	u.v = v
	return u
}

// Int set the Int property for TrackHitsBuilder.
func (u *TrackHitsBuilder) Int(v int) *TrackHitsBuilder {
	u.v = v
	return u
}
