...
func NewEdgeNGramTokenizer() *EdgeNGramTokenizerBuilder {
...
// CustomTokenChars set the CustomTokenChars property for EdgeNGramTokenizerBuilder.
...
// MaxGram set the MaxGram property for EdgeNGramTokenizerBuilder.
func (rb *EdgeNGramTokenizerBuilder) MaxGram(maxgram int) *EdgeNGramTokenizerBuilder {
	rb.v.MaxGram = maxgram
	return rb
}

// MinGram set the MinGram property for EdgeNGramTokenizerBuilder.
func (rb *EdgeNGramTokenizerBuilder) MinGram(mingram int) *EdgeNGramTokenizerBuilder {
	rb.v.MinGram = mingram
	return rb
}

// TokenChars set the TokenChars property for EdgeNGramTokenizerBuilder.
func (rb *EdgeNGramTokenizerBuilder) TokenChars(token_chars ...tokenchar.TokenChar) *EdgeNGramTokenizerBuilder {
	rb.v.TokenChars = append(rb.v.TokenChars, token_chars...)
	return rb
}

// Type set the Type property for EdgeNGramTokenizerBuilder.

// Version set the Version property for EdgeNGramTokenizerBuilder.
