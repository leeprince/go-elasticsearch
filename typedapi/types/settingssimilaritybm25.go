...
func NewSettingsSimilarityBm25() *SettingsSimilarityBm25Builder {
...
// B set the B property for SettingsSimilarityBm25Builder.
func (rb *SettingsSimilarityBm25Builder) B(b int) *SettingsSimilarityBm25Builder {
	rb.v.B = b
	return rb
}

// DiscountOverlaps set the DiscountOverlaps property for SettingsSimilarityBm25Builder.
...
// K1 set the K1 property for SettingsSimilarityBm25Builder.
func (rb *SettingsSimilarityBm25Builder) K1(k1 float64) *SettingsSimilarityBm25Builder {
	rb.v.K1 = k1
	return rb
}

// Type set the Type property for SettingsSimilarityBm25Builder.
