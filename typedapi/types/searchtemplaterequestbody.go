...
func NewSearchTemplateRequestBody() *SearchTemplateRequestBodyBuilder {
...
// Explain set the Explain property for SearchTemplateRequestBodyBuilder.
...
// Params set the Params property for SearchTemplateRequestBodyBuilder.
func (rb *SearchTemplateRequestBodyBuilder) Params(value map[string]interface{}) *SearchTemplateRequestBodyBuilder {
	rb.v.Params = value
	return rb
}

// Profile set the Profile property for SearchTemplateRequestBodyBuilder.
