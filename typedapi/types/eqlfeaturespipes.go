...
func NewEqlFeaturesPipes() *EqlFeaturesPipesBuilder {
...
// PipeHead set the PipeHead property for EqlFeaturesPipesBuilder.
func (rb *EqlFeaturesPipesBuilder) PipeHead(pipehead uint) *EqlFeaturesPipesBuilder {
	rb.v.PipeHead = pipehead
	return rb
}

// PipeTail set the PipeTail property for EqlFeaturesPipesBuilder.
