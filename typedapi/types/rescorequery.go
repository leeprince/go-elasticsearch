...
func NewRescoreQuery() *RescoreQueryBuilder {
...
// Query set the Query property for RescoreQueryBuilder.
func (rb *RescoreQueryBuilder) Query(query QueryContainer) *RescoreQueryBuilder {
	rb.v.Query = query
	return rb
}

// QueryWeight set the QueryWeight property for RescoreQueryBuilder.
func (rb *RescoreQueryBuilder) QueryWeight(queryweight float64) *RescoreQueryBuilder {
	rb.v.QueryWeight = &queryweight
	return rb
}

// RescoreQueryWeight set the RescoreQueryWeight property for RescoreQueryBuilder.
...
// ScoreMode set the ScoreMode property for RescoreQueryBuilder.
