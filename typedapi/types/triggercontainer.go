...
func NewTriggerContainer() *TriggerContainerBuilder {
...
// Schedule set the Schedule property for TriggerContainerBuilder.
func (rb *TriggerContainerBuilder) Schedule(schedule ScheduleContainer) *TriggerContainerBuilder {
