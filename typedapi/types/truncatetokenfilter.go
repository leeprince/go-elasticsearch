...
func NewTruncateTokenFilter() *TruncateTokenFilterBuilder {
...
// Length set the Length property for TruncateTokenFilterBuilder.
func (rb *TruncateTokenFilterBuilder) Length(length int) *TruncateTokenFilterBuilder {
	rb.v.Length = length
	return rb
}

// Type set the Type property for TruncateTokenFilterBuilder.

// Version set the Version property for TruncateTokenFilterBuilder.
