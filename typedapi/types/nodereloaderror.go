...
func NewNodeReloadError() *NodeReloadErrorBuilder {
...
// Name set the Name property for NodeReloadErrorBuilder.
func (rb *NodeReloadErrorBuilder) Name(name Name) *NodeReloadErrorBuilder {
	rb.v.Name = name
	return rb
}

// ReloadException set the ReloadException property for NodeReloadErrorBuilder.
func (rb *NodeReloadErrorBuilder) ReloadException(reloadexception ErrorCause) *NodeReloadErrorBuilder {
	rb.v.ReloadException = &reloadexception
	return rb
}
