...
func NewCommandAllocatePrimaryAction() *CommandAllocatePrimaryActionBuilder {
...
// Index set the Index property for CommandAllocatePrimaryActionBuilder.
func (rb *CommandAllocatePrimaryActionBuilder) Index(index IndexName) *CommandAllocatePrimaryActionBuilder {
	rb.v.Index = index
	return rb
}

// Node set the Node property for CommandAllocatePrimaryActionBuilder.
func (rb *CommandAllocatePrimaryActionBuilder) Node(node string) *CommandAllocatePrimaryActionBuilder {
	rb.v.Node = node
	return rb
}

// Shard set the Shard property for CommandAllocatePrimaryActionBuilder.
