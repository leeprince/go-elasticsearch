...
func NewFollowStats() *FollowStatsBuilder {
...
// Indices set the Indices property for FollowStatsBuilder.
func (rb *FollowStatsBuilder) Indices(indices ...FollowIndexStats) *FollowStatsBuilder {
