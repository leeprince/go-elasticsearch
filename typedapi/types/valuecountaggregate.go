...
func NewValueCountAggregate() *ValueCountAggregateBuilder {
...
// Meta set the Meta property for ValueCountAggregateBuilder.
func (rb *ValueCountAggregateBuilder) Meta(meta Metadata) *ValueCountAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for ValueCountAggregateBuilder.
