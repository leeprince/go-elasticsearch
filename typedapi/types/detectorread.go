...
func NewDetectorRead() *DetectorReadBuilder {
...
// a rule may dictate conditions under which results should be skipped. Kibana
// refers to custom rules as job rules.
func (rb *DetectorReadBuilder) CustomRules(custom_rules ...DetectionRule) *DetectorReadBuilder {
	rb.v.CustomRules = append(rb.v.CustomRules, custom_rules...)
	return rb
}
