...
func NewRoleDescriptorWrapper() *RoleDescriptorWrapperBuilder {
...
// RoleDescriptor set the RoleDescriptor property for RoleDescriptorWrapperBuilder.
func (rb *RoleDescriptorWrapperBuilder) RoleDescriptor(roledescriptor RoleDescriptor) *RoleDescriptorWrapperBuilder {
	rb.v.RoleDescriptor = roledescriptor
	return rb
}
