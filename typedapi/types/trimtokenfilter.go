...
func NewTrimTokenFilter() *TrimTokenFilterBuilder {
...
// Type set the Type property for TrimTokenFilterBuilder.

// Version set the Version property for TrimTokenFilterBuilder.
