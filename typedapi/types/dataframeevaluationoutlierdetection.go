...
func NewDataframeEvaluationOutlierDetection() *DataframeEvaluationOutlierDetectionBuilder {
...
// Metrics Specifies the metrics that are used for the evaluation.
func (rb *DataframeEvaluationOutlierDetectionBuilder) Metrics(metrics DataframeEvaluationOutlierDetectionMetrics) *DataframeEvaluationOutlierDetectionBuilder {
