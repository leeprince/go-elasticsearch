...
func NewStemmerTokenFilter() *StemmerTokenFilterBuilder {
...
// Language set the Language property for StemmerTokenFilterBuilder.
func (rb *StemmerTokenFilterBuilder) Language(language string) *StemmerTokenFilterBuilder {
	rb.v.Language = language
	return rb
}

// Type set the Type property for StemmerTokenFilterBuilder.

// Version set the Version property for StemmerTokenFilterBuilder.
