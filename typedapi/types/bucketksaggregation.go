...
func NewBucketKsAggregation() *BucketKsAggregationBuilder {
...
func (rb *BucketKsAggregationBuilder) Alternative(alternative ...string) *BucketKsAggregationBuilder {
	rb.v.Alternative = append(rb.v.Alternative, alternative...)
	return rb
}

// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *BucketKsAggregationBuilder) BucketsPath(bucketspath BucketsPath) *BucketKsAggregationBuilder {
...
func (rb *BucketKsAggregationBuilder) Fractions(fractions ...float64) *BucketKsAggregationBuilder {
	rb.v.Fractions = append(rb.v.Fractions, fractions...)
	return rb
}

// Meta set the Meta property for BucketKsAggregationBuilder.
func (rb *BucketKsAggregationBuilder) Meta(meta Metadata) *BucketKsAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for BucketKsAggregationBuilder.
