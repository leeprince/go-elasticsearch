...
func NewTrainedModelDeploymentStats() *TrainedModelDeploymentStatsBuilder {
...
// AllocationStatus The detailed allocation status for the deployment.
func (rb *TrainedModelDeploymentStatsBuilder) AllocationStatus(allocationstatus TrainedModelDeploymentAllocationStatus) *TrainedModelDeploymentStatsBuilder {
...
// Nodes The deployent stats for each node that currently has the model allocated.
func (rb *TrainedModelDeploymentStatsBuilder) Nodes(nodes TrainedModelDeploymentNodesStats) *TrainedModelDeploymentStatsBuilder {
	rb.v.Nodes = nodes
	return rb
}
