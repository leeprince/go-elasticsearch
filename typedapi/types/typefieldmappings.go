...
func NewTypeFieldMappings() *TypeFieldMappingsBuilder {
...
// Mappings set the Mappings property for TypeFieldMappingsBuilder.
func (rb *TypeFieldMappingsBuilder) Mappings(value map[Field]FieldMapping) *TypeFieldMappingsBuilder {
	rb.v.Mappings = value
	return rb
}
