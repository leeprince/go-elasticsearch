...
func NewNodeInfoHttp() *NodeInfoHttpBuilder {
...
// BoundAddress set the BoundAddress property for NodeInfoHttpBuilder.
...
// MaxContentLength set the MaxContentLength property for NodeInfoHttpBuilder.
func (rb *NodeInfoHttpBuilder) MaxContentLength(maxcontentlength ByteSize) *NodeInfoHttpBuilder {
	rb.v.MaxContentLength = &maxcontentlength
	return rb
}

// MaxContentLengthInBytes set the MaxContentLengthInBytes property for NodeInfoHttpBuilder.
...
// PublishAddress set the PublishAddress property for NodeInfoHttpBuilder.
