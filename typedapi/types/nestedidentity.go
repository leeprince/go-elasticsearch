...
func NewNestedIdentity() *NestedIdentityBuilder {
...
// Field set the Field property for NestedIdentityBuilder.
func (rb *NestedIdentityBuilder) Field(field Field) *NestedIdentityBuilder {
	rb.v.Field = field
	return rb
}

// Nested_ set the Nested_ property for NestedIdentityBuilder.
func (rb *NestedIdentityBuilder) Nested_(nested_ NestedIdentity) *NestedIdentityBuilder {
	rb.v.Nested_ = &nested_
	return rb
}

// Offset set the Offset property for NestedIdentityBuilder.
