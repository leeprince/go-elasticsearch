...
func NewIndexAliases() *IndexAliasesBuilder {
...
// Aliases set the Aliases property for IndexAliasesBuilder.
func (rb *IndexAliasesBuilder) Aliases(value map[string]AliasDefinition) *IndexAliasesBuilder {
	rb.v.Aliases = value
	return rb
}
