...
func NewHistogramAggregate() *HistogramAggregateBuilder {
...
// Buckets set the Buckets property for HistogramAggregateBuilder.
func (rb *HistogramAggregateBuilder) Buckets(buckets BucketsHistogramBucket) *HistogramAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for HistogramAggregateBuilder.
func (rb *HistogramAggregateBuilder) Meta(meta Metadata) *HistogramAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
