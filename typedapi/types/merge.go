...
// Scheduler set the Scheduler property for MergeBuilder.
func (rb *MergeBuilder) Scheduler(scheduler MergeScheduler) *MergeBuilder {
	rb.v.Scheduler = &scheduler
	return rb
}
