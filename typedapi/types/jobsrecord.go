...
func NewJobsRecord() *JobsRecordBuilder {
	r := JobsRecordBuilder{
		&JobsRecord{},
	}
...
// DataInputBytes total input bytes
func (rb *JobsRecordBuilder) DataInputBytes(datainputbytes ByteSize) *JobsRecordBuilder {
	rb.v.DataInputBytes = &datainputbytes
	return rb
}
...
// ModelBytes model size
func (rb *JobsRecordBuilder) ModelBytes(modelbytes ByteSize) *JobsRecordBuilder {
	rb.v.ModelBytes = &modelbytes
	return rb
}

// ModelBytesExceeded how much the model has exceeded the limit
func (rb *JobsRecordBuilder) ModelBytesExceeded(modelbytesexceeded ByteSize) *JobsRecordBuilder {
