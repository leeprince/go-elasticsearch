...
func NewSettingsSimilarityLmj() *SettingsSimilarityLmjBuilder {
...
// Lambda set the Lambda property for SettingsSimilarityLmjBuilder.
func (rb *SettingsSimilarityLmjBuilder) Lambda(lambda float64) *SettingsSimilarityLmjBuilder {
	rb.v.Lambda = lambda
	return rb
}

// Type set the Type property for SettingsSimilarityLmjBuilder.
