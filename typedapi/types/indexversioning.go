...
func NewIndexVersioning() *IndexVersioningBuilder {
...
// Created set the Created property for IndexVersioningBuilder.
func (rb *IndexVersioningBuilder) Created(created VersionString) *IndexVersioningBuilder {
	rb.v.Created = created
	return rb
}

// CreatedString set the CreatedString property for IndexVersioningBuilder.
