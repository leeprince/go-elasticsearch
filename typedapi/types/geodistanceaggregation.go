...
func NewGeoDistanceAggregation() *GeoDistanceAggregationBuilder {
...
// DistanceType set the DistanceType property for GeoDistanceAggregationBuilder.
...
// Field set the Field property for GeoDistanceAggregationBuilder.
func (rb *GeoDistanceAggregationBuilder) Field(field Field) *GeoDistanceAggregationBuilder {
	rb.v.Field = &field
	return rb
}

// Meta set the Meta property for GeoDistanceAggregationBuilder.
func (rb *GeoDistanceAggregationBuilder) Meta(meta Metadata) *GeoDistanceAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for GeoDistanceAggregationBuilder.
func (rb *GeoDistanceAggregationBuilder) Name(name string) *GeoDistanceAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Origin set the Origin property for GeoDistanceAggregationBuilder.
func (rb *GeoDistanceAggregationBuilder) Origin(origin GeoLocation) *GeoDistanceAggregationBuilder {
	rb.v.Origin = &origin
	return rb
}

// Ranges set the Ranges property for GeoDistanceAggregationBuilder.
func (rb *GeoDistanceAggregationBuilder) Ranges(ranges ...AggregationRange) *GeoDistanceAggregationBuilder {
	rb.v.Ranges = append(rb.v.Ranges, ranges...)
	return rb
}

// Unit set the Unit property for GeoDistanceAggregationBuilder.
