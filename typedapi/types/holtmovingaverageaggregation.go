...
func NewHoltMovingAverageAggregation() *HoltMovingAverageAggregationBuilder {
...
// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *HoltMovingAverageAggregationBuilder) BucketsPath(bucketspath BucketsPath) *HoltMovingAverageAggregationBuilder {
	rb.v.BucketsPath = &bucketspath
	return rb
}

// Format set the Format property for HoltMovingAverageAggregationBuilder.
func (rb *HoltMovingAverageAggregationBuilder) Format(format string) *HoltMovingAverageAggregationBuilder {
	rb.v.Format = &format
	return rb
}

// GapPolicy set the GapPolicy property for HoltMovingAverageAggregationBuilder.
...
// Meta set the Meta property for HoltMovingAverageAggregationBuilder.
func (rb *HoltMovingAverageAggregationBuilder) Meta(meta Metadata) *HoltMovingAverageAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Minimize set the Minimize property for HoltMovingAverageAggregationBuilder.
...
// Model set the Model property for HoltMovingAverageAggregationBuilder.

// Name set the Name property for HoltMovingAverageAggregationBuilder.
func (rb *HoltMovingAverageAggregationBuilder) Name(name string) *HoltMovingAverageAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Predict set the Predict property for HoltMovingAverageAggregationBuilder.
func (rb *HoltMovingAverageAggregationBuilder) Predict(predict int) *HoltMovingAverageAggregationBuilder {
	rb.v.Predict = &predict
	return rb
}

// Settings set the Settings property for HoltMovingAverageAggregationBuilder.
func (rb *HoltMovingAverageAggregationBuilder) Settings(settings HoltLinearModelSettings) *HoltMovingAverageAggregationBuilder {
	rb.v.Settings = settings
	return rb
}

// Window set the Window property for HoltMovingAverageAggregationBuilder.
