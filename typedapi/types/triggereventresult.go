...
func NewTriggerEventResult() *TriggerEventResultBuilder {
...
// Manual set the Manual property for TriggerEventResultBuilder.
func (rb *TriggerEventResultBuilder) Manual(manual TriggerEventContainer) *TriggerEventResultBuilder {
	rb.v.Manual = manual
	return rb
}

// TriggeredTime set the TriggeredTime property for TriggerEventResultBuilder.
...
// Type set the Type property for TriggerEventResultBuilder.
