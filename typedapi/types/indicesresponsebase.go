...
func NewIndicesResponseBase() *IndicesResponseBaseBuilder {
...
// Shards_ set the Shards_ property for IndicesResponseBaseBuilder.
func (rb *IndicesResponseBaseBuilder) Shards_(shards_ ShardStatistics) *IndicesResponseBaseBuilder {
