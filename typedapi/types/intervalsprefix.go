...
func NewIntervalsPrefix() *IntervalsPrefixBuilder {
...
// Analyzer set the Analyzer property for IntervalsPrefixBuilder.
func (rb *IntervalsPrefixBuilder) Analyzer(analyzer string) *IntervalsPrefixBuilder {
	rb.v.Analyzer = &analyzer
	return rb
}

// Prefix set the Prefix property for IntervalsPrefixBuilder.
func (rb *IntervalsPrefixBuilder) Prefix(prefix string) *IntervalsPrefixBuilder {
	rb.v.Prefix = prefix
	return rb
}

// UseField set the UseField property for IntervalsPrefixBuilder.
