...
// BoundaryScannerLocale set the BoundaryScannerLocale property for HighlightBuilder.
...
// Encoder set the Encoder property for HighlightBuilder.
func (rb *HighlightBuilder) Encoder(encoder highlighterencoder.HighlighterEncoder) *HighlightBuilder {
	rb.v.Encoder = &encoder
	return rb
}

// Fields set the Fields property for HighlightBuilder.
func (rb *HighlightBuilder) Fields(value map[Field]HighlightField) *HighlightBuilder {
	rb.v.Fields = value
	return rb
}

// ForceSource set the ForceSource property for HighlightBuilder.
func (rb *HighlightBuilder) ForceSource(forcesource bool) *HighlightBuilder {
	rb.v.ForceSource = &forcesource
	return rb
}

// FragmentSize set the FragmentSize property for HighlightBuilder.
func (rb *HighlightBuilder) FragmentSize(fragmentsize int) *HighlightBuilder {
	rb.v.FragmentSize = &fragmentsize
	return rb
}

// Fragmenter set the Fragmenter property for HighlightBuilder.
...
// HighlightFilter set the HighlightFilter property for HighlightBuilder.
func (rb *HighlightBuilder) HighlightFilter(highlightfilter bool) *HighlightBuilder {
	rb.v.HighlightFilter = &highlightfilter
	return rb
}

// HighlightQuery set the HighlightQuery property for HighlightBuilder.
func (rb *HighlightBuilder) HighlightQuery(highlightquery QueryContainer) *HighlightBuilder {
	rb.v.HighlightQuery = &highlightquery
	return rb
}

// MaxAnalyzedOffset set the MaxAnalyzedOffset property for HighlightBuilder.
...
// MaxFragmentLength set the MaxFragmentLength property for HighlightBuilder.
...
// NoMatchSize set the NoMatchSize property for HighlightBuilder.
func (rb *HighlightBuilder) NoMatchSize(nomatchsize int) *HighlightBuilder {
	rb.v.NoMatchSize = &nomatchsize
	return rb
}

// NumberOfFragments set the NumberOfFragments property for HighlightBuilder.
...
// TagsSchema set the TagsSchema property for HighlightBuilder.
...
// Type set the Type property for HighlightBuilder.
