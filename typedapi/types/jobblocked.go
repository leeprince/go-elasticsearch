...
func NewJobBlocked() *JobBlockedBuilder {
	r := JobBlockedBuilder{
		&JobBlocked{},
	}
...
// Reason set the Reason property for JobBlockedBuilder.
func (rb *JobBlockedBuilder) Reason(reason jobblockedreason.JobBlockedReason) *JobBlockedBuilder {
	rb.v.Reason = reason
	return rb
}

// TaskId set the TaskId property for JobBlockedBuilder.
func (rb *JobBlockedBuilder) TaskId(taskid TaskId) *JobBlockedBuilder {
	rb.v.TaskId = &taskid
	return rb
}
