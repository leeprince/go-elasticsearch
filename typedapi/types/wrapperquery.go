...
func NewWrapperQuery() *WrapperQueryBuilder {
...
// Boost set the Boost property for WrapperQueryBuilder.
...
// QueryName_ set the QueryName_ property for WrapperQueryBuilder.
