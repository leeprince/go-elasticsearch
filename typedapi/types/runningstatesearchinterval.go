...
func NewRunningStateSearchInterval() *RunningStateSearchIntervalBuilder {
...
// EndMs set the EndMs property for RunningStateSearchIntervalBuilder.
func (rb *RunningStateSearchIntervalBuilder) EndMs(endms int64) *RunningStateSearchIntervalBuilder {
	rb.v.EndMs = endms
	return rb
}

// StartMs set the StartMs property for RunningStateSearchIntervalBuilder.
