...
func NewClusterRemoteSniffInfo() *ClusterRemoteSniffInfoBuilder {
...
// Connected set the Connected property for ClusterRemoteSniffInfoBuilder.
func (rb *ClusterRemoteSniffInfoBuilder) Connected(connected bool) *ClusterRemoteSniffInfoBuilder {
	rb.v.Connected = connected
	return rb
}

// InitialConnectTimeout set the InitialConnectTimeout property for ClusterRemoteSniffInfoBuilder.
func (rb *ClusterRemoteSniffInfoBuilder) InitialConnectTimeout(initialconnecttimeout Time) *ClusterRemoteSniffInfoBuilder {
	rb.v.InitialConnectTimeout = initialconnecttimeout
	return rb
}

// MaxConnectionsPerCluster set the MaxConnectionsPerCluster property for ClusterRemoteSniffInfoBuilder.
...
// Mode set the Mode property for ClusterRemoteSniffInfoBuilder.

// NumNodesConnected set the NumNodesConnected property for ClusterRemoteSniffInfoBuilder.
...
// Seeds set the Seeds property for ClusterRemoteSniffInfoBuilder.
func (rb *ClusterRemoteSniffInfoBuilder) Seeds(seeds ...string) *ClusterRemoteSniffInfoBuilder {
	rb.v.Seeds = append(rb.v.Seeds, seeds...)
	return rb
}

// SkipUnavailable set the SkipUnavailable property for ClusterRemoteSniffInfoBuilder.
