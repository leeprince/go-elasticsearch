...
func NewFieldSizeUsage() *FieldSizeUsageBuilder {
...
// Size set the Size property for FieldSizeUsageBuilder.
func (rb *FieldSizeUsageBuilder) Size(size ByteSize) *FieldSizeUsageBuilder {
	rb.v.Size = &size
	return rb
}

// SizeInBytes set the SizeInBytes property for FieldSizeUsageBuilder.
