...
func NewRateAggregation() *RateAggregationBuilder {
...
// Field set the Field property for RateAggregationBuilder.
func (rb *RateAggregationBuilder) Field(field Field) *RateAggregationBuilder {
	rb.v.Field = &field
	return rb
}

// Format set the Format property for RateAggregationBuilder.
func (rb *RateAggregationBuilder) Format(format string) *RateAggregationBuilder {
	rb.v.Format = &format
	return rb
}

// Missing set the Missing property for RateAggregationBuilder.
func (rb *RateAggregationBuilder) Missing(missing Missing) *RateAggregationBuilder {
	rb.v.Missing = &missing
	return rb
}

// Mode set the Mode property for RateAggregationBuilder.
func (rb *RateAggregationBuilder) Mode(mode ratemode.RateMode) *RateAggregationBuilder {
	rb.v.Mode = &mode
	return rb
}

// Script set the Script property for RateAggregationBuilder.
func (rb *RateAggregationBuilder) Script(script Script) *RateAggregationBuilder {
	rb.v.Script = &script
	return rb
}

// Unit set the Unit property for RateAggregationBuilder.
