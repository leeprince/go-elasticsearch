...
func NewIndexSettingsLifecycle() *IndexSettingsLifecycleBuilder {
...
// Step set the Step property for IndexSettingsLifecycleBuilder.
func (rb *IndexSettingsLifecycleBuilder) Step(step IndexSettingsLifecycleStep) *IndexSettingsLifecycleBuilder {
	rb.v.Step = &step
	return rb
}
