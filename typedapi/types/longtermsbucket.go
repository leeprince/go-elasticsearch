...
func NewLongTermsBucket() *LongTermsBucketBuilder {
...
// Aggregations set the Aggregations property for LongTermsBucketBuilder.
func (rb *LongTermsBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *LongTermsBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for LongTermsBucketBuilder.
func (rb *LongTermsBucketBuilder) DocCount(doccount int64) *LongTermsBucketBuilder {
	rb.v.DocCount = doccount
	return rb
}

// DocCountError set the DocCountError property for LongTermsBucketBuilder.
func (rb *LongTermsBucketBuilder) DocCountError(doccounterror int64) *LongTermsBucketBuilder {
	rb.v.DocCountError = &doccounterror
	return rb
}

// Key set the Key property for LongTermsBucketBuilder.
func (rb *LongTermsBucketBuilder) Key(key int64) *LongTermsBucketBuilder {
	rb.v.Key = key
	return rb
}

// KeyAsString set the KeyAsString property for LongTermsBucketBuilder.
