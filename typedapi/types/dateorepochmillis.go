...
func NewDateOrEpochMillis() *DateOrEpochMillisBuilder {
...
// DateString set the DateString property for DateOrEpochMillisBuilder.
func (u *DateOrEpochMillisBuilder) DateString(v DateString) *DateOrEpochMillisBuilder {
	u.v = v
	return u
}

// EpochMillis set the EpochMillis property for DateOrEpochMillisBuilder.
func (u *DateOrEpochMillisBuilder) EpochMillis(v EpochMillis) *DateOrEpochMillisBuilder {
	u.v = v
	return u
}
