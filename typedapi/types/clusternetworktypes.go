...
func NewClusterNetworkTypes() *ClusterNetworkTypesBuilder {
...
// HttpTypes set the HttpTypes property for ClusterNetworkTypesBuilder.
func (rb *ClusterNetworkTypesBuilder) HttpTypes(value map[string]int) *ClusterNetworkTypesBuilder {
	rb.v.HttpTypes = value
	return rb
}

// TransportTypes set the TransportTypes property for ClusterNetworkTypesBuilder.
