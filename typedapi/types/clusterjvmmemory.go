...
func NewClusterJvmMemory() *ClusterJvmMemoryBuilder {
...
// HeapMaxInBytes set the HeapMaxInBytes property for ClusterJvmMemoryBuilder.
...
// HeapUsedInBytes set the HeapUsedInBytes property for ClusterJvmMemoryBuilder.
