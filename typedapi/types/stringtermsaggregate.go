...
func NewStringTermsAggregate() *StringTermsAggregateBuilder {
...
// Buckets set the Buckets property for StringTermsAggregateBuilder.
func (rb *StringTermsAggregateBuilder) Buckets(buckets BucketsStringTermsBucket) *StringTermsAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// DocCountErrorUpperBound set the DocCountErrorUpperBound property for StringTermsAggregateBuilder.
...
// Meta set the Meta property for StringTermsAggregateBuilder.
func (rb *StringTermsAggregateBuilder) Meta(meta Metadata) *StringTermsAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// SumOtherDocCount set the SumOtherDocCount property for StringTermsAggregateBuilder.
