...
func NewFuzziness() *FuzzinessBuilder {
...
// Int set the Int property for FuzzinessBuilder.
func (u *FuzzinessBuilder) Int(v int) *FuzzinessBuilder {
	u.v = v
	return u
}

// String set the String property for FuzzinessBuilder.
func (u *FuzzinessBuilder) String(v string) *FuzzinessBuilder {
	u.v = v
	return u
}
