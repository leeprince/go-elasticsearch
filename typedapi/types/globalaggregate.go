...
func NewGlobalAggregate() *GlobalAggregateBuilder {
...
// Aggregations set the Aggregations property for GlobalAggregateBuilder.
func (rb *GlobalAggregateBuilder) Aggregations(value map[AggregateName]Aggregate) *GlobalAggregateBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for GlobalAggregateBuilder.
func (rb *GlobalAggregateBuilder) DocCount(doccount int64) *GlobalAggregateBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Meta set the Meta property for GlobalAggregateBuilder.
func (rb *GlobalAggregateBuilder) Meta(meta Metadata) *GlobalAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
