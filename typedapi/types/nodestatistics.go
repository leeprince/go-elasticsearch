...
func NewNodeStatistics() *NodeStatisticsBuilder {
...
// Failures set the Failures property for NodeStatisticsBuilder.
func (rb *NodeStatisticsBuilder) Failures(failures ...ErrorCause) *NodeStatisticsBuilder {
