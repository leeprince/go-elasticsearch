...
func NewFieldMapping() *FieldMappingBuilder {
...
// FullName set the FullName property for FieldMappingBuilder.
func (rb *FieldMappingBuilder) FullName(fullname string) *FieldMappingBuilder {
	rb.v.FullName = fullname
	return rb
}

// Mapping set the Mapping property for FieldMappingBuilder.
func (rb *FieldMappingBuilder) Mapping(value map[Field]Property) *FieldMappingBuilder {
	rb.v.Mapping = value
	return rb
}
