...
func NewTopMetrics() *TopMetricsBuilder {
	r := TopMetricsBuilder{
		&TopMetrics{
...
// Metrics set the Metrics property for TopMetricsBuilder.
...
// Sort set the Sort property for TopMetricsBuilder.
func (rb *TopMetricsBuilder) Sort(sort ...FieldValue) *TopMetricsBuilder {
	rb.v.Sort = append(rb.v.Sort, sort...)
	return rb
}
