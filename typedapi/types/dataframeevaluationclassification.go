...
func NewDataframeEvaluationClassification() *DataframeEvaluationClassificationBuilder {
...
// Metrics Specifies the metrics that are used for the evaluation.
func (rb *DataframeEvaluationClassificationBuilder) Metrics(metrics DataframeEvaluationClassificationMetrics) *DataframeEvaluationClassificationBuilder {
