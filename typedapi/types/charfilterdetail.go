...
func NewCharFilterDetail() *CharFilterDetailBuilder {
...
// FilteredText set the FilteredText property for CharFilterDetailBuilder.
func (rb *CharFilterDetailBuilder) FilteredText(filtered_text ...string) *CharFilterDetailBuilder {
	rb.v.FilteredText = append(rb.v.FilteredText, filtered_text...)
	return rb
}

// Name set the Name property for CharFilterDetailBuilder.
