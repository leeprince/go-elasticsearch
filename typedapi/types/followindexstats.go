...
func NewFollowIndexStats() *FollowIndexStatsBuilder {
...
// Index set the Index property for FollowIndexStatsBuilder.
func (rb *FollowIndexStatsBuilder) Index(index IndexName) *FollowIndexStatsBuilder {
	rb.v.Index = index
	return rb
}

// Shards set the Shards property for FollowIndexStatsBuilder.
func (rb *FollowIndexStatsBuilder) Shards(shards ...ShardStats) *FollowIndexStatsBuilder {
