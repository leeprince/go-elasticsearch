...
func NewCalendarEvent() *CalendarEventBuilder {
...
// EndTime The timestamp for the end of the scheduled event in milliseconds since the
// epoch or ISO 8601 format.
func (rb *CalendarEventBuilder) EndTime(endtime EpochMillis) *CalendarEventBuilder {
	rb.v.EndTime = endtime
	return rb
}

// EventId set the EventId property for CalendarEventBuilder.
...
// StartTime The timestamp for the beginning of the scheduled event in milliseconds since
// the epoch or ISO 8601 format.
func (rb *CalendarEventBuilder) StartTime(starttime EpochMillis) *CalendarEventBuilder {
