...
// Available set the Available property for VectorBuilder.
func (rb *VectorBuilder) Available(available bool) *VectorBuilder {
	rb.v.Available = available
	return rb
}

// DenseVectorDimsAvgCount set the DenseVectorDimsAvgCount property for VectorBuilder.
...
// DenseVectorFieldsCount set the DenseVectorFieldsCount property for VectorBuilder.
...
// Enabled set the Enabled property for VectorBuilder.
func (rb *VectorBuilder) Enabled(enabled bool) *VectorBuilder {
	rb.v.Enabled = enabled
	return rb
}

// SparseVectorFieldsCount set the SparseVectorFieldsCount property for VectorBuilder.
