...
func NewIcuTokenizer() *IcuTokenizerBuilder {
...
// RuleFiles set the RuleFiles property for IcuTokenizerBuilder.
func (rb *IcuTokenizerBuilder) RuleFiles(rulefiles string) *IcuTokenizerBuilder {
	rb.v.RuleFiles = rulefiles
	return rb
}

// Type set the Type property for IcuTokenizerBuilder.

// Version set the Version property for IcuTokenizerBuilder.
