...
func NewUnmappedRareTermsAggregate() *UnmappedRareTermsAggregateBuilder {
...
// Buckets set the Buckets property for UnmappedRareTermsAggregateBuilder.
func (rb *UnmappedRareTermsAggregateBuilder) Buckets(buckets BucketsVoid) *UnmappedRareTermsAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for UnmappedRareTermsAggregateBuilder.
func (rb *UnmappedRareTermsAggregateBuilder) Meta(meta Metadata) *UnmappedRareTermsAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
