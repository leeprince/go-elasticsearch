...
func NewMergeScheduler() *MergeSchedulerBuilder {
...
// MaxMergeCount set the MaxMergeCount property for MergeSchedulerBuilder.
func (rb *MergeSchedulerBuilder) MaxMergeCount(maxmergecount int) *MergeSchedulerBuilder {
	rb.v.MaxMergeCount = &maxmergecount
	return rb
}

// MaxThreadCount set the MaxThreadCount property for MergeSchedulerBuilder.
