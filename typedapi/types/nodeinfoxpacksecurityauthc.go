...
func NewNodeInfoXpackSecurityAuthc() *NodeInfoXpackSecurityAuthcBuilder {
...
// Realms set the Realms property for NodeInfoXpackSecurityAuthcBuilder.
func (rb *NodeInfoXpackSecurityAuthcBuilder) Realms(realms NodeInfoXpackSecurityAuthcRealms) *NodeInfoXpackSecurityAuthcBuilder {
	rb.v.Realms = realms
	return rb
}

// Token set the Token property for NodeInfoXpackSecurityAuthcBuilder.
func (rb *NodeInfoXpackSecurityAuthcBuilder) Token(token NodeInfoXpackSecurityAuthcToken) *NodeInfoXpackSecurityAuthcBuilder {
	rb.v.Token = token
	return rb
}
