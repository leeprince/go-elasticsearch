...
func NewSnapshotRestore() *SnapshotRestoreBuilder {
...
// Indices set the Indices property for SnapshotRestoreBuilder.
func (rb *SnapshotRestoreBuilder) Indices(indices ...IndexName) *SnapshotRestoreBuilder {
	rb.v.Indices = append(rb.v.Indices, indices...)
	return rb
}

// Shards set the Shards property for SnapshotRestoreBuilder.
func (rb *SnapshotRestoreBuilder) Shards(shards ShardStatistics) *SnapshotRestoreBuilder {
	rb.v.Shards = shards
	return rb
}

// Snapshot set the Snapshot property for SnapshotRestoreBuilder.
