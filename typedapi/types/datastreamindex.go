...
func NewDataStreamIndex() *DataStreamIndexBuilder {
...
// IndexName set the IndexName property for DataStreamIndexBuilder.
func (rb *DataStreamIndexBuilder) IndexName(indexname IndexName) *DataStreamIndexBuilder {
	rb.v.IndexName = indexname
	return rb
}

// IndexUuid set the IndexUuid property for DataStreamIndexBuilder.
