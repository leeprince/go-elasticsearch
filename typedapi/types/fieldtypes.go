...
func NewFieldTypes() *FieldTypesBuilder {
	r := FieldTypesBuilder{
		&FieldTypes{},
	}
...
// Count set the Count property for FieldTypesBuilder.
func (rb *FieldTypesBuilder) Count(count int) *FieldTypesBuilder {
	rb.v.Count = count
	return rb
}

// IndexCount set the IndexCount property for FieldTypesBuilder.
func (rb *FieldTypesBuilder) IndexCount(indexcount int) *FieldTypesBuilder {
	rb.v.IndexCount = indexcount
	return rb
}

// Name set the Name property for FieldTypesBuilder.
func (rb *FieldTypesBuilder) Name(name Name) *FieldTypesBuilder {
	rb.v.Name = name
	return rb
}

// ScriptCount set the ScriptCount property for FieldTypesBuilder.
