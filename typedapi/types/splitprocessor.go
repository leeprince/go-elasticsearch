...
func NewSplitProcessor() *SplitProcessorBuilder {
...
// Field set the Field property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) Field(field Field) *SplitProcessorBuilder {
	rb.v.Field = field
	return rb
}

// If set the If property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) If_(if_ string) *SplitProcessorBuilder {
	rb.v.If = &if_
	return rb
}

// IgnoreFailure set the IgnoreFailure property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) IgnoreFailure(ignorefailure bool) *SplitProcessorBuilder {
	rb.v.IgnoreFailure = &ignorefailure
	return rb
}

// IgnoreMissing set the IgnoreMissing property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) IgnoreMissing(ignoremissing bool) *SplitProcessorBuilder {
	rb.v.IgnoreMissing = &ignoremissing
	return rb
}

// OnFailure set the OnFailure property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) OnFailure(on_failure ...ProcessorContainer) *SplitProcessorBuilder {
	rb.v.OnFailure = append(rb.v.OnFailure, on_failure...)
	return rb
}

// PreserveTrailing set the PreserveTrailing property for SplitProcessorBuilder.
...
// Separator set the Separator property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) Separator(separator string) *SplitProcessorBuilder {
	rb.v.Separator = separator
	return rb
}

// Tag set the Tag property for SplitProcessorBuilder.
func (rb *SplitProcessorBuilder) Tag(tag string) *SplitProcessorBuilder {
	rb.v.Tag = &tag
	return rb
}

// TargetField set the TargetField property for SplitProcessorBuilder.
