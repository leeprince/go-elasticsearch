...
func NewClusterOperatingSystemArchitecture() *ClusterOperatingSystemArchitectureBuilder {
...
// Arch set the Arch property for ClusterOperatingSystemArchitectureBuilder.
func (rb *ClusterOperatingSystemArchitectureBuilder) Arch(arch string) *ClusterOperatingSystemArchitectureBuilder {
	rb.v.Arch = arch
	return rb
}

// Count set the Count property for ClusterOperatingSystemArchitectureBuilder.
