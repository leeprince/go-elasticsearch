...
func NewCompareCondition() *CompareConditionBuilder {
...
// Comparison set the Comparison property for CompareConditionBuilder.
func (rb *CompareConditionBuilder) Comparison(comparison string) *CompareConditionBuilder {
	rb.v.Comparison = &comparison
	return rb
}

// CtxPayloadMatch set the CtxPayloadMatch property for CompareConditionBuilder.
func (rb *CompareConditionBuilder) CtxPayloadMatch(ctxpayloadmatch CompareContextPayloadCondition) *CompareConditionBuilder {
	rb.v.CtxPayloadMatch = &ctxpayloadmatch
	return rb
}

// CtxPayloadValue set the CtxPayloadValue property for CompareConditionBuilder.
func (rb *CompareConditionBuilder) CtxPayloadValue(ctxpayloadvalue CompareContextPayloadCondition) *CompareConditionBuilder {
	rb.v.CtxPayloadValue = &ctxpayloadvalue
	return rb
}

// Path set the Path property for CompareConditionBuilder.
func (rb *CompareConditionBuilder) Path(path string) *CompareConditionBuilder {
	rb.v.Path = &path
	return rb
}

// Value set the Value property for CompareConditionBuilder.
