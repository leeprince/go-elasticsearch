...
func NewNerInferenceUpdateOptions() *NerInferenceUpdateOptionsBuilder {
...
// Tokenization The tokenization options to update when inferring
func (rb *NerInferenceUpdateOptionsBuilder) Tokenization(tokenization NlpTokenizationUpdateOptions) *NerInferenceUpdateOptionsBuilder {
