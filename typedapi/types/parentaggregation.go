...
func NewParentAggregation() *ParentAggregationBuilder {
...
// Meta set the Meta property for ParentAggregationBuilder.
func (rb *ParentAggregationBuilder) Meta(meta Metadata) *ParentAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for ParentAggregationBuilder.
func (rb *ParentAggregationBuilder) Name(name string) *ParentAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Type set the Type property for ParentAggregationBuilder.
