...
func NewNodesCredentialsFileToken() *NodesCredentialsFileTokenBuilder {
...
// Nodes set the Nodes property for NodesCredentialsFileTokenBuilder.
func (rb *NodesCredentialsFileTokenBuilder) Nodes(nodes ...string) *NodesCredentialsFileTokenBuilder {
	rb.v.Nodes = append(rb.v.Nodes, nodes...)
	return rb
}
