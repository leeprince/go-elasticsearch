...
func NewDataframeAnalysisFeatureProcessor() *DataframeAnalysisFeatureProcessorBuilder {
...
// FrequencyEncoding The configuration information necessary to perform frequency encoding.
func (rb *DataframeAnalysisFeatureProcessorBuilder) FrequencyEncoding(frequencyencoding DataframeAnalysisFeatureProcessorFrequencyEncoding) *DataframeAnalysisFeatureProcessorBuilder {
	rb.v.FrequencyEncoding = &frequencyencoding
	return rb
}
...
// multiple processors to be changed together. This way the output of a
// processor can then be passed to another as an input.
func (rb *DataframeAnalysisFeatureProcessorBuilder) MultiEncoding(multiencoding DataframeAnalysisFeatureProcessorMultiEncoding) *DataframeAnalysisFeatureProcessorBuilder {
	rb.v.MultiEncoding = &multiencoding
	return rb
}
...
// <feature_prefix>.<ngram><string position>. For example, if the feature_prefix
// is f, the feature name for the second unigram in a string is f.11.
func (rb *DataframeAnalysisFeatureProcessorBuilder) NGramEncoding(ngramencoding DataframeAnalysisFeatureProcessorNGramEncoding) *DataframeAnalysisFeatureProcessorBuilder {
	rb.v.NGramEncoding = &ngramencoding
	return rb
}

// OneHotEncoding The configuration information necessary to perform one hot encoding.
func (rb *DataframeAnalysisFeatureProcessorBuilder) OneHotEncoding(onehotencoding DataframeAnalysisFeatureProcessorOneHotEncoding) *DataframeAnalysisFeatureProcessorBuilder {
	rb.v.OneHotEncoding = &onehotencoding
	return rb
}

// TargetMeanEncoding The configuration information necessary to perform target mean encoding.
func (rb *DataframeAnalysisFeatureProcessorBuilder) TargetMeanEncoding(targetmeanencoding DataframeAnalysisFeatureProcessorTargetMeanEncoding) *DataframeAnalysisFeatureProcessorBuilder {
	rb.v.TargetMeanEncoding = &targetmeanencoding
	return rb
}
