...
func NewAnalysisConfigRead() *AnalysisConfigReadBuilder {
...
// either as a string or as an object. If it is a string, it must refer to a
// built-in analyzer or one added by another plugin.
func (rb *AnalysisConfigReadBuilder) CategorizationAnalyzer(categorizationanalyzer CategorizationAnalyzer) *AnalysisConfigReadBuilder {
...
// detectors for a job. If the detectors array does not contain at least one
// detector, no analysis can occur and an error is returned.
func (rb *AnalysisConfigReadBuilder) Detectors(detectors ...DetectorRead) *AnalysisConfigReadBuilder {
...
// NOTE: Latency is applicable only when you send data by using the post data
// API.
func (rb *AnalysisConfigReadBuilder) Latency(latency Time) *AnalysisConfigReadBuilder {
...
// from the model. For jobs created in 8.1 and later, the default value is the
// greater of `30d` or 20 times `bucket_span`.
func (rb *AnalysisConfigReadBuilder) ModelPruneWindow(modelprunewindow Time) *AnalysisConfigReadBuilder {
...
// PerPartitionCategorization Settings related to how categorization interacts with partition fields.
func (rb *AnalysisConfigReadBuilder) PerPartitionCategorization(perpartitioncategorization PerPartitionCategorization) *AnalysisConfigReadBuilder {
