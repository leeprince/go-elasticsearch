...
func NewNodeInfoSettingsTransport() *NodeInfoSettingsTransportBuilder {
...
// Features set the Features property for NodeInfoSettingsTransportBuilder.
func (rb *NodeInfoSettingsTransportBuilder) Features(features NodeInfoSettingsTransportFeatures) *NodeInfoSettingsTransportBuilder {
	rb.v.Features = &features
	return rb
}

// Type set the Type property for NodeInfoSettingsTransportBuilder.
func (rb *NodeInfoSettingsTransportBuilder) Type_(type_ NodeInfoSettingsTransportType) *NodeInfoSettingsTransportBuilder {
	rb.v.Type = type_
	return rb
}

// TypeDefault set the TypeDefault property for NodeInfoSettingsTransportBuilder.
