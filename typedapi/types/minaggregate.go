...
func NewMinAggregate() *MinAggregateBuilder {
...
// Meta set the Meta property for MinAggregateBuilder.
func (rb *MinAggregateBuilder) Meta(meta Metadata) *MinAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for MinAggregateBuilder.
