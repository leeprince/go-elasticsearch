...
func NewMultiBucketAggregateBaseStringRareTermsBucket() *MultiBucketAggregateBaseStringRareTermsBucketBuilder {
...
// Buckets set the Buckets property for MultiBucketAggregateBaseStringRareTermsBucketBuilder.
func (rb *MultiBucketAggregateBaseStringRareTermsBucketBuilder) Buckets(buckets BucketsStringRareTermsBucket) *MultiBucketAggregateBaseStringRareTermsBucketBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for MultiBucketAggregateBaseStringRareTermsBucketBuilder.
func (rb *MultiBucketAggregateBaseStringRareTermsBucketBuilder) Meta(meta Metadata) *MultiBucketAggregateBaseStringRareTermsBucketBuilder {
	rb.v.Meta = &meta
	return rb
}
