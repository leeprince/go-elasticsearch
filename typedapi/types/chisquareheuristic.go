...
func NewChiSquareHeuristic() *ChiSquareHeuristicBuilder {
...
// BackgroundIsSuperset set the BackgroundIsSuperset property for ChiSquareHeuristicBuilder.
...
// IncludeNegatives set the IncludeNegatives property for ChiSquareHeuristicBuilder.
