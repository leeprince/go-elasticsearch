...
func NewTransportHistogram() *TransportHistogramBuilder {
...
// Count set the Count property for TransportHistogramBuilder.
func (rb *TransportHistogramBuilder) Count(count int64) *TransportHistogramBuilder {
	rb.v.Count = &count
	return rb
}

// GeMillis set the GeMillis property for TransportHistogramBuilder.
func (rb *TransportHistogramBuilder) GeMillis(gemillis int64) *TransportHistogramBuilder {
	rb.v.GeMillis = &gemillis
	return rb
}

// LtMillis set the LtMillis property for TransportHistogramBuilder.
