...
func NewBucketCorrelationFunction() *BucketCorrelationFunctionBuilder {
...
// CountCorrelation The configuration to calculate a count correlation. This function is designed
// for determining the correlation of a term value and a given metric.
func (rb *BucketCorrelationFunctionBuilder) CountCorrelation(countcorrelation BucketCorrelationFunctionCountCorrelation) *BucketCorrelationFunctionBuilder {
	rb.v.CountCorrelation = countcorrelation
	return rb
}
