...
func NewDataframeAnalysisClassification() *DataframeAnalysisClassificationBuilder {
...
// ClassAssignmentObjective set the ClassAssignmentObjective property for DataframeAnalysisClassificationBuilder.
...
// if you want to override the automatic feature encoding of the specified
// fields.
func (rb *DataframeAnalysisClassificationBuilder) FeatureProcessors(feature_processors ...DataframeAnalysisFeatureProcessor) *DataframeAnalysisClassificationBuilder {
	rb.v.FeatureProcessors = append(rb.v.FeatureProcessors, feature_processors...)
	return rb
}
...
// contain arrays with more than one value) won’t be included in the calculation
// for used percentage.
func (rb *DataframeAnalysisClassificationBuilder) TrainingPercent(trainingpercent Percentage) *DataframeAnalysisClassificationBuilder {
	rb.v.TrainingPercent = &trainingpercent
	return rb
}
