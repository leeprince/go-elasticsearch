...
func NewMatchAllQuery() *MatchAllQueryBuilder {
...
// Boost set the Boost property for MatchAllQueryBuilder.
func (rb *MatchAllQueryBuilder) Boost(boost float32) *MatchAllQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// QueryName_ set the QueryName_ property for MatchAllQueryBuilder.
