...
func NewSnowballAnalyzer() *SnowballAnalyzerBuilder {
...
// Language set the Language property for SnowballAnalyzerBuilder.
...
// Stopwords set the Stopwords property for SnowballAnalyzerBuilder.
func (rb *SnowballAnalyzerBuilder) Stopwords(stopwords StopWords) *SnowballAnalyzerBuilder {
	rb.v.Stopwords = &stopwords
	return rb
}

// Type set the Type property for SnowballAnalyzerBuilder.

// Version set the Version property for SnowballAnalyzerBuilder.
