...
func NewRecoveryStartStatus() *RecoveryStartStatusBuilder {
...
// CheckIndexTime set the CheckIndexTime property for RecoveryStartStatusBuilder.
...
// TotalTimeInMillis set the TotalTimeInMillis property for RecoveryStartStatusBuilder.
