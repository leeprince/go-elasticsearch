...
func NewMemoryStats() *MemoryStatsBuilder {
...
// AdjustedTotalInBytes set the AdjustedTotalInBytes property for MemoryStatsBuilder.
...
// UsedInBytes set the UsedInBytes property for MemoryStatsBuilder.
