...
func NewHdrPercentilesAggregate() *HdrPercentilesAggregateBuilder {
...
// Meta set the Meta property for HdrPercentilesAggregateBuilder.
func (rb *HdrPercentilesAggregateBuilder) Meta(meta Metadata) *HdrPercentilesAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Values set the Values property for HdrPercentilesAggregateBuilder.
func (rb *HdrPercentilesAggregateBuilder) Values(values Percentiles) *HdrPercentilesAggregateBuilder {
	rb.v.Values = values
	return rb
}
