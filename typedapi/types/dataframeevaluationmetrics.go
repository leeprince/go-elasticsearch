...
func NewDataframeEvaluationMetrics() *DataframeEvaluationMetricsBuilder {
...
// score and optionally the curve. It is calculated for a specific class
// (provided as "class_name") treated as positive.
func (rb *DataframeEvaluationMetricsBuilder) AucRoc(aucroc DataframeEvaluationClassificationMetricsAucRoc) *DataframeEvaluationMetricsBuilder {
	rb.v.AucRoc = &aucroc
	return rb
}
