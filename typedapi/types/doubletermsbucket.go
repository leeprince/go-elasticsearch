...
func NewDoubleTermsBucket() *DoubleTermsBucketBuilder {
...
// Aggregations set the Aggregations property for DoubleTermsBucketBuilder.
func (rb *DoubleTermsBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *DoubleTermsBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for DoubleTermsBucketBuilder.
func (rb *DoubleTermsBucketBuilder) DocCount(doccount int64) *DoubleTermsBucketBuilder {
	rb.v.DocCount = doccount
	return rb
}

// DocCountError set the DocCountError property for DoubleTermsBucketBuilder.
...
// Key set the Key property for DoubleTermsBucketBuilder.
func (rb *DoubleTermsBucketBuilder) Key(key float64) *DoubleTermsBucketBuilder {
	rb.v.Key = key
	return rb
}

// KeyAsString set the KeyAsString property for DoubleTermsBucketBuilder.
