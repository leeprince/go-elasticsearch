...
func NewTermsGrouping() *TermsGroupingBuilder {
...
// Fields set the Fields property for TermsGroupingBuilder.
func (rb *TermsGroupingBuilder) Fields(fields Fields) *TermsGroupingBuilder {
	rb.v.Fields = fields
	return rb
}
