...
func NewNoriTokenizer() *NoriTokenizerBuilder {
...
// DecompoundMode set the DecompoundMode property for NoriTokenizerBuilder.
...
// DiscardPunctuation set the DiscardPunctuation property for NoriTokenizerBuilder.
...
// Type set the Type property for NoriTokenizerBuilder.

// UserDictionary set the UserDictionary property for NoriTokenizerBuilder.
func (rb *NoriTokenizerBuilder) UserDictionary(userdictionary string) *NoriTokenizerBuilder {
	rb.v.UserDictionary = &userdictionary
	return rb
}

// UserDictionaryRules set the UserDictionaryRules property for NoriTokenizerBuilder.
...
// Version set the Version property for NoriTokenizerBuilder.
