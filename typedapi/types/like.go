...
// LikeDocument set the LikeDocument property for LikeBuilder.
func (u *LikeBuilder) LikeDocument(v LikeDocument) *LikeBuilder {
	u.v = v
	return u
}

// String set the String property for LikeBuilder.
func (u *LikeBuilder) String(v string) *LikeBuilder {
	u.v = v
	return u
}
