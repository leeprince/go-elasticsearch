...
func NewWildcardQuery() *WildcardQueryBuilder {
...
// Boost set the Boost property for WildcardQueryBuilder.
...
// QueryName_ set the QueryName_ property for WildcardQueryBuilder.
