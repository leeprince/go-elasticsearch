...
func NewSignificantStringTermsBucket() *SignificantStringTermsBucketBuilder {
...
// Aggregations set the Aggregations property for SignificantStringTermsBucketBuilder.
func (rb *SignificantStringTermsBucketBuilder) Aggregations(value map[AggregateName]Aggregate) *SignificantStringTermsBucketBuilder {
	rb.v.Aggregations = value
	return rb
}

// BgCount set the BgCount property for SignificantStringTermsBucketBuilder.
...
// DocCount set the DocCount property for SignificantStringTermsBucketBuilder.
func (rb *SignificantStringTermsBucketBuilder) DocCount(doccount int64) *SignificantStringTermsBucketBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Key set the Key property for SignificantStringTermsBucketBuilder.
func (rb *SignificantStringTermsBucketBuilder) Key(key string) *SignificantStringTermsBucketBuilder {
	rb.v.Key = key
	return rb
}

// Score set the Score property for SignificantStringTermsBucketBuilder.
