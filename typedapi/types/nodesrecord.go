...
func NewNodesRecord() *NodesRecordBuilder {
...
// DiskAvail available disk space
func (rb *NodesRecordBuilder) DiskAvail(diskavail ByteSize) *NodesRecordBuilder {
	rb.v.DiskAvail = &diskavail
	return rb
}

// DiskTotal total disk space
func (rb *NodesRecordBuilder) DiskTotal(disktotal ByteSize) *NodesRecordBuilder {
	rb.v.DiskTotal = &disktotal
	return rb
}

// DiskUsed used disk space
func (rb *NodesRecordBuilder) DiskUsed(diskused ByteSize) *NodesRecordBuilder {
	rb.v.DiskUsed = &diskused
	return rb
}

// DiskUsedPercent used disk space percentage
func (rb *NodesRecordBuilder) DiskUsedPercent(diskusedpercent Percentage) *NodesRecordBuilder {
	rb.v.DiskUsedPercent = &diskusedpercent
	return rb
}
...
// FileDescPercent used file descriptor ratio
func (rb *NodesRecordBuilder) FileDescPercent(filedescpercent Percentage) *NodesRecordBuilder {
	rb.v.FileDescPercent = &filedescpercent
	return rb
}
...
// HeapPercent used heap ratio
func (rb *NodesRecordBuilder) HeapPercent(heappercent Percentage) *NodesRecordBuilder {
	rb.v.HeapPercent = &heappercent
	return rb
}
...
// RamPercent used machine memory ratio
func (rb *NodesRecordBuilder) RamPercent(rampercent Percentage) *NodesRecordBuilder {
	rb.v.RamPercent = &rampercent
	return rb
}
