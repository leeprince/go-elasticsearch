...
func NewMaxAggregate() *MaxAggregateBuilder {
...
// Meta set the Meta property for MaxAggregateBuilder.
func (rb *MaxAggregateBuilder) Meta(meta Metadata) *MaxAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for MaxAggregateBuilder.
