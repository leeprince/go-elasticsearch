...
func NewClusterOperatingSystemPrettyName() *ClusterOperatingSystemPrettyNameBuilder {
...
// Count set the Count property for ClusterOperatingSystemPrettyNameBuilder.
func (rb *ClusterOperatingSystemPrettyNameBuilder) Count(count int) *ClusterOperatingSystemPrettyNameBuilder {
	rb.v.Count = count
	return rb
}

// PrettyName set the PrettyName property for ClusterOperatingSystemPrettyNameBuilder.
