...
func NewUrlDecodeProcessor() *UrlDecodeProcessorBuilder {
...
// Field set the Field property for UrlDecodeProcessorBuilder.
func (rb *UrlDecodeProcessorBuilder) Field(field Field) *UrlDecodeProcessorBuilder {
	rb.v.Field = field
	return rb
}

// If set the If property for UrlDecodeProcessorBuilder.
func (rb *UrlDecodeProcessorBuilder) If_(if_ string) *UrlDecodeProcessorBuilder {
	rb.v.If = &if_
	return rb
}

// IgnoreFailure set the IgnoreFailure property for UrlDecodeProcessorBuilder.
func (rb *UrlDecodeProcessorBuilder) IgnoreFailure(ignorefailure bool) *UrlDecodeProcessorBuilder {
	rb.v.IgnoreFailure = &ignorefailure
	return rb
}

// IgnoreMissing set the IgnoreMissing property for UrlDecodeProcessorBuilder.
...
// OnFailure set the OnFailure property for UrlDecodeProcessorBuilder.
func (rb *UrlDecodeProcessorBuilder) OnFailure(on_failure ...ProcessorContainer) *UrlDecodeProcessorBuilder {
	rb.v.OnFailure = append(rb.v.OnFailure, on_failure...)
	return rb
}

// Tag set the Tag property for UrlDecodeProcessorBuilder.
func (rb *UrlDecodeProcessorBuilder) Tag(tag string) *UrlDecodeProcessorBuilder {
	rb.v.Tag = &tag
	return rb
}

// TargetField set the TargetField property for UrlDecodeProcessorBuilder.
