...
func NewSoftDeletes() *SoftDeletesBuilder {
...
// follower the following
// process will fail due to incomplete history on the leader.
func (rb *SoftDeletesBuilder) RetentionLease(retentionlease RetentionLease) *SoftDeletesBuilder {
	rb.v.RetentionLease = &retentionlease
	return rb
}
