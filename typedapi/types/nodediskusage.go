...
func NewNodeDiskUsage() *NodeDiskUsageBuilder {
...
// LeastAvailable set the LeastAvailable property for NodeDiskUsageBuilder.
func (rb *NodeDiskUsageBuilder) LeastAvailable(leastavailable DiskUsage) *NodeDiskUsageBuilder {
	rb.v.LeastAvailable = leastavailable
	return rb
}

// MostAvailable set the MostAvailable property for NodeDiskUsageBuilder.
func (rb *NodeDiskUsageBuilder) MostAvailable(mostavailable DiskUsage) *NodeDiskUsageBuilder {
	rb.v.MostAvailable = mostavailable
	return rb
}

// NodeName set the NodeName property for NodeDiskUsageBuilder.
