...
func NewWeightedAvgAggregate() *WeightedAvgAggregateBuilder {
...
// Meta set the Meta property for WeightedAvgAggregateBuilder.
func (rb *WeightedAvgAggregateBuilder) Meta(meta Metadata) *WeightedAvgAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for WeightedAvgAggregateBuilder.
