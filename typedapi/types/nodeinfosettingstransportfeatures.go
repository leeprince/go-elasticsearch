...
func NewNodeInfoSettingsTransportFeatures() *NodeInfoSettingsTransportFeaturesBuilder {
...
// XPack set the XPack property for NodeInfoSettingsTransportFeaturesBuilder.
