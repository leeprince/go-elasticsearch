...
func NewIndicesOptions() *IndicesOptionsBuilder {
...
// comma-separated values,
// such as `open,hidden`.
func (rb *IndicesOptionsBuilder) ExpandWildcards(expandwildcards ExpandWildcards) *IndicesOptionsBuilder {
	rb.v.ExpandWildcards = &expandwildcards
	return rb
}
