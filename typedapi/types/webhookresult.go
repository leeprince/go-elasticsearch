...
func NewWebhookResult() *WebhookResultBuilder {
...
// Request set the Request property for WebhookResultBuilder.
func (rb *WebhookResultBuilder) Request(request HttpInputRequestResult) *WebhookResultBuilder {
	rb.v.Request = request
	return rb
}

// Response set the Response property for WebhookResultBuilder.
func (rb *WebhookResultBuilder) Response(response HttpInputResponseResult) *WebhookResultBuilder {
