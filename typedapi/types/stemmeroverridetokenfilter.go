...
func NewStemmerOverrideTokenFilter() *StemmerOverrideTokenFilterBuilder {
...
// Rules set the Rules property for StemmerOverrideTokenFilterBuilder.
func (rb *StemmerOverrideTokenFilterBuilder) Rules(rules ...string) *StemmerOverrideTokenFilterBuilder {
	rb.v.Rules = append(rb.v.Rules, rules...)
	return rb
}

// RulesPath set the RulesPath property for StemmerOverrideTokenFilterBuilder.
...
// Type set the Type property for StemmerOverrideTokenFilterBuilder.

// Version set the Version property for StemmerOverrideTokenFilterBuilder.
