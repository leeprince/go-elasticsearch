...
func NewCumulativeSumAggregation() *CumulativeSumAggregationBuilder {
...
// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *CumulativeSumAggregationBuilder) BucketsPath(bucketspath BucketsPath) *CumulativeSumAggregationBuilder {
	rb.v.BucketsPath = &bucketspath
	return rb
}

// Format set the Format property for CumulativeSumAggregationBuilder.
func (rb *CumulativeSumAggregationBuilder) Format(format string) *CumulativeSumAggregationBuilder {
	rb.v.Format = &format
	return rb
}

// GapPolicy set the GapPolicy property for CumulativeSumAggregationBuilder.
...
// Meta set the Meta property for CumulativeSumAggregationBuilder.
func (rb *CumulativeSumAggregationBuilder) Meta(meta Metadata) *CumulativeSumAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for CumulativeSumAggregationBuilder.
