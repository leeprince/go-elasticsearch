...
func NewProcessor() *ProcessorBuilder {
	r := ProcessorBuilder{
		&Processor{},
	}
...
// Count set the Count property for ProcessorBuilder.
func (rb *ProcessorBuilder) Count(count int64) *ProcessorBuilder {
	rb.v.Count = &count
	return rb
}

// Current set the Current property for ProcessorBuilder.
func (rb *ProcessorBuilder) Current(current int64) *ProcessorBuilder {
	rb.v.Current = &current
	return rb
}

// Failed set the Failed property for ProcessorBuilder.
func (rb *ProcessorBuilder) Failed(failed int64) *ProcessorBuilder {
	rb.v.Failed = &failed
	return rb
}

// TimeInMillis set the TimeInMillis property for ProcessorBuilder.
