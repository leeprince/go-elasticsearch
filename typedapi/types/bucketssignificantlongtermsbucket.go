...
func NewBucketsSignificantLongTermsBucket() *BucketsSignificantLongTermsBucketBuilder {
...
// Map set the Map property for BucketsSignificantLongTermsBucketBuilder.
func (u *BucketsSignificantLongTermsBucketBuilder) Map(v map[string]SignificantLongTermsBucket) *BucketsSignificantLongTermsBucketBuilder {
	u.v = v
	return u
}

// SignificantLongTermsBuckets set the SignificantLongTermsBuckets property for BucketsSignificantLongTermsBucketBuilder.
func (u *BucketsSignificantLongTermsBucketBuilder) SignificantLongTermsBuckets(v []SignificantLongTermsBucket) *BucketsSignificantLongTermsBucketBuilder {
	u.v = v
	return u
}
