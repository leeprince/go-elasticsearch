...
func NewExecutionResultCondition() *ExecutionResultConditionBuilder {
...
// Met set the Met property for ExecutionResultConditionBuilder.
func (rb *ExecutionResultConditionBuilder) Met(met bool) *ExecutionResultConditionBuilder {
	rb.v.Met = met
	return rb
}

// Status set the Status property for ExecutionResultConditionBuilder.
...
// Type set the Type property for ExecutionResultConditionBuilder.
