...
func NewScriptSort() *ScriptSortBuilder {
	r := ScriptSortBuilder{
		&ScriptSort{},
	}
...
// Mode set the Mode property for ScriptSortBuilder.
func (rb *ScriptSortBuilder) Mode(mode sortmode.SortMode) *ScriptSortBuilder {
	rb.v.Mode = &mode
	return rb
}

// Nested set the Nested property for ScriptSortBuilder.
func (rb *ScriptSortBuilder) Nested(nested NestedSortValue) *ScriptSortBuilder {
	rb.v.Nested = &nested
	return rb
}

// Order set the Order property for ScriptSortBuilder.
func (rb *ScriptSortBuilder) Order(order sortorder.SortOrder) *ScriptSortBuilder {
	rb.v.Order = &order
	return rb
}

// Script set the Script property for ScriptSortBuilder.
func (rb *ScriptSortBuilder) Script(script Script) *ScriptSortBuilder {
	rb.v.Script = script
	return rb
}

// Type set the Type property for ScriptSortBuilder.
