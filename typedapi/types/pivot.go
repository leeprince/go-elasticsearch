...
// top metrics, value count, weighted
// average.
func (rb *PivotBuilder) Aggregations(value map[string]AggregationContainer) *PivotBuilder {
...
// pivot. The following groupings are
// currently supported: date histogram, geotile grid, histogram, terms.
func (rb *PivotBuilder) GroupBy(value map[string]PivotGroupByContainer) *PivotBuilder {
	rb.v.GroupBy = value
	return rb
}
