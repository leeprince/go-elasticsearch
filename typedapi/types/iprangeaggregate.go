...
func NewIpRangeAggregate() *IpRangeAggregateBuilder {
...
// Buckets set the Buckets property for IpRangeAggregateBuilder.
func (rb *IpRangeAggregateBuilder) Buckets(buckets BucketsIpRangeBucket) *IpRangeAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for IpRangeAggregateBuilder.
func (rb *IpRangeAggregateBuilder) Meta(meta Metadata) *IpRangeAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
