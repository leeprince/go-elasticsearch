...
func NewStandardDeviationBoundsAsString() *StandardDeviationBoundsAsStringBuilder {
...
// Lower set the Lower property for StandardDeviationBoundsAsStringBuilder.
func (rb *StandardDeviationBoundsAsStringBuilder) Lower(lower string) *StandardDeviationBoundsAsStringBuilder {
	rb.v.Lower = lower
	return rb
}

// LowerPopulation set the LowerPopulation property for StandardDeviationBoundsAsStringBuilder.
...
// LowerSampling set the LowerSampling property for StandardDeviationBoundsAsStringBuilder.
...
// Upper set the Upper property for StandardDeviationBoundsAsStringBuilder.
func (rb *StandardDeviationBoundsAsStringBuilder) Upper(upper string) *StandardDeviationBoundsAsStringBuilder {
	rb.v.Upper = upper
	return rb
}

// UpperPopulation set the UpperPopulation property for StandardDeviationBoundsAsStringBuilder.
...
// UpperSampling set the UpperSampling property for StandardDeviationBoundsAsStringBuilder.
