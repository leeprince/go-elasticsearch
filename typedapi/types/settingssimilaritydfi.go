...
func NewSettingsSimilarityDfi() *SettingsSimilarityDfiBuilder {
...
// IndependenceMeasure set the IndependenceMeasure property for SettingsSimilarityDfiBuilder.
...
// Type set the Type property for SettingsSimilarityDfiBuilder.
