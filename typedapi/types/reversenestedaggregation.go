...
func NewReverseNestedAggregation() *ReverseNestedAggregationBuilder {
...
// Meta set the Meta property for ReverseNestedAggregationBuilder.
func (rb *ReverseNestedAggregationBuilder) Meta(meta Metadata) *ReverseNestedAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for ReverseNestedAggregationBuilder.
func (rb *ReverseNestedAggregationBuilder) Name(name string) *ReverseNestedAggregationBuilder {
	rb.v.Name = &name
	return rb
}

// Path set the Path property for ReverseNestedAggregationBuilder.
