...
func NewCloseIndexResult() *CloseIndexResultBuilder {
...
// Closed set the Closed property for CloseIndexResultBuilder.
func (rb *CloseIndexResultBuilder) Closed(closed bool) *CloseIndexResultBuilder {
	rb.v.Closed = closed
	return rb
}

// Shards set the Shards property for CloseIndexResultBuilder.
func (rb *CloseIndexResultBuilder) Shards(value map[string]CloseShardResult) *CloseIndexResultBuilder {
	rb.v.Shards = value
	return rb
}
