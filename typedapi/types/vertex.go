...
// Depth set the Depth property for VertexBuilder.
func (rb *VertexBuilder) Depth(depth int64) *VertexBuilder {
	rb.v.Depth = depth
	return rb
}

// Field set the Field property for VertexBuilder.
func (rb *VertexBuilder) Field(field Field) *VertexBuilder {
	rb.v.Field = field
	return rb
}

// Term set the Term property for VertexBuilder.
func (rb *VertexBuilder) Term(term string) *VertexBuilder {
	rb.v.Term = term
	return rb
}

// Weight set the Weight property for VertexBuilder.
