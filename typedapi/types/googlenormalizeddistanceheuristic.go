...
func NewGoogleNormalizedDistanceHeuristic() *GoogleNormalizedDistanceHeuristicBuilder {
...
// BackgroundIsSuperset set the BackgroundIsSuperset property for GoogleNormalizedDistanceHeuristicBuilder.
