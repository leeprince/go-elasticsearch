...
func NewPipelineConfig() *PipelineConfigBuilder {
...
// Description set the Description property for PipelineConfigBuilder.
func (rb *PipelineConfigBuilder) Description(description string) *PipelineConfigBuilder {
	rb.v.Description = &description
	return rb
}

// Processors set the Processors property for PipelineConfigBuilder.
func (rb *PipelineConfigBuilder) Processors(processors ...ProcessorContainer) *PipelineConfigBuilder {
	rb.v.Processors = append(rb.v.Processors, processors...)
	return rb
}

// Version set the Version property for PipelineConfigBuilder.
