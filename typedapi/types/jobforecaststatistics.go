...
func NewJobForecastStatistics() *JobForecastStatisticsBuilder {
...
// ForecastedJobs set the ForecastedJobs property for JobForecastStatisticsBuilder.
...
// MemoryBytes set the MemoryBytes property for JobForecastStatisticsBuilder.
func (rb *JobForecastStatisticsBuilder) MemoryBytes(memorybytes JobStatistics) *JobForecastStatisticsBuilder {
	rb.v.MemoryBytes = &memorybytes
	return rb
}

// ProcessingTimeMs set the ProcessingTimeMs property for JobForecastStatisticsBuilder.
func (rb *JobForecastStatisticsBuilder) ProcessingTimeMs(processingtimems JobStatistics) *JobForecastStatisticsBuilder {
	rb.v.ProcessingTimeMs = &processingtimems
	return rb
}

// Records set the Records property for JobForecastStatisticsBuilder.
func (rb *JobForecastStatisticsBuilder) Records(records JobStatistics) *JobForecastStatisticsBuilder {
	rb.v.Records = &records
	return rb
}

// Status set the Status property for JobForecastStatisticsBuilder.
func (rb *JobForecastStatisticsBuilder) Status(value map[string]int64) *JobForecastStatisticsBuilder {
	rb.v.Status = value
	return rb
}

// Total set the Total property for JobForecastStatisticsBuilder.
