...
func NewIndexAction() *IndexActionBuilder {
...
// DocId set the DocId property for IndexActionBuilder.
func (rb *IndexActionBuilder) DocId(docid Id) *IndexActionBuilder {
	rb.v.DocId = &docid
	return rb
}

// ExecutionTimeField set the ExecutionTimeField property for IndexActionBuilder.
...
// Index set the Index property for IndexActionBuilder.
func (rb *IndexActionBuilder) Index(index IndexName) *IndexActionBuilder {
	rb.v.Index = index
	return rb
}

// OpType set the OpType property for IndexActionBuilder.
func (rb *IndexActionBuilder) OpType(optype optype.OpType) *IndexActionBuilder {
	rb.v.OpType = &optype
	return rb
}

// Refresh set the Refresh property for IndexActionBuilder.
func (rb *IndexActionBuilder) Refresh(refresh refresh.Refresh) *IndexActionBuilder {
	rb.v.Refresh = &refresh
	return rb
}

// Timeout set the Timeout property for IndexActionBuilder.
func (rb *IndexActionBuilder) Timeout(timeout Time) *IndexActionBuilder {
