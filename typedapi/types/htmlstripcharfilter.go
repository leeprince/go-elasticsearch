...
func NewHtmlStripCharFilter() *HtmlStripCharFilterBuilder {
...
// Type set the Type property for HtmlStripCharFilterBuilder.

// Version set the Version property for HtmlStripCharFilterBuilder.
