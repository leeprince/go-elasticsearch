...
func NewAutoFollowedCluster() *AutoFollowedClusterBuilder {
...
// ClusterName set the ClusterName property for AutoFollowedClusterBuilder.
func (rb *AutoFollowedClusterBuilder) ClusterName(clustername Name) *AutoFollowedClusterBuilder {
	rb.v.ClusterName = clustername
	return rb
}

// LastSeenMetadataVersion set the LastSeenMetadataVersion property for AutoFollowedClusterBuilder.
...
// TimeSinceLastCheckMillis set the TimeSinceLastCheckMillis property for AutoFollowedClusterBuilder.
