...
func NewLatLonGeoLocation() *LatLonGeoLocationBuilder {
...
// Lat set the Lat property for LatLonGeoLocationBuilder.
func (rb *LatLonGeoLocationBuilder) Lat(lat float64) *LatLonGeoLocationBuilder {
	rb.v.Lat = lat
	return rb
}

// Lon set the Lon property for LatLonGeoLocationBuilder.
