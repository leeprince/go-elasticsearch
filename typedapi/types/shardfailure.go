...
func NewShardFailure() *ShardFailureBuilder {
...
// Index set the Index property for ShardFailureBuilder.
func (rb *ShardFailureBuilder) Index(index IndexName) *ShardFailureBuilder {
	rb.v.Index = &index
	return rb
}

// Node set the Node property for ShardFailureBuilder.
func (rb *ShardFailureBuilder) Node(node string) *ShardFailureBuilder {
	rb.v.Node = &node
	return rb
}

// Reason set the Reason property for ShardFailureBuilder.
func (rb *ShardFailureBuilder) Reason(reason ErrorCause) *ShardFailureBuilder {
	rb.v.Reason = reason
	return rb
}

// Shard set the Shard property for ShardFailureBuilder.
func (rb *ShardFailureBuilder) Shard(shard int) *ShardFailureBuilder {
	rb.v.Shard = shard
	return rb
}

// Status set the Status property for ShardFailureBuilder.
