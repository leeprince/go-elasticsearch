...
func NewRenameProcessor() *RenameProcessorBuilder {
...
// Field set the Field property for RenameProcessorBuilder.
func (rb *RenameProcessorBuilder) Field(field Field) *RenameProcessorBuilder {
	rb.v.Field = field
	return rb
}

// If set the If property for RenameProcessorBuilder.
func (rb *RenameProcessorBuilder) If_(if_ string) *RenameProcessorBuilder {
	rb.v.If = &if_
	return rb
}

// IgnoreFailure set the IgnoreFailure property for RenameProcessorBuilder.
func (rb *RenameProcessorBuilder) IgnoreFailure(ignorefailure bool) *RenameProcessorBuilder {
	rb.v.IgnoreFailure = &ignorefailure
	return rb
}

// IgnoreMissing set the IgnoreMissing property for RenameProcessorBuilder.
func (rb *RenameProcessorBuilder) IgnoreMissing(ignoremissing bool) *RenameProcessorBuilder {
	rb.v.IgnoreMissing = &ignoremissing
	return rb
}

// OnFailure set the OnFailure property for RenameProcessorBuilder.
func (rb *RenameProcessorBuilder) OnFailure(on_failure ...ProcessorContainer) *RenameProcessorBuilder {
	rb.v.OnFailure = append(rb.v.OnFailure, on_failure...)
	return rb
}

// Tag set the Tag property for RenameProcessorBuilder.
func (rb *RenameProcessorBuilder) Tag(tag string) *RenameProcessorBuilder {
	rb.v.Tag = &tag
	return rb
}

// TargetField set the TargetField property for RenameProcessorBuilder.
