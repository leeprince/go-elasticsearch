...
func NewPassThroughInferenceUpdateOptions() *PassThroughInferenceUpdateOptionsBuilder {
...
// Tokenization The tokenization options to update when inferring
func (rb *PassThroughInferenceUpdateOptionsBuilder) Tokenization(tokenization NlpTokenizationUpdateOptions) *PassThroughInferenceUpdateOptionsBuilder {
