...
func NewDataframeAnalysis() *DataframeAnalysisBuilder {
...
// if you want to override the automatic feature encoding of the specified
// fields.
func (rb *DataframeAnalysisBuilder) FeatureProcessors(feature_processors ...DataframeAnalysisFeatureProcessor) *DataframeAnalysisBuilder {
...
// contain arrays with more than one value) won’t be included in the calculation
// for used percentage.
func (rb *DataframeAnalysisBuilder) TrainingPercent(trainingpercent Percentage) *DataframeAnalysisBuilder {
