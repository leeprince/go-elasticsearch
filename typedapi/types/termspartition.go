...
func NewTermsPartition() *TermsPartitionBuilder {
...
// NumPartitions set the NumPartitions property for TermsPartitionBuilder.
func (rb *TermsPartitionBuilder) NumPartitions(numpartitions int64) *TermsPartitionBuilder {
	rb.v.NumPartitions = numpartitions
	return rb
}

// Partition set the Partition property for TermsPartitionBuilder.
