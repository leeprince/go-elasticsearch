...
func NewDataframeAnalysisRegression() *DataframeAnalysisRegressionBuilder {
...
// if you want to override the automatic feature encoding of the specified
// fields.
func (rb *DataframeAnalysisRegressionBuilder) FeatureProcessors(feature_processors ...DataframeAnalysisFeatureProcessor) *DataframeAnalysisRegressionBuilder {
...
// contain arrays with more than one value) won’t be included in the calculation
// for used percentage.
func (rb *DataframeAnalysisRegressionBuilder) TrainingPercent(trainingpercent Percentage) *DataframeAnalysisRegressionBuilder {
