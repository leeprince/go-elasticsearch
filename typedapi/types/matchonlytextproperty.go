...
func NewMatchOnlyTextProperty() *MatchOnlyTextPropertyBuilder {
...
// CopyTo Allows you to copy the values of multiple fields into a group
// field, which can then be queried as a single field.
func (rb *MatchOnlyTextPropertyBuilder) CopyTo(copyto Fields) *MatchOnlyTextPropertyBuilder {
	rb.v.CopyTo = &copyto
	return rb
}
...
// field for search and a multi-field for sorting and aggregations, or the same
// string value analyzed by different analyzers.
func (rb *MatchOnlyTextPropertyBuilder) Fields(value map[PropertyName]Property) *MatchOnlyTextPropertyBuilder {
	rb.v.Fields = value
	return rb
}
...
// Type set the Type property for MatchOnlyTextPropertyBuilder.
