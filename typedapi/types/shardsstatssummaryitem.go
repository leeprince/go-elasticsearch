...
func NewShardsStatsSummaryItem() *ShardsStatsSummaryItemBuilder {
...
// FileCount set the FileCount property for ShardsStatsSummaryItemBuilder.
func (rb *ShardsStatsSummaryItemBuilder) FileCount(filecount int64) *ShardsStatsSummaryItemBuilder {
	rb.v.FileCount = filecount
	return rb
}

// SizeInBytes set the SizeInBytes property for ShardsStatsSummaryItemBuilder.
