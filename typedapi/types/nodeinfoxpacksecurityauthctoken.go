...
func NewNodeInfoXpackSecurityAuthcToken() *NodeInfoXpackSecurityAuthcTokenBuilder {
...
// Enabled set the Enabled property for NodeInfoXpackSecurityAuthcTokenBuilder.
