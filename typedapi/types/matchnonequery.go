...
func NewMatchNoneQuery() *MatchNoneQueryBuilder {
...
// Boost set the Boost property for MatchNoneQueryBuilder.
func (rb *MatchNoneQueryBuilder) Boost(boost float32) *MatchNoneQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// QueryName_ set the QueryName_ property for MatchNoneQueryBuilder.
