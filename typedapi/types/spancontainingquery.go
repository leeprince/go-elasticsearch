...
func NewSpanContainingQuery() *SpanContainingQueryBuilder {
...
// Big set the Big property for SpanContainingQueryBuilder.
func (rb *SpanContainingQueryBuilder) Big(big SpanQuery) *SpanContainingQueryBuilder {
	rb.v.Big = &big
	return rb
}

// Boost set the Boost property for SpanContainingQueryBuilder.
func (rb *SpanContainingQueryBuilder) Boost(boost float32) *SpanContainingQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Little set the Little property for SpanContainingQueryBuilder.
func (rb *SpanContainingQueryBuilder) Little(little SpanQuery) *SpanContainingQueryBuilder {
	rb.v.Little = &little
	return rb
}

// QueryName_ set the QueryName_ property for SpanContainingQueryBuilder.
