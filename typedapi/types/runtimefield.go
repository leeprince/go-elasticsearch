...
func NewRuntimeField() *RuntimeFieldBuilder {
...
// Format set the Format property for RuntimeFieldBuilder.
func (rb *RuntimeFieldBuilder) Format(format string) *RuntimeFieldBuilder {
	rb.v.Format = &format
	return rb
}

// Script set the Script property for RuntimeFieldBuilder.
func (rb *RuntimeFieldBuilder) Script(script Script) *RuntimeFieldBuilder {
	rb.v.Script = &script
	return rb
}

// Type set the Type property for RuntimeFieldBuilder.
