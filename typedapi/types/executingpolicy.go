...
func NewExecutingPolicy() *ExecutingPolicyBuilder {
...
// Name set the Name property for ExecutingPolicyBuilder.
func (rb *ExecutingPolicyBuilder) Name(name Name) *ExecutingPolicyBuilder {
	rb.v.Name = name
	return rb
}

// Task set the Task property for ExecutingPolicyBuilder.
func (rb *ExecutingPolicyBuilder) Task(task TaskInfo) *ExecutingPolicyBuilder {
	rb.v.Task = task
	return rb
}
