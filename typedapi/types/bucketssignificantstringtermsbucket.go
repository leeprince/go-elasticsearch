...
func NewBucketsSignificantStringTermsBucket() *BucketsSignificantStringTermsBucketBuilder {
...
// Map set the Map property for BucketsSignificantStringTermsBucketBuilder.
func (u *BucketsSignificantStringTermsBucketBuilder) Map(v map[string]SignificantStringTermsBucket) *BucketsSignificantStringTermsBucketBuilder {
	u.v = v
	return u
}

// SignificantStringTermsBuckets set the SignificantStringTermsBuckets property for BucketsSignificantStringTermsBucketBuilder.
func (u *BucketsSignificantStringTermsBucketBuilder) SignificantStringTermsBuckets(v []SignificantStringTermsBucket) *BucketsSignificantStringTermsBucketBuilder {
	u.v = v
	return u
}
