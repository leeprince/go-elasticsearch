...
func NewCompletionStats() *CompletionStatsBuilder {
...
// Fields set the Fields property for CompletionStatsBuilder.
func (rb *CompletionStatsBuilder) Fields(value map[Field]FieldSizeUsage) *CompletionStatsBuilder {
	rb.v.Fields = value
	return rb
}

// Size set the Size property for CompletionStatsBuilder.
func (rb *CompletionStatsBuilder) Size(size ByteSize) *CompletionStatsBuilder {
	rb.v.Size = &size
	return rb
}

// SizeInBytes set the SizeInBytes property for CompletionStatsBuilder.
