...
func NewDataframeAnalytics() *DataframeAnalyticsBuilder {
...
// AnalysisStats An object containing information about the analysis job.
func (rb *DataframeAnalyticsBuilder) AnalysisStats(analysisstats DataframeAnalyticsStatsContainer) *DataframeAnalyticsBuilder {
	rb.v.AnalysisStats = &analysisstats
	return rb
}
...
// DataCounts An object that provides counts for the quantity of documents skipped, used in
// training, or available for testing.
func (rb *DataframeAnalyticsBuilder) DataCounts(datacounts DataframeAnalyticsStatsDataCounts) *DataframeAnalyticsBuilder {
...
// MemoryUsage An object describing memory usage of the analytics. It is present only after
// the job is started and memory usage is reported.
func (rb *DataframeAnalyticsBuilder) MemoryUsage(memoryusage DataframeAnalyticsStatsMemoryUsage) *DataframeAnalyticsBuilder {
...
// Node Contains properties for the node that runs the job. This information is
// available only for running jobs.
func (rb *DataframeAnalyticsBuilder) Node(node NodeAttributes) *DataframeAnalyticsBuilder {
	rb.v.Node = &node
	return rb
}

// Progress The progress report of the data frame analytics job by phase.
func (rb *DataframeAnalyticsBuilder) Progress(progress ...DataframeAnalyticsStatsProgress) *DataframeAnalyticsBuilder {
	rb.v.Progress = append(rb.v.Progress, progress...)
	return rb
}
