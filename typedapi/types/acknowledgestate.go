...
func NewAcknowledgeState() *AcknowledgeStateBuilder {
...
// State set the State property for AcknowledgeStateBuilder.
func (rb *AcknowledgeStateBuilder) State(state acknowledgementoptions.AcknowledgementOptions) *AcknowledgeStateBuilder {
	rb.v.State = state
	return rb
}

// Timestamp set the Timestamp property for AcknowledgeStateBuilder.
