...
func NewStatsResponseBase() *StatsResponseBaseBuilder {
...
// Indices Contains statistics about indices with shards assigned to selected nodes.
func (rb *StatsResponseBaseBuilder) Indices(indices ClusterIndices) *StatsResponseBaseBuilder {
...
// NodeStats Contains statistics about the number of nodes selected by the request’s node
// filters.
func (rb *StatsResponseBaseBuilder) NodeStats(nodestats NodeStatistics) *StatsResponseBaseBuilder {
	rb.v.NodeStats = &nodestats
	return rb
}

// Nodes Contains statistics about nodes selected by the request’s node filters.
func (rb *StatsResponseBaseBuilder) Nodes(nodes ClusterNodes) *StatsResponseBaseBuilder {
	rb.v.Nodes = nodes
	return rb
}
