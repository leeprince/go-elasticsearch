...
func NewGeoPolygonQuery() *GeoPolygonQueryBuilder {
...
// Boost set the Boost property for GeoPolygonQueryBuilder.
func (rb *GeoPolygonQueryBuilder) Boost(boost float32) *GeoPolygonQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// GeoPolygonQuery set the GeoPolygonQuery property for GeoPolygonQueryBuilder.
func (rb *GeoPolygonQueryBuilder) GeoPolygonQuery(value map[Field]GeoPolygonPoints) *GeoPolygonQueryBuilder {
	rb.v.GeoPolygonQuery = value
	return rb
}

// IgnoreUnmapped set the IgnoreUnmapped property for GeoPolygonQueryBuilder.
...
// QueryName_ set the QueryName_ property for GeoPolygonQueryBuilder.
func (rb *GeoPolygonQueryBuilder) QueryName_(queryname_ string) *GeoPolygonQueryBuilder {
	rb.v.QueryName_ = &queryname_
	return rb
}

// ValidationMethod set the ValidationMethod property for GeoPolygonQueryBuilder.
