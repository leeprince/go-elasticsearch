...
func NewTrainedModelsRecord() *TrainedModelsRecordBuilder {
...
// HeapSize the estimated heap size to keep the model in memory
func (rb *TrainedModelsRecordBuilder) HeapSize(heapsize ByteSize) *TrainedModelsRecordBuilder {
	rb.v.HeapSize = &heapsize
	return rb
}
...
// Type set the Type property for TrainedModelsRecordBuilder.
