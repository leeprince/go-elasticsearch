...
func NewStepKey() *StepKeyBuilder {
	r := StepKeyBuilder{
		&StepKey{},
	}
...
// Action set the Action property for StepKeyBuilder.
func (rb *StepKeyBuilder) Action(action string) *StepKeyBuilder {
	rb.v.Action = action
	return rb
}

// Name set the Name property for StepKeyBuilder.
func (rb *StepKeyBuilder) Name(name string) *StepKeyBuilder {
	rb.v.Name = name
	return rb
}

// Phase set the Phase property for StepKeyBuilder.
