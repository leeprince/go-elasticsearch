...
func NewIndexResult() *IndexResultBuilder {
...
// Response set the Response property for IndexResultBuilder.
func (rb *IndexResultBuilder) Response(response IndexResultSummary) *IndexResultBuilder {
