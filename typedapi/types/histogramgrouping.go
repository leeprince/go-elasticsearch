...
func NewHistogramGrouping() *HistogramGroupingBuilder {
...
// Fields set the Fields property for HistogramGroupingBuilder.
func (rb *HistogramGroupingBuilder) Fields(fields Fields) *HistogramGroupingBuilder {
	rb.v.Fields = fields
	return rb
}

// Interval set the Interval property for HistogramGroupingBuilder.
