...
func NewTaskInfos() *TaskInfosBuilder {
...
// Map set the Map property for TaskInfosBuilder.
func (u *TaskInfosBuilder) Map(v map[string]ParentTaskInfo) *TaskInfosBuilder {
	u.v = v
	return u
}

// TaskInfos set the TaskInfos property for TaskInfosBuilder.
func (u *TaskInfosBuilder) TaskInfos(v []TaskInfo) *TaskInfosBuilder {
	u.v = v
	return u
}
