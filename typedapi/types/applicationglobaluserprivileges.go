...
func NewApplicationGlobalUserPrivileges() *ApplicationGlobalUserPrivilegesBuilder {
...
// Manage set the Manage property for ApplicationGlobalUserPrivilegesBuilder.
func (rb *ApplicationGlobalUserPrivilegesBuilder) Manage(manage ManageUserPrivileges) *ApplicationGlobalUserPrivilegesBuilder {
	rb.v.Manage = manage
	return rb
}
