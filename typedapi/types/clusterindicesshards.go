...
func NewClusterIndicesShards() *ClusterIndicesShardsBuilder {
...
// Index Contains statistics about shards assigned to selected nodes.
func (rb *ClusterIndicesShardsBuilder) Index(index ClusterIndicesShardsIndex) *ClusterIndicesShardsBuilder {
	rb.v.Index = &index
	return rb
}
