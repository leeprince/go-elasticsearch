...
func NewMemMlStats() *MemMlStatsBuilder {
	r := MemMlStatsBuilder{
		&MemMlStats{},
	}
...
// AnomalyDetectors Amount of native memory set aside for anomaly detection jobs.
func (rb *MemMlStatsBuilder) AnomalyDetectors(anomalydetectors ByteSize) *MemMlStatsBuilder {
...
// DataFrameAnalytics Amount of native memory set aside for data frame analytics jobs.
func (rb *MemMlStatsBuilder) DataFrameAnalytics(dataframeanalytics ByteSize) *MemMlStatsBuilder {
	rb.v.DataFrameAnalytics = &dataframeanalytics
	return rb
}
...
// Max Maximum amount of native memory (separate to the JVM heap) that may be used
// by machine learning native processes.
func (rb *MemMlStatsBuilder) Max(max ByteSize) *MemMlStatsBuilder {
	rb.v.Max = &max
	return rb
}
...
// NativeCodeOverhead Amount of native memory set aside for loading machine learning native code
// shared libraries.
func (rb *MemMlStatsBuilder) NativeCodeOverhead(nativecodeoverhead ByteSize) *MemMlStatsBuilder {
	rb.v.NativeCodeOverhead = &nativecodeoverhead
	return rb
}
...
// NativeInference Amount of native memory set aside for trained models that have a PyTorch
// model_type.
func (rb *MemMlStatsBuilder) NativeInference(nativeinference ByteSize) *MemMlStatsBuilder {
	rb.v.NativeInference = &nativeinference
	return rb
}
