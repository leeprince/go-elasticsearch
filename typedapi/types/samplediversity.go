...
func NewSampleDiversity() *SampleDiversityBuilder {
...
// Field set the Field property for SampleDiversityBuilder.
func (rb *SampleDiversityBuilder) Field(field Field) *SampleDiversityBuilder {
	rb.v.Field = field
	return rb
}

// MaxDocsPerValue set the MaxDocsPerValue property for SampleDiversityBuilder.
