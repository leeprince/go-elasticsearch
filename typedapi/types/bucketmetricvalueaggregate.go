...
func NewBucketMetricValueAggregate() *BucketMetricValueAggregateBuilder {
...
// Keys set the Keys property for BucketMetricValueAggregateBuilder.
func (rb *BucketMetricValueAggregateBuilder) Keys(keys ...string) *BucketMetricValueAggregateBuilder {
	rb.v.Keys = append(rb.v.Keys, keys...)
	return rb
}

// Meta set the Meta property for BucketMetricValueAggregateBuilder.
func (rb *BucketMetricValueAggregateBuilder) Meta(meta Metadata) *BucketMetricValueAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
...
// ValueAsString set the ValueAsString property for BucketMetricValueAggregateBuilder.
