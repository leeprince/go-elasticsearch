...
func NewAcknowledgement() *AcknowledgementBuilder {
...
// License set the License property for AcknowledgementBuilder.
func (rb *AcknowledgementBuilder) License(license ...string) *AcknowledgementBuilder {
	rb.v.License = append(rb.v.License, license...)
	return rb
}

// Message set the Message property for AcknowledgementBuilder.
