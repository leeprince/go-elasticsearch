...
// Available set the Available property for ArchiveBuilder.
func (rb *ArchiveBuilder) Available(available bool) *ArchiveBuilder {
	rb.v.Available = available
	return rb
}

// Enabled set the Enabled property for ArchiveBuilder.
func (rb *ArchiveBuilder) Enabled(enabled bool) *ArchiveBuilder {
	rb.v.Enabled = enabled
	return rb
}

// IndicesCount set the IndicesCount property for ArchiveBuilder.
