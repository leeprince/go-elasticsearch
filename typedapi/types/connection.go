...
// DocCount set the DocCount property for ConnectionBuilder.
func (rb *ConnectionBuilder) DocCount(doccount int64) *ConnectionBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Source set the Source property for ConnectionBuilder.
func (rb *ConnectionBuilder) Source(source int64) *ConnectionBuilder {
	rb.v.Source = source
	return rb
}

// Target set the Target property for ConnectionBuilder.
func (rb *ConnectionBuilder) Target(target int64) *ConnectionBuilder {
	rb.v.Target = target
	return rb
}

// Weight set the Weight property for ConnectionBuilder.
