...
func NewExtendedBoundsdouble() *ExtendedBoundsdoubleBuilder {
...
// Max set the Max property for ExtendedBoundsdoubleBuilder.
func (rb *ExtendedBoundsdoubleBuilder) Max(max float64) *ExtendedBoundsdoubleBuilder {
	rb.v.Max = max
	return rb
}

// Min set the Min property for ExtendedBoundsdoubleBuilder.
