...
func NewSpanFieldMaskingQuery() *SpanFieldMaskingQueryBuilder {
...
// Boost set the Boost property for SpanFieldMaskingQueryBuilder.
func (rb *SpanFieldMaskingQueryBuilder) Boost(boost float32) *SpanFieldMaskingQueryBuilder {
	rb.v.Boost = &boost
	return rb
}

// Field set the Field property for SpanFieldMaskingQueryBuilder.
func (rb *SpanFieldMaskingQueryBuilder) Field(field Field) *SpanFieldMaskingQueryBuilder {
	rb.v.Field = field
	return rb
}

// Query set the Query property for SpanFieldMaskingQueryBuilder.
func (rb *SpanFieldMaskingQueryBuilder) Query(query SpanQuery) *SpanFieldMaskingQueryBuilder {
	rb.v.Query = &query
	return rb
}

// QueryName_ set the QueryName_ property for SpanFieldMaskingQueryBuilder.
