...
func NewAggregationProfileDelegateDebugFilter() *AggregationProfileDelegateDebugFilterBuilder {
...
// Query set the Query property for AggregationProfileDelegateDebugFilterBuilder.
func (rb *AggregationProfileDelegateDebugFilterBuilder) Query(query string) *AggregationProfileDelegateDebugFilterBuilder {
	rb.v.Query = &query
	return rb
}

// ResultsFromMetadata set the ResultsFromMetadata property for AggregationProfileDelegateDebugFilterBuilder.
...
// SpecializedFor set the SpecializedFor property for AggregationProfileDelegateDebugFilterBuilder.
