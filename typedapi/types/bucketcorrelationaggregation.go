...
func NewBucketCorrelationAggregation() *BucketCorrelationAggregationBuilder {
...
// BucketsPath Path to the buckets that contain one set of values to correlate.
func (rb *BucketCorrelationAggregationBuilder) BucketsPath(bucketspath BucketsPath) *BucketCorrelationAggregationBuilder {
	rb.v.BucketsPath = &bucketspath
	return rb
}

// Function The correlation function to execute.
func (rb *BucketCorrelationAggregationBuilder) Function(function BucketCorrelationFunction) *BucketCorrelationAggregationBuilder {
	rb.v.Function = function
	return rb
}

// Meta set the Meta property for BucketCorrelationAggregationBuilder.
func (rb *BucketCorrelationAggregationBuilder) Meta(meta Metadata) *BucketCorrelationAggregationBuilder {
	rb.v.Meta = &meta
	return rb
}

// Name set the Name property for BucketCorrelationAggregationBuilder.
