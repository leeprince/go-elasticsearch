...
func NewExplanationDetail() *ExplanationDetailBuilder {
...
// Description set the Description property for ExplanationDetailBuilder.
func (rb *ExplanationDetailBuilder) Description(description string) *ExplanationDetailBuilder {
	rb.v.Description = description
	return rb
}

// Details set the Details property for ExplanationDetailBuilder.
func (rb *ExplanationDetailBuilder) Details(details ...ExplanationDetail) *ExplanationDetailBuilder {
	rb.v.Details = append(rb.v.Details, details...)
	return rb
}

// Value set the Value property for ExplanationDetailBuilder.
