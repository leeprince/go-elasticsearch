...
func NewSearchInputRequestBody() *SearchInputRequestBodyBuilder {
...
// Query set the Query property for SearchInputRequestBodyBuilder.
func (rb *SearchInputRequestBodyBuilder) Query(query QueryContainer) *SearchInputRequestBodyBuilder {
	rb.v.Query = query
	return rb
}
