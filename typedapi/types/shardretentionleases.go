...
func NewShardRetentionLeases() *ShardRetentionLeasesBuilder {
...
// Leases set the Leases property for ShardRetentionLeasesBuilder.
func (rb *ShardRetentionLeasesBuilder) Leases(leases ...ShardLease) *ShardRetentionLeasesBuilder {
	rb.v.Leases = append(rb.v.Leases, leases...)
	return rb
}

// PrimaryTerm set the PrimaryTerm property for ShardRetentionLeasesBuilder.
...
// Version set the Version property for ShardRetentionLeasesBuilder.
