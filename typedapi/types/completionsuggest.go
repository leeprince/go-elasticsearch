...
func NewCompletionSuggest() *CompletionSuggestBuilder {
...
// Length set the Length property for CompletionSuggestBuilder.
func (rb *CompletionSuggestBuilder) Length(length int) *CompletionSuggestBuilder {
	rb.v.Length = length
	return rb
}

// Offset set the Offset property for CompletionSuggestBuilder.
func (rb *CompletionSuggestBuilder) Offset(offset int) *CompletionSuggestBuilder {
	rb.v.Offset = offset
	return rb
}

// Options set the Options property for CompletionSuggestBuilder.
func (rb *CompletionSuggestBuilder) Options(options ...CompletionSuggestOption) *CompletionSuggestBuilder {
	rb.v.Options = append(rb.v.Options, options...)
	return rb
}

// Text set the Text property for CompletionSuggestBuilder.
