...
func NewGlobalPrivilege() *GlobalPrivilegeBuilder {
...
// Application set the Application property for GlobalPrivilegeBuilder.
func (rb *GlobalPrivilegeBuilder) Application(application ApplicationGlobalUserPrivileges) *GlobalPrivilegeBuilder {
