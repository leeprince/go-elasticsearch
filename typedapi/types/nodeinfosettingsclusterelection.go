...
func NewNodeInfoSettingsClusterElection() *NodeInfoSettingsClusterElectionBuilder {
...
// Strategy set the Strategy property for NodeInfoSettingsClusterElectionBuilder.
