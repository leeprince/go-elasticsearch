...
func NewDatafeedConfig() *DatafeedConfigBuilder {
...
// Aggregations If set, the datafeed performs aggregation searches. Support for aggregations
// is limited and should be used only with low cardinality data.
func (rb *DatafeedConfigBuilder) Aggregations(value map[string]AggregationContainer) *DatafeedConfigBuilder {
...
// size of these time chunks are calculated and is an advanced configuration
// option.
func (rb *DatafeedConfigBuilder) ChunkingConfig(chunkingconfig ChunkingConfig) *DatafeedConfigBuilder {
	rb.v.ChunkingConfig = &chunkingconfig
	return rb
}
...
// the datafeed has passed that moment in time. This check runs only on
// real-time datafeeds.
func (rb *DatafeedConfigBuilder) DelayedDataCheckConfig(delayeddatacheckconfig DelayedDataCheckConfig) *DatafeedConfigBuilder {
	rb.v.DelayedDataCheckConfig = &delayeddatacheckconfig
	return rb
}
...
// Indexes set the Indexes property for DatafeedConfigBuilder.
func (rb *DatafeedConfigBuilder) Indexes(indexes ...string) *DatafeedConfigBuilder {
	rb.v.Indexes = append(rb.v.Indexes, indexes...)
	return rb
}
...
// IndicesOptions Specifies index expansion options that are used during search.
func (rb *DatafeedConfigBuilder) IndicesOptions(indicesoptions IndicesOptions) *DatafeedConfigBuilder {
	rb.v.IndicesOptions = &indicesoptions
	return rb
}

// JobId set the JobId property for DatafeedConfigBuilder.
...
// options that are supported by Elasticsearch can be used, as this object is
// passed verbatim to Elasticsearch.
func (rb *DatafeedConfigBuilder) Query(query QueryContainer) *DatafeedConfigBuilder {
	rb.v.Query = query
	return rb
}
...
// RuntimeMappings Specifies runtime fields for the datafeed search.
func (rb *DatafeedConfigBuilder) RuntimeMappings(runtimemappings RuntimeFields) *DatafeedConfigBuilder {
...
// to the datafeed. The detector configuration objects in a job can contain
// functions that use these script fields.
func (rb *DatafeedConfigBuilder) ScriptFields(value map[string]ScriptField) *DatafeedConfigBuilder {
