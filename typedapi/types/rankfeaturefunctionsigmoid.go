...
func NewRankFeatureFunctionSigmoid() *RankFeatureFunctionSigmoidBuilder {
...
// Exponent set the Exponent property for RankFeatureFunctionSigmoidBuilder.
...
// Pivot set the Pivot property for RankFeatureFunctionSigmoidBuilder.
