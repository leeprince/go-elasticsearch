...
func NewRecoveryRecord() *RecoveryRecordBuilder {
...
// BytesPercent percent of bytes recovered
func (rb *RecoveryRecordBuilder) BytesPercent(bytespercent Percentage) *RecoveryRecordBuilder {
	rb.v.BytesPercent = &bytespercent
	return rb
}
...
// FilesPercent percent of files recovered
func (rb *RecoveryRecordBuilder) FilesPercent(filespercent Percentage) *RecoveryRecordBuilder {
	rb.v.FilesPercent = &filespercent
	return rb
}
...
// TranslogOpsPercent percent of translog ops recovered
func (rb *RecoveryRecordBuilder) TranslogOpsPercent(translogopspercent Percentage) *RecoveryRecordBuilder {
	rb.v.TranslogOpsPercent = &translogopspercent
	return rb
}
