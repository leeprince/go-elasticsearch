...
func NewTDigestPercentilesAggregate() *TDigestPercentilesAggregateBuilder {
...
// Meta set the Meta property for TDigestPercentilesAggregateBuilder.
func (rb *TDigestPercentilesAggregateBuilder) Meta(meta Metadata) *TDigestPercentilesAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}

// Values set the Values property for TDigestPercentilesAggregateBuilder.
func (rb *TDigestPercentilesAggregateBuilder) Values(values Percentiles) *TDigestPercentilesAggregateBuilder {
	rb.v.Values = values
	return rb
}
