...
func NewFilterAggregate() *FilterAggregateBuilder {
...
// Aggregations set the Aggregations property for FilterAggregateBuilder.
func (rb *FilterAggregateBuilder) Aggregations(value map[AggregateName]Aggregate) *FilterAggregateBuilder {
	rb.v.Aggregations = value
	return rb
}

// DocCount set the DocCount property for FilterAggregateBuilder.
func (rb *FilterAggregateBuilder) DocCount(doccount int64) *FilterAggregateBuilder {
	rb.v.DocCount = doccount
	return rb
}

// Meta set the Meta property for FilterAggregateBuilder.
func (rb *FilterAggregateBuilder) Meta(meta Metadata) *FilterAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
