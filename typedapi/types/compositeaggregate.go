...
func NewCompositeAggregate() *CompositeAggregateBuilder {
...
// AfterKey set the AfterKey property for CompositeAggregateBuilder.
func (rb *CompositeAggregateBuilder) AfterKey(value map[string]interface{}) *CompositeAggregateBuilder {
	rb.v.AfterKey = value
	return rb
}

// Buckets set the Buckets property for CompositeAggregateBuilder.
func (rb *CompositeAggregateBuilder) Buckets(buckets BucketsCompositeBucket) *CompositeAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for CompositeAggregateBuilder.
func (rb *CompositeAggregateBuilder) Meta(meta Metadata) *CompositeAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
