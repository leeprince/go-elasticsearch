...
func NewWatcherActions() *WatcherActionsBuilder {
...
// Actions set the Actions property for WatcherActionsBuilder.
func (rb *WatcherActionsBuilder) Actions(value map[Name]WatcherActionTotals) *WatcherActionsBuilder {
	rb.v.Actions = value
	return rb
}
