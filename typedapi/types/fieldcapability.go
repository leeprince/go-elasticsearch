...
func NewFieldCapability() *FieldCapabilityBuilder {
...
// Indices The list of indices where this field has the same type family, or null if all
// indices have the same type family for the field.
func (rb *FieldCapabilityBuilder) Indices(indices Indices) *FieldCapabilityBuilder {
...
// this key, while a length of 2 or more indicates that not all indices had the
// same value for this key.
func (rb *FieldCapabilityBuilder) Meta(meta Metadata) *FieldCapabilityBuilder {
	rb.v.Meta = &meta
	return rb
}
...
func (rb *FieldCapabilityBuilder) MetricConflictsIndices(metric_conflicts_indices ...IndexName) *FieldCapabilityBuilder {
	rb.v.MetricConflictsIndices = append(rb.v.MetricConflictsIndices, metric_conflicts_indices...)
	return rb
}

// NonAggregatableIndices The list of indices where this field is not aggregatable, or null if all
// indices have the same definition for the field.
func (rb *FieldCapabilityBuilder) NonAggregatableIndices(nonaggregatableindices Indices) *FieldCapabilityBuilder {
	rb.v.NonAggregatableIndices = &nonaggregatableindices
	return rb
}
...
func (rb *FieldCapabilityBuilder) NonDimensionIndices(non_dimension_indices ...IndexName) *FieldCapabilityBuilder {
	rb.v.NonDimensionIndices = append(rb.v.NonDimensionIndices, non_dimension_indices...)
	return rb
}

// NonSearchableIndices The list of indices where this field is not searchable, or null if all
// indices have the same definition for the field.
func (rb *FieldCapabilityBuilder) NonSearchableIndices(nonsearchableindices Indices) *FieldCapabilityBuilder {
	rb.v.NonSearchableIndices = &nonsearchableindices
	return rb
}
...
// Type set the Type property for FieldCapabilityBuilder.
