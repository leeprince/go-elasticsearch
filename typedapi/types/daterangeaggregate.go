...
func NewDateRangeAggregate() *DateRangeAggregateBuilder {
...
// Buckets set the Buckets property for DateRangeAggregateBuilder.
func (rb *DateRangeAggregateBuilder) Buckets(buckets BucketsRangeBucket) *DateRangeAggregateBuilder {
	rb.v.Buckets = buckets
	return rb
}

// Meta set the Meta property for DateRangeAggregateBuilder.
func (rb *DateRangeAggregateBuilder) Meta(meta Metadata) *DateRangeAggregateBuilder {
	rb.v.Meta = &meta
	return rb
}
