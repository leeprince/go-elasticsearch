...
func NewMetricAggregationBase() *MetricAggregationBaseBuilder {
...
// Field set the Field property for MetricAggregationBaseBuilder.
func (rb *MetricAggregationBaseBuilder) Field(field Field) *MetricAggregationBaseBuilder {
	rb.v.Field = &field
	return rb
}

// Missing set the Missing property for MetricAggregationBaseBuilder.
func (rb *MetricAggregationBaseBuilder) Missing(missing Missing) *MetricAggregationBaseBuilder {
	rb.v.Missing = &missing
	return rb
}

// Script set the Script property for MetricAggregationBaseBuilder.
func (rb *MetricAggregationBaseBuilder) Script(script Script) *MetricAggregationBaseBuilder {
	rb.v.Script = &script
	return rb
}
