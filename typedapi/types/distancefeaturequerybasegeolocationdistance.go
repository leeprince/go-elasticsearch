...
func NewDistanceFeatureQueryBaseGeoLocationDistance() *DistanceFeatureQueryBaseGeoLocationDistanceBuilder {
...
// Boost set the Boost property for DistanceFeatureQueryBaseGeoLocationDistanceBuilder.
...
// Field set the Field property for DistanceFeatureQueryBaseGeoLocationDistanceBuilder.
...
// Origin set the Origin property for DistanceFeatureQueryBaseGeoLocationDistanceBuilder.
func (rb *DistanceFeatureQueryBaseGeoLocationDistanceBuilder) Origin(origin GeoLocation) *DistanceFeatureQueryBaseGeoLocationDistanceBuilder {
	rb.v.Origin = origin
	return rb
}

// Pivot set the Pivot property for DistanceFeatureQueryBaseGeoLocationDistanceBuilder.
...
// QueryName_ set the QueryName_ property for DistanceFeatureQueryBaseGeoLocationDistanceBuilder.
