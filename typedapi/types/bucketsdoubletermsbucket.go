...
func NewBucketsDoubleTermsBucket() *BucketsDoubleTermsBucketBuilder {
...
// DoubleTermsBuckets set the DoubleTermsBuckets property for BucketsDoubleTermsBucketBuilder.
func (u *BucketsDoubleTermsBucketBuilder) DoubleTermsBuckets(v []DoubleTermsBucket) *BucketsDoubleTermsBucketBuilder {
	u.v = v
	return u
}

// Map set the Map property for BucketsDoubleTermsBucketBuilder.
func (u *BucketsDoubleTermsBucketBuilder) Map(v map[string]DoubleTermsBucket) *BucketsDoubleTermsBucketBuilder {
	u.v = v
	return u
}
