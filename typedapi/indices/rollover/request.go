...
func (rb *RequestBuilder) Aliases(value map[types.IndexName]types.Alias) *RequestBuilder {
	rb.v.Aliases = value
	return rb
}

func (rb *RequestBuilder) Conditions(conditions types.RolloverConditions) *RequestBuilder {
	rb.v.Conditions = &conditions
	return rb
}
