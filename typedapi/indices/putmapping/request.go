...
func (rb *RequestBuilder) FieldNames_(fieldnames_ types.FieldNamesField) *RequestBuilder {
...
func (rb *RequestBuilder) Properties(value map[types.PropertyName]types.Property) *RequestBuilder {
	rb.v.Properties = value
	return rb
}

func (rb *RequestBuilder) Routing_(routing_ types.RoutingField) *RequestBuilder {
	rb.v.Routing_ = &routing_
	return rb
}

func (rb *RequestBuilder) Runtime(runtime types.RuntimeFields) *RequestBuilder {
	rb.v.Runtime = &runtime
	return rb
}

func (rb *RequestBuilder) Source_(source_ types.SourceField) *RequestBuilder {
