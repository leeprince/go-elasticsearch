...
func (rb *RequestBuilder) ContextSetup(contextsetup types.PainlessContextSetup) *RequestBuilder {
	rb.v.ContextSetup = &contextsetup
	return rb
}

func (rb *RequestBuilder) Script(script types.InlineScript) *RequestBuilder {
	rb.v.Script = &script
	return rb
}
