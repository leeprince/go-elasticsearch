...
func (rb *RequestBuilder) GeoMatch(geomatch types.Policy) *RequestBuilder {
	rb.v.GeoMatch = &geomatch
	return rb
}

func (rb *RequestBuilder) Match(match types.Policy) *RequestBuilder {
	rb.v.Match = &match
	return rb
}

func (rb *RequestBuilder) Range_(range_ types.Policy) *RequestBuilder {
	rb.v.Range = &range_
	return rb
}
