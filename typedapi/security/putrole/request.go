...
func (rb *RequestBuilder) Applications(applications ...types.ApplicationPrivileges) *RequestBuilder {
...
func (rb *RequestBuilder) Indices(indices ...types.IndicesPrivileges) *RequestBuilder {
...
func (rb *RequestBuilder) TransientMetadata(transientmetadata types.TransientMetadataConfig) *RequestBuilder {
