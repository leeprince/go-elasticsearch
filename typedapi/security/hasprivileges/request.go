...
func (rb *RequestBuilder) Application(application ...types.ApplicationPrivilegesCheck) *RequestBuilder {
...
func (rb *RequestBuilder) Index(index ...types.IndexPrivilegesCheck) *RequestBuilder {
