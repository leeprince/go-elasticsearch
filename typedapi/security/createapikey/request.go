...
func (rb *RequestBuilder) Expiration(expiration types.Time) *RequestBuilder {
...
func (rb *RequestBuilder) RoleDescriptors(value map[string]types.RoleDescriptor) *RequestBuilder {
